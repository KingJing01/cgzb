...
class grid_cg_zjk_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_grid_cg_zjk";
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_cg_zjk.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['rtf_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "lwbz" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      while (!$rs->EOF)
      {
         ...
         $this->xm = $rs->fields[1] ;  
         $this->xb = $rs->fields[2] ;  
         $this->gzdw = $rs->fields[3] ;  
         $this->zc = $rs->fields[4] ;  
         $this->yddh = $rs->fields[5] ;  
         $this->email = $rs->fields[6] ;  
         $this->kyzt = $rs->fields[7] ;  
         $this->sfzh = $rs->fields[8] ;  
         $this->zy = $rs->fields[9] ;  
   ...
   //----- lwbz
   function NM_export_lwbz()
   {
         nmgp_Form_Num_Val($this->lwbz, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
         if (!NM_is_utf8($this->lwbz))
         {
             $this->lwbz = sc_convert_encoding($this->lwbz, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->lwbz = str_replace('<', '&lt;', $this->lwbz);
         $this->lwbz = str_replace('>', '&gt;', $this->lwbz);
         $this->Texto_tag .= "<td>" . $this->lwbz . "</td>\r\n";
   }
   //----- bz
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk'][$path_doc_md5][1] = $this->Tit_doc;
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_zjk'] ?> :: RTF</TITLE>

...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "dlsj";$Nm_numeric[] = "id";$Nm_numeric[] = "lwbz";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_zjbh"  <?php echo $str_hide_zjbh?>><?php
      $zjbh_look = substr($this->Db->qstr($zjbh), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_xm"  <?php echo $str_hide_xm?>><?php
      $xm_look = substr($this->Db->qstr($xm), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_gzdw"  <?php echo $str_hide_gzdw?>><?php
      $gzdw_look = substr($this->Db->qstr($gzdw), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_zy"  <?php echo $str_hide_zy?>>
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_zc"  <?php echo $str_hide_zc?>>
<?php

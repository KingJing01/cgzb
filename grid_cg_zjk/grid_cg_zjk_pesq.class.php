...
class grid_cg_zjk_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_zjk_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_zjk_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_zjk_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_gzdw')
      {
          $gzdw = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_gzdw($gzdw);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_gzdw($gzdw)
   {
      $gzdw = substr($this->Db->qstr($gzdw), 1, -1);
            $gzdw_look = substr($this->Db->qstr($gzdw), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct gzdw from " . $this->Ini->nm_tabela . " where  gzdw like '%" . $gzdw . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_zjk'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_zjk/grid_cg_zjk_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_zjk_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_zjk_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_gzdw_cond#NMF#' + search_get_sel_txt('SC_gzdw_cond') + '@NMF@';
  str_out += 'SC_gzdw#NMF#' + search_get_text('SC_gzdw') + '@NMF@';
  str_out += 'id_ac_gzdw#NMF#' + search_get_text('id_ac_gzdw') + '@NMF@';
  str_out += 'SC_xb_cond#NMF#' + search_get_sel_txt('SC_xb_cond') + '@NMF@';
  str_out += 'SC_xb#NMF#' + search_get_checkbox('SC_xb') + '@NMF@';
  str_out += 'SC_zy_cond#NMF#' + search_get_sel_txt('SC_zy_cond') + '@NMF@';
  str_out += 'SC_zy#NMF#' + search_get_checkbox('SC_zy') + '@NMF@';
   ...
   $("#id_ac_gzdw").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_gzdw",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_gzdw").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_gzdw").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_zjk'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $zjbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zjbh']; 
          $zjbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zjbh_cond']; 
          $xm = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['xm']; 
          $xm_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['xm_cond']; 
          $gzdw = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['gzdw']; 
          $gzdw_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['gzdw_cond']; 
          $xb = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['xb']; 
          $xb_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['xb_cond']; 
          $zy = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zy']; 
          $zy_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zy_cond']; 
          $zc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zc']; 
          $zc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zc_cond']; 
          $kyzt = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['kyzt']; 
          $kyzt_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['kyzt_cond']; 
          $dlsj_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_dia']; 
          $dlsj_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_mes']; 
          $dlsj_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_ano']; 
          $dlsj_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_dia']; 
          $dlsj_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_mes']; 
          $dlsj_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_ano']; 
          $dlsj_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_hor']; 
          $dlsj_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_min']; 
          $dlsj_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_seg']; 
          $dlsj_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_hor']; 
          $dlsj_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_min']; 
          $dlsj_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_seg']; 
          $dlsj_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($gzdw_cond) || empty($gzdw_cond))
      {
         $gzdw_cond = "qp";
      }
      ...
      if (!isset($zy_cond) || empty($zy_cond))
      {
         $zy_cond = "qp";
      }
      ...
      $str_hide_gzdw = (in_array($gzdw_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_xb = (in_array($xb_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_zy = (in_array($zy_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      // zy
      if (is_array($zy) && !empty($zy))
      {
         $tmp_array = array();
         $zy_val_str = "";
         foreach ($zy as $tmp_val_cmp)
         {
            if ("" != $zy_val_str)
            {
               $zy_val_str .= ", ";
...
<?php
   if (is_file("grid_cg_zjk_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['zjbh'])) ? $this->New_label['zjbh'] : "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_zjbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_zjbh" name="zjbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['xm'])) ? $this->New_label['xm'] : "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_xm'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_xm" name="xm_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['gzdw'])) ? $this->New_label['gzdw'] : "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_gzdw'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_gzdw_cond" name="gzdw_cond" onChange="nm_campos_between(document.getElementById('id_vis_gzdw'), this, 'gzdw')">
       <OPTION value="qp" <?php if ("qp" == $gzdw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $gzdw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $gzdw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $gzdw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_gzdw" <?php echo $str_hide_gzdw?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['gzdw'])) ? $this->New_label['gzdw'] : "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_gzdw'] . "";
 $nmgp_tab_label .= "gzdw?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $gzdw_look = substr($this->Db->qstr($gzdw), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct gzdw from " . $this->Ini->nm_tabela . " where gzdw = '$gzdw_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$gzdw]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$gzdw];
      }
      else
      {
          $sAutocompValue = $gzdw;
...
?>
<INPUT  type="text" id="SC_gzdw" name="gzdw" value="<?php echo NM_encode_input($gzdw) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_gzdw" name="gzdw_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['xb'])) ? $this->New_label['xb'] : "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_xb'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_xb_cond" name="xb_cond" onChange="nm_campos_between(document.getElementById('id_vis_xb'), this, 'xb')">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['xb'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['xb'][] = "男";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['xb'][] = "女";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_xb" name="xb[]" value="男##@@男"  <?php if (in_array("男", $xb))  { echo " checked" ;} ?>>男</TD>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_xb" name="xb[]" value="女##@@女"  <?php if (in_array("女", $xb))  { echo " checked" ;} ?>>女</TD>
</TR><TR>
 <TD colspan=2>
  ...
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('xb', 'N'); return false;" style="cursor: pointer">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['zy'])) ? $this->New_label['zy'] : "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_zy'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_zy_cond" name="zy_cond" onChange="nm_campos_between(document.getElementById('id_vis_zy'), this, 'zy')">
       <OPTION value="qp" <?php if ("qp" == $zy_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $zy_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $zy_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $zy_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_zy" <?php echo $str_hide_zy?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['zy'])) ? $this->New_label['zy'] : "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_zy'] . "";
 $nmgp_tab_label .= "zy?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>

<?php
      $zy_look = substr($this->Db->qstr($zy), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT mc, mc  FROM dm_zyfl  ORDER BY mc"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['zy'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['zy'][] = trim($rs->fields[0]);
      ...
      echo "<span id=\"idAjaxCheckbox_zy\">\r\n";
      echo "        <TABLE border=\"0px\" cellpadding=\"0px\">\r\n";
      echo "         <TR>\r\n";
      if (!isset($zy) || !is_array($zy))
      {
         $zy = array();
      }
      for ($j = 0; $j < sizeof($nm_opcoes); $j++)
      {
         if (!empty($nm_opcoes[$j]))
         {
            ...
            echo "           <INPUT class=\"scFilterObjectOdd\" type=\"checkbox\" id=\"SC_zy\" name=\"zy[]\" value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\" $tmp_cmp_sel $tmp_cmp_click>$nm_opc_val\r\n";
            echo "          </TD>\r\n";
            $i++;
     ...
     echo "         <TR>\r\n";
     echo "          <TD colspan=2>\r\n";
     echo "           <IMG SRC=\"" . $this->Ini->path_img_global . "/img_select_all.gif\" ALIGN=\"absmiddle\" onClick=\"nm_marca_check('zy', 'N'); return false;\" style=\"cursor: pointer\">&nbsp;\r\n";
     echo "           <IMG SRC=\"" . $this->Ini->path_img_global . "/img_select_none.gif\" ALIGN=\"absmiddle\" onClick=\"nm_limpa_check('zy', 'N'); return false;\" style=\"cursor: pointer\">\r\n";
     echo "         </TR>\r\n";
      echo "        </TABLE>\r\n";
      echo "</span>\r\n";
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['zc'])) ? $this->New_label['zc'] : "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_zc'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['zc'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['zc'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['kyzt'])) ? $this->New_label['kyzt'] : "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_kyzt'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['kyzt'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['kyzt'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['kyzt'][] = "否";
 ?>
...
<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
 ...
 <TD colspan=2>
  ...
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('kyzt', 'N'); return false;" style="cursor: pointer">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['dlsj'])) ? $this->New_label['dlsj'] : "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_dlsj'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_zjk']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_zjk']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_gzdw'), document.F1.gzdw_cond, 'gzdw');
   document.F1.gzdw.value = "";
   document.F1.gzdw_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_zy'), document.F1.zy_cond, 'zy');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'zy[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_dlsj_dia').bind('change', function() {sc_grid_cg_zjk_valida_dia(this)});
    $('#SC_dlsj_input_2_dia').bind('change', function() {sc_grid_cg_zjk_valida_dia(this)});
    $('#SC_dlsj_input_2_mes').bind('change', function() {sc_grid_cg_zjk_valida_mes(this)});
    $('#SC_dlsj_mes').bind('change', function() {sc_grid_cg_zjk_valida_mes(this)});
 }
 function sc_grid_cg_zjk_valida_dia(obj)
 {
 ...
 function sc_grid_cg_zjk_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_gzdw_cond'] = 'cond';
      $tp_fields['SC_gzdw'] = 'text_aut';
      $tp_fields['id_ac_gzdw'] = 'text_aut';
      $tp_fields['SC_xb_cond'] = 'cond';
      $tp_fields['SC_xb'] = 'checkbox';
      $tp_fields['SC_zy_cond'] = 'cond';
      $tp_fields['SC_zy'] = 'checkbox';
   ...
   {
      global $zjbh_cond, $zjbh, $zjbh_autocomp,
             $xm_cond, $xm, $xm_autocomp,
             $gzdw_cond, $gzdw, $gzdw_autocomp,
             $xb_cond, $xb,
             $zy_cond, $zy,
      ...
      if (!empty($gzdw_autocomp) && empty($gzdw))
      {
          $gzdw = $gzdw_autocomp;
      }
      ...
      $gzdw_cond_salva = $gzdw_cond; 
      if (!isset($gzdw_input_2) || $gzdw_input_2 == "")
      {
          $gzdw_input_2 = $gzdw;
      }
      ...
      $zy_cond_salva = $zy_cond; 
      if (!isset($zy_input_2) || $zy_input_2 == "")
      {
          $zy_input_2 = $zy;
      }
      ...
      if (is_array($xb)) {
          foreach ($xb as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['xb'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_xb'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($zy)) {
          foreach ($zy as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['zy'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_zy'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($zc)) {
          foreach ($zc as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['zc'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_zc'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($kyzt)) {
          foreach ($kyzt as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['psq_check_ret']['kyzt'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_zjk_fld_kyzt'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zjbh'] = $zjbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zjbh_cond'] = $zjbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['xm'] = $xm; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['xm_cond'] = $xm_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['gzdw'] = $gzdw; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['gzdw_cond'] = $gzdw_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['xb'] = $xb; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['xb_cond'] = $xb_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zy'] = $zy; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zy_cond'] = $zy_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zc'] = $zc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zc_cond'] = $zc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['kyzt'] = $kyzt; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['kyzt_cond'] = $kyzt_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_dia'] = $dlsj_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_mes'] = $dlsj_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_ano'] = $dlsj_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_dia'] = $dlsj_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_mes'] = $dlsj_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_ano'] = $dlsj_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_hor'] = $dlsj_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_min'] = $dlsj_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_seg'] = $dlsj_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_hor'] = $dlsj_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_min'] = $dlsj_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2_seg'] = $dlsj_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_cond'] = $dlsj_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['gzdw'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['gzdw'] = $gzdw;
      }
      $this->cmp_formatado['xb'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['xb'];
      $this->cmp_formatado['xb_input_2'] = $xb_input_2;
      $this->cmp_formatado['zy'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zy'];
      $this->cmp_formatado['zy_input_2'] = $zy_input_2;
      $this->cmp_formatado['zc'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['zc'];
      $this->cmp_formatado['zc_input_2'] = $zc_input_2;
      $this->cmp_formatado['kyzt'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['kyzt'];
      ...
      //----- $gzdw
      $this->Date_part = false;
      if (isset($gzdw) || $gzdw_cond == "nu" || $gzdw_cond == "nn" || $gzdw_cond == "ep" || $gzdw_cond == "ne")
      {
         $this->monta_condicao("gzdw", $gzdw_cond, $gzdw, "", "gzdw");
      }
      ...
      if (count($xb) != 0)
      {
         ...
         if (strtoupper($xb_cond) == "DF" || strtoupper($xb_cond) == "NP")
         {
             ...
             $this->comando_sum    .= " cg_zjk.xb not in (";
             $this->comando_filtro .= " xb not in (";
         }
         else
         {
             $this->comando        .= " xb in (";
             $this->comando_sum    .= " cg_zjk.xb in (";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label['xb'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      {
         $this->and_or();
         if (strtoupper($zy_cond) == "DF" || strtoupper($zy_cond) == "NP")
         {
             $this->comando        .= " zy not in (";
             $this->comando_sum    .= " cg_zjk.zy not in (";
             $this->comando_filtro .= " zy not in (";
         }
         else
         {
             $this->comando        .= " zy in (";
             $this->comando_sum    .= " cg_zjk.zy in (";
             $this->comando_filtro .= " zy in (";
         }
         $x                     = count($zy);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label['zy'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($zc) != 0)
      {
         ...
         if (strtoupper($zc_cond) == "DF" || strtoupper($zc_cond) == "NP")
         {
             ...
             $this->comando_sum    .= " cg_zjk.zc not in (";
             $this->comando_filtro .= " zc not in (";
         }
         else
         {
             $this->comando        .= " zc in (";
             $this->comando_sum    .= " cg_zjk.zc in (";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label['zc'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($kyzt) != 0)
      {
         ...
         if (strtoupper($kyzt_cond) == "DF" || strtoupper($kyzt_cond) == "NP")
         {
             ...
             $this->comando_sum    .= " cg_zjk.kyzt not in (";
             $this->comando_filtro .= " kyzt not in (";
         }
         else
         {
             $this->comando        .= " kyzt in (";
             $this->comando_sum    .= " cg_zjk.kyzt in (";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $nmgp_tab_label['kyzt'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if ($dlsj_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj'] = $val[0];
          ...
          if ($dlsj_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']['dlsj_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['where_pesq_ant'] = $this->comando . $this->comando_fim;

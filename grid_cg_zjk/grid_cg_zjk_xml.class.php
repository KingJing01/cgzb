...
class grid_cg_zjk_xml
{
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['xml_name']);
      }
      if (!$this->Grava_view)
      {
   ...
   function NM_export_lwbz()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->lwbz))
         {
             $this->lwbz = sc_convert_encoding($this->lwbz, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " lwbz =\"" . $this->trata_dados($this->lwbz) . "\"";
   }
   //----- bz
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zjk']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_zjk'] ?> :: XML</TITLE>

...
class grid_notice_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_notice']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_notice']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_notice']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_notice']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_notice']['contr_erro'] = 'off'; 
   ...
   function NM_export_author()
   {
         ...
         $this->author = str_replace('>', '&gt;', $this->author);
         $this->Texto_tag .= "<td>" . $this->author . "</td>\r\n";
   }
   //----- releasetime
   function NM_export_releasetime()
   {
         ...
         $this->releasetime = str_replace('<', '&lt;', $this->releasetime);
         $this->releasetime = str_replace('>', '&gt;', $this->releasetime);
         $this->Texto_tag .= "<td>" . $this->releasetime . "</td>\r\n";
   }
   //----- id
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_notice']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_notice']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_notice'] ?> :: RTF</TITLE>

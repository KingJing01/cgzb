...
Table_sv_fil[0] = "title";
Table_sv_fil[1] = "author";
Table_sv_fil[2] = "releasetime";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
      ...
      success: function(json_sel_fil) {
        ...
        if ($("#SC_releasetime_cond")) {
            formata_bi_releasetime(search_get_sel_txt("SC_releasetime_cond"));
        }

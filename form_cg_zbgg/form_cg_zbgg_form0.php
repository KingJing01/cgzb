...
<?php
include_once("form_cg_zbgg_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_zbgg_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['recarga'];
}
?>
...
<?php
 include_once("form_cg_zbgg_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_zbgg'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_zbgg'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgbbh_label" id="hidden_field_label_cgbbh" style="<?php echo $sStyleHidden_cgbbh; ?>"><span id="id_label_cgbbh"><?php echo $this->nm_new_label['cgbbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['cgbbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['cgbbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_cgbbh" class="sc-ui-readonly-cgbbh css_cgbbh_line" style="<?php echo $sStyleReadLab_cgbbh; ?>"><?php echo $this->form_encode_input($this->cgbbh); ?></span><span id="id_read_off_cgbbh" style="white-space: nowrap;<?php echo $sStyleReadInp_cgbbh; ?>">
 ...
 size=32 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_cg_cgb"]) && $this->Ini->sc_lig_md5["grid_cg_cgb"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,cgbbh,b_cgbbh*scoutnm_evt_ret_busca*scinsc_form_cg_zbgg_cgbbh_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cg_zbgg@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,cgbbh,b_cgbbh*scoutnm_evt_ret_busca*scinsc_form_cg_zbgg_cgbbh_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgbmc_label" id="hidden_field_label_cgbmc" style="<?php echo $sStyleHidden_cgbmc; ?>"><span id="id_label_cgbmc"><?php echo $this->nm_new_label['cgbmc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['cgbmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['cgbmc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cgfs_label" id="hidden_field_label_cgfs" style="<?php echo $sStyleHidden_cgfs; ?>"><span id="id_label_cgfs"><?php echo $this->nm_new_label['cgfs']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['cgfs']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['cgfs'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cgfs_line" id="hidden_field_data_cgfs" style="<?php echo $sStyleHidden_cgfs; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cgfs_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="cgfs" value="<?php echo $this->form_encode_input($cgfs); ?>"><span id="id_ajax_label_cgfs"><?php echo nl2br($cgfs); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bzj_label" id="hidden_field_label_bzj" style="<?php echo $sStyleHidden_bzj; ?>"><span id="id_label_bzj"><?php echo $this->nm_new_label['bzj']; ?></span></TD>
    <TD class="scFormDataOdd css_bzj_line" id="hidden_field_data_bzj" style="<?php echo $sStyleHidden_bzj; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bzj_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bskssj_label" id="hidden_field_label_bskssj" style="<?php echo $sStyleHidden_bskssj; ?>"><span id="id_label_bskssj"><?php echo $this->nm_new_label['bskssj']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['bskssj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['bskssj'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_bskssj_line" id="hidden_field_data_bskssj" style="<?php echo $sStyleHidden_bskssj; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bskssj_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bsjssj_label" id="hidden_field_label_bsjssj" style="<?php echo $sStyleHidden_bsjssj; ?>"><span id="id_label_bsjssj"><?php echo $this->nm_new_label['bsjssj']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['bsjssj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['bsjssj'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_bsjssj_line" id="hidden_field_data_bsjssj" style="<?php echo $sStyleHidden_bsjssj; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bsjssj_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bsf_label" id="hidden_field_label_bsf" style="<?php echo $sStyleHidden_bsf; ?>"><span id="id_label_bsf"><?php echo $this->nm_new_label['bsf']; ?></span></TD>
    <TD class="scFormDataOdd css_bsf_line" id="hidden_field_data_bsf" style="<?php echo $sStyleHidden_bsf; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bsf_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_wzqd_label" id="hidden_field_label_wzqd" style="<?php echo $sStyleHidden_wzqd; ?>"><span id="id_label_wzqd"><?php echo $this->nm_new_label['wzqd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['wzqd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['wzqd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_wzqd_line" id="hidden_field_data_wzqd" style="<?php echo $sStyleHidden_wzqd; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_wzqd_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xckssj_label" id="hidden_field_label_xckssj" style="<?php echo $sStyleHidden_xckssj; ?>"><span id="id_label_xckssj"><?php echo $this->nm_new_label['xckssj']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['xckssj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['xckssj'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_xckssj_line" id="hidden_field_data_xckssj" style="<?php echo $sStyleHidden_xckssj; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_xckssj_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xcjssj_label" id="hidden_field_label_xcjssj" style="<?php echo $sStyleHidden_xcjssj; ?>"><span id="id_label_xcjssj"><?php echo $this->nm_new_label['xcjssj']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['xcjssj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['xcjssj'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_xcjssj_line" id="hidden_field_data_xcjssj" style="<?php echo $sStyleHidden_xcjssj; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_xcjssj_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zbkssj_label" id="hidden_field_label_zbkssj" style="<?php echo $sStyleHidden_zbkssj; ?>"><span id="id_label_zbkssj"><?php echo $this->nm_new_label['zbkssj']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['zbkssj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['zbkssj'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_zbkssj_line" id="hidden_field_data_zbkssj" style="<?php echo $sStyleHidden_zbkssj; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zbkssj_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zbjssj_label" id="hidden_field_label_zbjssj" style="<?php echo $sStyleHidden_zbjssj; ?>"><span id="id_label_zbjssj"><?php echo $this->nm_new_label['zbjssj']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['zbjssj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['zbjssj'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_zbjssj_line" id="hidden_field_data_zbjssj" style="<?php echo $sStyleHidden_zbjssj; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zbjssj_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zbfile_label" id="hidden_field_label_zbfile" style="<?php echo $sStyleHidden_zbfile; ?>"><span id="id_label_zbfile"><?php echo $this->nm_new_label['zbfile']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['zbfile']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['zbfile'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_zbfile_line" id="hidden_field_data_zbfile" style="<?php echo $sStyleHidden_zbfile; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zbfile_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lxr_label" id="hidden_field_label_lxr" style="<?php echo $sStyleHidden_lxr; ?>"><span id="id_label_lxr"><?php echo $this->nm_new_label['lxr']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['lxr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['lxr'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_lxr" class="sc-ui-readonly-lxr css_lxr_line" style="<?php echo $sStyleReadLab_lxr; ?>"><?php echo $this->form_encode_input($this->lxr); ?></span><span id="id_read_off_lxr" style="white-space: nowrap;<?php echo $sStyleReadInp_lxr; ?>">
 ...
 size=32 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_cg_staff"]) && $this->Ini->sc_lig_md5["grid_cg_staff"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,lxr,ygxm*scoutnm_evt_ret_busca*scinsc_form_cg_zbgg_lxr_onchange(this)*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cg_zbgg@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,lxr,ygxm*scoutnm_evt_ret_busca*scinsc_form_cg_zbgg_lxr_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_yddh_label" id="hidden_field_label_yddh" style="<?php echo $sStyleHidden_yddh; ?>"><span id="id_label_yddh"><?php echo $this->nm_new_label['yddh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['yddh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['yddh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_email_label" id="hidden_field_label_email" style="<?php echo $sStyleHidden_email; ?>"><span id="id_label_email"><?php echo $this->nm_new_label['email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['php_cmp_required']['email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_postcode_label" id="hidden_field_label_postcode" style="<?php echo $sStyleHidden_postcode; ?>"><span id="id_label_postcode"><?php echo $this->nm_new_label['postcode']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dz_label" id="hidden_field_label_dz" style="<?php echo $sStyleHidden_dz; ?>"><span id="id_label_dz"><?php echo $this->nm_new_label['dz']; ?></span></TD>
    <TD class="scFormDataOdd css_dz_line" id="hidden_field_data_dz" style="<?php echo $sStyleHidden_dz; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dz_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_kfh_label" id="hidden_field_label_kfh" style="<?php echo $sStyleHidden_kfh; ?>"><span id="id_label_kfh"><?php echo $this->nm_new_label['kfh']; ?></span></TD>
    <TD class="scFormDataOdd css_kfh_line" id="hidden_field_data_kfh" style="<?php echo $sStyleHidden_kfh; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kfh_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_yhzh_label" id="hidden_field_label_yhzh" style="<?php echo $sStyleHidden_yhzh; ?>"><span id="id_label_yhzh"><?php echo $this->nm_new_label['yhzh']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
<?php  $this->ybqy_1 = explode(";", trim($this->ybqy)) ; ?>
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ybqy_label" id="hidden_field_label_ybqy" style="<?php echo $sStyleHidden_ybqy; ?>"><span id="id_label_ybqy"><?php echo $this->nm_new_label['ybqy']; ?></span></TD>
    <TD class="scFormDataOdd css_ybqy_line" id="hidden_field_data_ybqy" style="<?php echo $sStyleHidden_ybqy; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ybqy_line" style="vertical-align: top;padding: 0px">
...
ORDER BY gsmc";
   ...
   echo " <span id=\"idAjaxSelect_ybqy\"><select class=\"sc-js-input scFormObjectOdd css_ybqy_obj\" style=\"\" id=\"id_sc_field_ybqy\" name=\"ybqy_orig\" size=\"7\" multiple onDblClick=\"nm_add_sel('ybqy_orig', 'ybqy_dest', null);  \" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo "<div class='scBtnPassField' id='ybqy_all_right'>";
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('ybqy_orig', 'ybqy_dest', null);    return false;", "nm_add_all('ybqy_orig', 'ybqy_dest', null);    return false;", "Bbpassfld_rightall", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
;
   ...
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('ybqy_orig', 'ybqy_dest', null);    return false;", "nm_add_sel('ybqy_orig', 'ybqy_dest', null);    return false;", "Bbpassfld_righ", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
;
   ...
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('ybqy_dest', 'ybqy_orig', null);    return false;", "nm_del_sel('ybqy_dest', 'ybqy_orig', null);    return false;", "Bbpassfld_left", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 
<?php
;
   echo "</div>";
   echo "<div class='scBtnPassField' id='ybqy_all_left'>";
   echo         $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('ybqy_dest', 'ybqy_orig', null);    return false;", "nm_del_all('ybqy_dest', 'ybqy_orig', null);    return false;", "Bbpassfld_leftall", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
;
   ...
   echo "</td>";
   echo "<td>";
   echo " <select class=\"sc-js-input scFormObjectOdd css_ybqy_obj\" style=\"\" name=\"ybqy_dest\"  onBlur=\"scCssBlur(this);\"  onFocus=\"scCssFocus(this);\"  size=7 multiple onDblClick=\"nm_del_sel('ybqy_dest', 'ybqy_orig', null);  \" alt=\"{type: 'select', enterTab: false}\">";
   $x = 0 ; 
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo " </select>" ; 
   echo " <input type=\"hidden\" name=\"ybqy\" value=\"\">" ; 
   echo "</td></tr></table>";
   echo " <script>document.F1.ybqy_dest.selectedIndex = -1;</script>" ; 
   echo "\r" ; 
   echo "</span>";
?> 
<?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xmsm_label" id="hidden_field_label_xmsm" style="<?php echo $sStyleHidden_xmsm; ?>"><span id="id_label_xmsm"><?php echo $this->nm_new_label['xmsm']; ?></span></TD>
    <TD class="scFormDataOdd css_xmsm_line" id="hidden_field_data_xmsm" style="<?php echo $sStyleHidden_xmsm; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_xmsm_line" style="vertical-align: top;padding: 0px">
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_zbgg']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_zbgg");
 parent.scAjaxDetailHeight("form_cg_zbgg", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}

  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cg_zbgg_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cgbbh
  function do_ajax_form_cg_zbgg_mob_validate_cgbbh()
  {
    var nomeCampo_cgbbh = "cgbbh";
    var var_cgbbh = scAjaxGetFieldText(nomeCampo_cgbbh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_cgbbh(var_cgbbh, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_cgbbh_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_cgbbh

  function do_ajax_form_cg_zbgg_mob_validate_cgbbh_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_cgbbh_cb

  // ---------- Validate cgbmc
  function do_ajax_form_cg_zbgg_mob_validate_cgbmc()
  {
    var nomeCampo_cgbmc = "cgbmc";
    var var_cgbmc = scAjaxGetFieldHidden(nomeCampo_cgbmc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_cgbmc(var_cgbmc, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_cgbmc_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_cgbmc

  function do_ajax_form_cg_zbgg_mob_validate_cgbmc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cgbmc";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_cgbmc_cb

  // ---------- Validate cgfs
  function do_ajax_form_cg_zbgg_mob_validate_cgfs()
  {
    var nomeCampo_cgfs = "cgfs";
    var var_cgfs = scAjaxGetFieldHidden(nomeCampo_cgfs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_cgfs(var_cgfs, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_cgfs_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_cgfs

  function do_ajax_form_cg_zbgg_mob_validate_cgfs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cgfs";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_cgfs_cb

  // ---------- Validate bzj
  function do_ajax_form_cg_zbgg_mob_validate_bzj()
  {
    var nomeCampo_bzj = "bzj";
    var var_bzj = scAjaxGetFieldText(nomeCampo_bzj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_bzj(var_bzj, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_bzj_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_bzj

  function do_ajax_form_cg_zbgg_mob_validate_bzj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bzj";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_bzj_cb

  // ---------- Validate bskssj
  function do_ajax_form_cg_zbgg_mob_validate_bskssj()
  {
    var nomeCampo_bskssj = "bskssj";
    var var_bskssj = scAjaxGetFieldText(nomeCampo_bskssj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_bskssj(var_bskssj, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_bskssj_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_bskssj

  function do_ajax_form_cg_zbgg_mob_validate_bskssj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bskssj";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_bskssj_cb

  // ---------- Validate bsjssj
  function do_ajax_form_cg_zbgg_mob_validate_bsjssj()
  {
    var nomeCampo_bsjssj = "bsjssj";
    var var_bsjssj = scAjaxGetFieldText(nomeCampo_bsjssj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_bsjssj(var_bsjssj, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_bsjssj_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_bsjssj

  function do_ajax_form_cg_zbgg_mob_validate_bsjssj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bsjssj";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_bsjssj_cb

  // ---------- Validate bsf
  function do_ajax_form_cg_zbgg_mob_validate_bsf()
  {
    var nomeCampo_bsf = "bsf";
    var var_bsf = scAjaxGetFieldText(nomeCampo_bsf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_bsf(var_bsf, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_bsf_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_bsf

  function do_ajax_form_cg_zbgg_mob_validate_bsf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bsf";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_bsf_cb

  // ---------- Validate wzqd
  function do_ajax_form_cg_zbgg_mob_validate_wzqd()
  {
    var nomeCampo_wzqd = "wzqd";
    var var_wzqd = scAjaxGetFieldText(nomeCampo_wzqd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_wzqd(var_wzqd, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_wzqd_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_wzqd

  function do_ajax_form_cg_zbgg_mob_validate_wzqd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "wzqd";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_wzqd_cb

  // ---------- Validate xckssj
  function do_ajax_form_cg_zbgg_mob_validate_xckssj()
  {
    var nomeCampo_xckssj = "xckssj";
    var var_xckssj = scAjaxGetFieldText(nomeCampo_xckssj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_xckssj(var_xckssj, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_xckssj_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_xckssj

  function do_ajax_form_cg_zbgg_mob_validate_xckssj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "xckssj";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_xckssj_cb

  // ---------- Validate xcjssj
  function do_ajax_form_cg_zbgg_mob_validate_xcjssj()
  {
    var nomeCampo_xcjssj = "xcjssj";
    var var_xcjssj = scAjaxGetFieldText(nomeCampo_xcjssj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_xcjssj(var_xcjssj, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_xcjssj_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_xcjssj

  function do_ajax_form_cg_zbgg_mob_validate_xcjssj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "xcjssj";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_xcjssj_cb

  // ---------- Validate zbkssj
  function do_ajax_form_cg_zbgg_mob_validate_zbkssj()
  {
    var nomeCampo_zbkssj = "zbkssj";
    var var_zbkssj = scAjaxGetFieldText(nomeCampo_zbkssj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_zbkssj(var_zbkssj, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_zbkssj_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_zbkssj

  function do_ajax_form_cg_zbgg_mob_validate_zbkssj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "zbkssj";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_zbkssj_cb

  // ---------- Validate zbjssj
  function do_ajax_form_cg_zbgg_mob_validate_zbjssj()
  {
    var nomeCampo_zbjssj = "zbjssj";
    var var_zbjssj = scAjaxGetFieldText(nomeCampo_zbjssj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_zbjssj(var_zbjssj, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_zbjssj_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_zbjssj

  function do_ajax_form_cg_zbgg_mob_validate_zbjssj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "zbjssj";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_zbjssj_cb

  // ---------- Validate zbfile
  function do_ajax_form_cg_zbgg_mob_validate_zbfile()
  {
    var nomeCampo_zbfile = "zbfile";
    var var_zbfile = scAjaxGetFieldText(nomeCampo_zbfile);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_zbfile(var_zbfile, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_zbfile_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_zbfile

  function do_ajax_form_cg_zbgg_mob_validate_zbfile_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "zbfile";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_zbfile_cb

  // ---------- Validate lxr
  function do_ajax_form_cg_zbgg_mob_validate_lxr()
  {
    var nomeCampo_lxr = "lxr";
    var var_lxr = scAjaxGetFieldText(nomeCampo_lxr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_lxr(var_lxr, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_lxr_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_lxr

  function do_ajax_form_cg_zbgg_mob_validate_lxr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "lxr";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_lxr_cb

  // ---------- Validate bgdh
  function do_ajax_form_cg_zbgg_mob_validate_bgdh()
  {
    var nomeCampo_bgdh = "bgdh";
    var var_bgdh = scAjaxGetFieldText(nomeCampo_bgdh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_bgdh(var_bgdh, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_bgdh_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_bgdh

  function do_ajax_form_cg_zbgg_mob_validate_bgdh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "bgdh";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_bgdh_cb

  // ---------- Validate yddh
  function do_ajax_form_cg_zbgg_mob_validate_yddh()
  {
    var nomeCampo_yddh = "yddh";
    var var_yddh = scAjaxGetFieldText(nomeCampo_yddh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_yddh(var_yddh, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_yddh_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_yddh

  function do_ajax_form_cg_zbgg_mob_validate_yddh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "yddh";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_yddh_cb

  // ---------- Validate fax
  function do_ajax_form_cg_zbgg_mob_validate_fax()
  {
    var nomeCampo_fax = "fax";
    var var_fax = scAjaxGetFieldText(nomeCampo_fax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_fax(var_fax, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_fax_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_fax

  function do_ajax_form_cg_zbgg_mob_validate_fax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fax";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_fax_cb

  // ---------- Validate email
  function do_ajax_form_cg_zbgg_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_email(var_email, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_email_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_email

  function do_ajax_form_cg_zbgg_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "email";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_email_cb

  // ---------- Validate postcode
  function do_ajax_form_cg_zbgg_mob_validate_postcode()
  {
    var nomeCampo_postcode = "postcode";
    var var_postcode = scAjaxGetFieldText(nomeCampo_postcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_postcode(var_postcode, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_postcode_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_postcode

  function do_ajax_form_cg_zbgg_mob_validate_postcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_postcode_cb

  // ---------- Validate dz
  function do_ajax_form_cg_zbgg_mob_validate_dz()
  {
    var nomeCampo_dz = "dz";
    var var_dz = scAjaxGetFieldText(nomeCampo_dz);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_dz(var_dz, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_dz_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_dz

  function do_ajax_form_cg_zbgg_mob_validate_dz_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "dz";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_dz_cb

  // ---------- Validate kfh
  function do_ajax_form_cg_zbgg_mob_validate_kfh()
  {
    var nomeCampo_kfh = "kfh";
    var var_kfh = scAjaxGetFieldSelect(nomeCampo_kfh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_kfh(var_kfh, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_kfh_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_kfh

  function do_ajax_form_cg_zbgg_mob_validate_kfh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "kfh";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_kfh_cb

  // ---------- Validate yhzh
  function do_ajax_form_cg_zbgg_mob_validate_yhzh()
  {
    var nomeCampo_yhzh = "yhzh";
    var var_yhzh = scAjaxGetFieldText(nomeCampo_yhzh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_yhzh(var_yhzh, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_yhzh_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_yhzh

  function do_ajax_form_cg_zbgg_mob_validate_yhzh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "yhzh";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_yhzh_cb

  // ---------- Validate ybqy
  function do_ajax_form_cg_zbgg_mob_validate_ybqy()
  {
    var nomeCampo_ybqy = "ybqy";
    var var_ybqy = scAjaxGetFieldSelect(nomeCampo_ybqy);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_ybqy(var_ybqy, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_ybqy_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_ybqy

  function do_ajax_form_cg_zbgg_mob_validate_ybqy_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "ybqy";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_ybqy_cb

  // ---------- Validate xmsm
  function do_ajax_form_cg_zbgg_mob_validate_xmsm()
  {
    var nomeCampo_xmsm = "xmsm";
    var var_xmsm = scAjaxGetFieldText(nomeCampo_xmsm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_zbgg_mob_validate_xmsm(var_xmsm, var_script_case_init, do_ajax_form_cg_zbgg_mob_validate_xmsm_cb);
  } // do_ajax_form_cg_zbgg_mob_validate_xmsm

  function do_ajax_form_cg_zbgg_mob_validate_xmsm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "xmsm";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_zbgg_mob_validate_xmsm_cb

  // ---------- Event onchange cgbbh
  function do_ajax_form_cg_zbgg_mob_event_cgbbh_onchange()
  {
    ...
    x_ajax_form_cg_zbgg_mob_event_cgbbh_onchange(var_cgbbh, var_cgbmc, var_cgfs, var_script_case_init, do_ajax_form_cg_zbgg_mob_event_cgbbh_onchange_cb);
  } // do_ajax_form_cg_zbgg_mob_event_cgbbh_onchange

  function do_ajax_form_cg_zbgg_mob_event_cgbbh_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cgbbh";
  ...
  } // do_ajax_form_cg_zbgg_mob_event_cgbbh_onchange_cb

  // ---------- Event onchange lxr
  function do_ajax_form_cg_zbgg_mob_event_lxr_onchange()
  {
    ...
    x_ajax_form_cg_zbgg_mob_event_lxr_onchange(var_lxr, var_bgdh, var_yddh, var_email, var_script_case_init, do_ajax_form_cg_zbgg_mob_event_lxr_onchange_cb);
  } // do_ajax_form_cg_zbgg_mob_event_lxr_onchange

  function do_ajax_form_cg_zbgg_mob_event_lxr_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "lxr";
  ...
  } // do_ajax_form_cg_zbgg_mob_event_lxr_onchange_cb
  // ---------- Form
  function do_ajax_form_cg_zbgg_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cg_zbgg_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cgbbh = scAjaxGetFieldText("cgbbh");
    ...
    var var_ybqy = scAjaxGetFieldSelect("ybqy");
    ...
    scAjaxProcOn();
    x_ajax_form_cg_zbgg_mob_submit_form(var_cgbbh, var_cgbmc, var_cgfs, var_bzj, var_bskssj, var_bsjssj, var_bsf, var_wzqd, var_xckssj, var_xcjssj, var_zbkssj, var_zbjssj, var_zbfile, var_lxr, var_bgdh, var_yddh, var_fax, var_email, var_postcode, var_dz, var_kfh, var_yhzh, var_ybqy, var_xmsm, var_id, var_wzqd_ul_name, var_wzqd_ul_type, var_zbfile_ul_name, var_zbfile_ul_type, var_wzqd_salva, var_wzqd_limpa, var_zbfile_salva, var_zbfile_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cg_zbgg_mob_submit_form_cb);
  } // do_ajax_form_cg_zbgg_mob_submit_form

  function do_ajax_form_cg_zbgg_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cg_zbgg_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_cg_zbgg_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cg_zbgg_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cg_zbgg_mob_navigate_form_cb);
  } // do_ajax_form_cg_zbgg_mob_navigate_form

  function do_ajax_form_cg_zbgg_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_cg_zbgg_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cg_zbgg_mob_navigate_form_cb
  function sc_hide_form_cg_zbgg_mob_form()
  {

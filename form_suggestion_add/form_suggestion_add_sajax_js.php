  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_suggestion_add" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate subject
  function do_ajax_form_suggestion_add_validate_subject()
  {
    var nomeCampo_subject = "subject";
    var var_subject = scAjaxGetFieldText(nomeCampo_subject);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suggestion_add_validate_subject(var_subject, var_script_case_init, do_ajax_form_suggestion_add_validate_subject_cb);
  } // do_ajax_form_suggestion_add_validate_subject

  function do_ajax_form_suggestion_add_validate_subject_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suggestion_add_validate_subject_cb

  // ---------- Validate content
  function do_ajax_form_suggestion_add_validate_content()
  {
    var nomeCampo_content = "content";
    var var_content = scAjaxGetFieldText(nomeCampo_content);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suggestion_add_validate_content(var_content, var_script_case_init, do_ajax_form_suggestion_add_validate_content_cb);
  } // do_ajax_form_suggestion_add_validate_content

  function do_ajax_form_suggestion_add_validate_content_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "content";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suggestion_add_validate_content_cb

  // ---------- Validate phone
  function do_ajax_form_suggestion_add_validate_phone()
  {
    var nomeCampo_phone = "phone";
    var var_phone = scAjaxGetFieldText(nomeCampo_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_suggestion_add_validate_phone(var_phone, var_script_case_init, do_ajax_form_suggestion_add_validate_phone_cb);
  } // do_ajax_form_suggestion_add_validate_phone

  function do_ajax_form_suggestion_add_validate_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "phone";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_suggestion_add_validate_phone_cb
  // ---------- Form
  function do_ajax_form_suggestion_add_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_suggestion_add_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_suggestion_add_submit_form(var_subject, var_content, var_phone, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_suggestion_add_submit_form_cb);
  } // do_ajax_form_suggestion_add_submit_form

  function do_ajax_form_suggestion_add_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_suggestion_add_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_suggestion_add_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_suggestion_add_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_suggestion_add_navigate_form_cb);
  } // do_ajax_form_suggestion_add_navigate_form

  function do_ajax_form_suggestion_add_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_suggestion_add_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_suggestion_add_navigate_form_cb
  function sc_hide_form_suggestion_add_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_suggestion_add_form

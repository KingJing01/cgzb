<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_qysb_ysb_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_qysb_ysb_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['zbggbh'] = "on";
   $tab_def_campos['zbggbh'] = "zbggbh";
   $tab_converte["zbggbh"]   = "zbggbh";
   $tab_labels["zbggbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["zbggbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["zbggbh"] : "" . $this->Nm_lang['lang_cg_qysb_fld_zbggbh'] . "";
   $tab_ger_campos['cgbmc'] = "on";
   $tab_def_campos['cgbmc'] = "cgbmc";
   $tab_converte["cgbmc"]   = "cgbmc";
   $tab_labels["cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["cgbmc"] : "" . $this->Nm_lang['lang_cg_qysb_fld_cgbmc'] . "";
   $tab_ger_campos['isbsxz'] = "on";
   $tab_def_campos['isbsxz'] = "isbsxz";
   $tab_converte["isbsxz"]   = "isbsxz";
   $tab_labels["isbsxz"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["isbsxz"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["isbsxz"] : "" . $this->Nm_lang['lang_cg_qysb_fld_isbsxz'] . "";
   $tab_ger_campos['istb'] = "on";
   $tab_def_campos['istb'] = "istb";
   $tab_converte["istb"]   = "istb";
   $tab_labels["istb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["istb"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["istb"] : "" . $this->Nm_lang['lang_cg_qysb_fld_istb'] . "";
   $tab_ger_campos['isrw'] = "on";
   $tab_def_campos['isrw'] = "isrw";
   $tab_converte["isrw"]   = "isrw";
   $tab_labels["isrw"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["isrw"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["isrw"] : "" . $this->Nm_lang['lang_cg_qysb_fld_isrw'] . "";
   $tab_ger_campos['isqualified'] = "on";
   $tab_def_campos['isqualified'] = "isqualified";
   $tab_converte["isqualified"]   = "isqualified";
   $tab_labels["isqualified"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["isqualified"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["isqualified"] : "" . $this->Nm_lang['lang_cg_qysb_fld_isqualified'] . "";
   $tab_ger_campos['kyzt'] = "on";
   $tab_def_campos['kyzt'] = "kyzt";
   $tab_converte["kyzt"]   = "kyzt";
   $tab_labels["kyzt"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["kyzt"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["kyzt"] : "" . $this->Nm_lang['lang_cg_qysb_fld_kyzt'] . "";
   $tab_ger_campos['spgl'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['spgl'] = "spgl";
       $tab_converte["spgl"]   = "spgl";
   }
   else
   {
       $tab_def_campos['spgl'] = "";
   ...
   $tab_labels["spgl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["spgl"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["spgl"] : "操作";
   $tab_ger_campos['zbfile'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['zbfile'] = "zbfile";
       $tab_converte["zbfile"]   = "zbfile";
   }
   else
   {
       $tab_def_campos['zbfile'] = "";
       $tab_converte[""]   = "zbfile";
   }
   $tab_labels["zbfile"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["zbfile"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["zbfile"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_zbfile'] . "";
   $tab_ger_campos['qytb'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['qytb'] = "qytb";
       $tab_converte["qytb"]   = "qytb";
   }
   else
   {
       $tab_def_campos['qytb'] = "";
   ...
   $tab_labels["qytb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["qytb"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['labels']["qytb"] : "操作";
   $tab_ger_campos['spgl'] = "none";
   $tab_ger_campos['zbfile'] = "none";
   $tab_ger_campos['qytb'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_menu_cg_qysb_ysb'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_qysb_ysb_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_qysb_ysb']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {

...
class grid_cg_qysb_ysb_pesq
{
    ...
    * @access  public
    */
   function grid_cg_qysb_ysb_pesq()
   {
      $this->dlsj_opc_bi[] = "TP";
      $this->dlsj_opc_bi[] = "HJ";
      $this->dlsj_opc_bi[] = "OT";
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_qysb_ysb_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_qysb_ysb_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_qysb_ysb_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_cg_qysb_ysb'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_qysb_ysb/grid_cg_qysb_ysb_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_qysb_ysb_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_qysb_ysb_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_kyzt_cond#NMF#' + search_get_sel_txt('SC_kyzt_cond') + '@NMF@';
  str_out += 'SC_kyzt#NMF#' + search_get_checkbox('SC_kyzt') + '@NMF@';
  str_out += 'SC_isbsxz_cond#NMF#' + search_get_sel_txt('SC_isbsxz_cond') + '@NMF@';
  str_out += 'SC_isbsxz#NMF#' + search_get_checkbox('SC_isbsxz') + '@NMF@';
  str_out += 'SC_istb_cond#NMF#' + search_get_sel_txt('SC_istb_cond') + '@NMF@';
  str_out += 'SC_istb#NMF#' + search_get_checkbox('SC_istb') + '@NMF@';
  str_out += 'SC_isrw_cond#NMF#' + search_get_sel_txt('SC_isrw_cond') + '@NMF@';
  str_out += 'SC_isrw#NMF#' + search_get_checkbox('SC_isrw') + '@NMF@';
  str_out += 'SC_isqualified_cond#NMF#' + search_get_sel_txt('SC_isqualified_cond') + '@NMF@';
  str_out += 'SC_isqualified#NMF#' + search_get_checkbox('SC_isqualified') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_cg_qysb_ysb'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cgbbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['cgbbh']; 
          $cgbbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['cgbbh_cond']; 
          $cgbmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['cgbmc']; 
          $cgbmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['cgbmc_cond']; 
          $kyzt = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['kyzt']; 
          $kyzt_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['kyzt_cond']; 
          $isbsxz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isbsxz']; 
          $isbsxz_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isbsxz_cond']; 
          $istb = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['istb']; 
          $istb_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['istb_cond']; 
          $isrw = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isrw']; 
          $isrw_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isrw_cond']; 
          $isqualified = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isqualified']; 
          $isqualified_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isqualified_cond']; 
          $dlsj_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_dia']; 
          $dlsj_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_mes']; 
          $dlsj_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_ano']; 
          $dlsj_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_dia']; 
          $dlsj_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_mes']; 
          $dlsj_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_ano']; 
          $dlsj_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_hor']; 
          $dlsj_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_min']; 
          $dlsj_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_seg']; 
          $dlsj_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_hor']; 
          $dlsj_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_min']; 
          $dlsj_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_seg']; 
          $dlsj_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($kyzt_cond) || empty($kyzt_cond))
      {
         $kyzt_cond = "qp";
      }
      if (!isset($isbsxz_cond) || empty($isbsxz_cond))
      {
         $isbsxz_cond = "qp";
      }
      if (!isset($istb_cond) || empty($istb_cond))
      {
         $istb_cond = "qp";
      }
      if (!isset($isrw_cond) || empty($isrw_cond))
      {
         $isrw_cond = "qp";
      }
      if (!isset($isqualified_cond) || empty($isqualified_cond))
      {
         $isqualified_cond = "qp";
      }
      ...
      $str_hide_kyzt = (in_array($kyzt_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_isbsxz = (in_array($isbsxz_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_istb = (in_array($istb_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_isrw = (in_array($isrw_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_isqualified = (in_array($isqualified_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      // kyzt
      if (is_array($kyzt) && !empty($kyzt))
      {
         $tmp_array = array();
         $kyzt_val_str = "";
         foreach ($kyzt as $tmp_val_cmp)
         {
            if ("" != $kyzt_val_str)
            {
               $kyzt_val_str .= ", ";
      ...
      // isbsxz
      if (is_array($isbsxz) && !empty($isbsxz))
      {
         $tmp_array = array();
         $isbsxz_val_str = "";
         foreach ($isbsxz as $tmp_val_cmp)
         {
            if ("" != $isbsxz_val_str)
            {
               $isbsxz_val_str .= ", ";
      ...
      // istb
      if (is_array($istb) && !empty($istb))
      {
         $tmp_array = array();
         $istb_val_str = "";
         foreach ($istb as $tmp_val_cmp)
         {
            if ("" != $istb_val_str)
            {
               $istb_val_str .= ", ";
      ...
      // isrw
      if (is_array($isrw) && !empty($isrw))
      {
         $tmp_array = array();
         $isrw_val_str = "";
         foreach ($isrw as $tmp_val_cmp)
         {
            if ("" != $isrw_val_str)
            {
               $isrw_val_str .= ", ";
      ...
      // isqualified
      if (is_array($isqualified) && !empty($isqualified))
      {
         $tmp_array = array();
         $isqualified_val_str = "";
         foreach ($isqualified as $tmp_val_cmp)
         {
            if ("" != $isqualified_val_str)
            {
               $isqualified_val_str .= ", ";
            }
            $tmp_pos = strpos($tmp_val_cmp, "##@@");
            ...
            $isqualified_val_str .= "'$tmp_val_cmp'";
         }
         $isqualified = $tmp_array;
      }
      else
      {
         $isqualified_val_str = "''";
...
<?php
   if (is_file("grid_cg_qysb_ysb_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgbbh'])) ? $this->New_label['cgbbh'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_cgbbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cgbbh" name="cgbbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cgbmc'])) ? $this->New_label['cgbmc'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_cgbmc'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cgbmc" name="cgbmc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['kyzt'])) ? $this->New_label['kyzt'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_kyzt'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_kyzt_cond" name="kyzt_cond" onChange="nm_campos_between(document.getElementById('id_vis_kyzt'), this, 'kyzt')">
       <OPTION value="qp" <?php if ("qp" == $kyzt_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $kyzt_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $kyzt_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $kyzt_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_kyzt" <?php echo $str_hide_kyzt?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['kyzt'])) ? $this->New_label['kyzt'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_kyzt'] . "";
 $nmgp_tab_label .= "kyzt?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  if (!isset($kyzt)) {$kyzt = explode("", $kyzt);}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['kyzt'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['kyzt'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['kyzt'][] = "否";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_kyzt" name="kyzt[]" value="是##@@是"  <?php if (in_array("是", $kyzt))  { echo " checked" ;} ?>>是</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_kyzt" name="kyzt[]" value="否##@@否"  <?php if (in_array("否", $kyzt))  { echo " checked" ;} ?>>否</TD>
</TR><TR>
 <TD colspan=2>
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_all.gif" ALIGN="absmiddle" onClick="nm_marca_check('kyzt', 'N'); return false;" style="cursor: pointer">&nbsp;
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('kyzt', 'N'); return false;" style="cursor: pointer">
 </TD>
</TR></TABLE>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['isbsxz'])) ? $this->New_label['isbsxz'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isbsxz'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_isbsxz_cond" name="isbsxz_cond" onChange="nm_campos_between(document.getElementById('id_vis_isbsxz'), this, 'isbsxz')">
       <OPTION value="qp" <?php if ("qp" == $isbsxz_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $isbsxz_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $isbsxz_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $isbsxz_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_isbsxz" <?php echo $str_hide_isbsxz?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['isbsxz'])) ? $this->New_label['isbsxz'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isbsxz'] . "";
 $nmgp_tab_label .= "isbsxz?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  if (!isset($isbsxz)) {$isbsxz = explode("", $isbsxz);}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isbsxz'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isbsxz'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isbsxz'][] = "否";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_isbsxz" name="isbsxz[]" value="是##@@是"  <?php if (in_array("是", $isbsxz))  { echo " checked" ;} ?>>是</TD>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_isbsxz" name="isbsxz[]" value="否##@@否"  <?php if (in_array("否", $isbsxz))  { echo " checked" ;} ?>>否</TD>
</TR><TR>
 <TD colspan=2>
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_all.gif" ALIGN="absmiddle" onClick="nm_marca_check('isbsxz', 'N'); return false;" style="cursor: pointer">&nbsp;
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('isbsxz', 'N'); return false;" style="cursor: pointer">
 </TD>
</TR></TABLE>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['istb'])) ? $this->New_label['istb'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_istb'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_istb_cond" name="istb_cond" onChange="nm_campos_between(document.getElementById('id_vis_istb'), this, 'istb')">
       <OPTION value="qp" <?php if ("qp" == $istb_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $istb_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $istb_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $istb_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_istb" <?php echo $str_hide_istb?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['istb'])) ? $this->New_label['istb'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_istb'] . "";
 $nmgp_tab_label .= "istb?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  if (!isset($istb)) {$istb = explode("", $istb);}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['istb'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['istb'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['istb'][] = "否";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_istb" name="istb[]" value="是##@@是"  <?php if (in_array("是", $istb))  { echo " checked" ;} ?>>是</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_istb" name="istb[]" value="否##@@否"  <?php if (in_array("否", $istb))  { echo " checked" ;} ?>>否</TD>
</TR><TR>
 <TD colspan=2>
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_all.gif" ALIGN="absmiddle" onClick="nm_marca_check('istb', 'N'); return false;" style="cursor: pointer">&nbsp;
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('istb', 'N'); return false;" style="cursor: pointer">
 </TD>
</TR></TABLE>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['isrw'])) ? $this->New_label['isrw'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isrw'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_isrw_cond" name="isrw_cond" onChange="nm_campos_between(document.getElementById('id_vis_isrw'), this, 'isrw')">
       <OPTION value="qp" <?php if ("qp" == $isrw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $isrw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $isrw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $isrw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_isrw" <?php echo $str_hide_isrw?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['isrw'])) ? $this->New_label['isrw'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isrw'] . "";
 $nmgp_tab_label .= "isrw?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  if (!isset($isrw)) {$isrw = explode("", $isrw);}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isrw'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isrw'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isrw'][] = "否";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_isrw" name="isrw[]" value="是##@@是"  <?php if (in_array("是", $isrw))  { echo " checked" ;} ?>>是</TD>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_isrw" name="isrw[]" value="否##@@否"  <?php if (in_array("否", $isrw))  { echo " checked" ;} ?>>否</TD>
</TR><TR>
 <TD colspan=2>
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_all.gif" ALIGN="absmiddle" onClick="nm_marca_check('isrw', 'N'); return false;" style="cursor: pointer">&nbsp;
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('isrw', 'N'); return false;" style="cursor: pointer">
 </TD>
</TR></TABLE>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['isqualified'])) ? $this->New_label['isqualified'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isqualified'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_isqualified_cond" name="isqualified_cond" onChange="nm_campos_between(document.getElementById('id_vis_isqualified'), this, 'isqualified')">
       <OPTION value="qp" <?php if ("qp" == $isqualified_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $isqualified_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $isqualified_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $isqualified_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_isqualified" <?php echo $str_hide_isqualified?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['isqualified'])) ? $this->New_label['isqualified'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isqualified'] . "";
 $nmgp_tab_label .= "isqualified?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  if (!isset($isqualified)) {$isqualified = explode("", $isqualified);}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isqualified'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isqualified'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isqualified'][] = "否";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_isqualified" name="isqualified[]" value="是##@@是"  <?php if (in_array("是", $isqualified))  { echo " checked" ;} ?>>是</TD>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_isqualified" name="isqualified[]" value="否##@@否"  <?php if (in_array("否", $isqualified))  { echo " checked" ;} ?>>否</TD>
</TR><TR>
 <TD colspan=2>
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_all.gif" ALIGN="absmiddle" onClick="nm_marca_check('isqualified', 'N'); return false;" style="cursor: pointer">&nbsp;
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('isqualified', 'N'); return false;" style="cursor: pointer">
 </TD>
</TR></TABLE>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['dlsj'])) ? $this->New_label['dlsj'] : "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_dlsj'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_qysb_ysb']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_qysb_ysb']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_kyzt'), document.F1.kyzt_cond, 'kyzt');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'kyzt[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
   nm_campos_between(document.getElementById('id_vis_isbsxz'), document.F1.isbsxz_cond, 'isbsxz');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'isbsxz[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
   nm_campos_between(document.getElementById('id_vis_istb'), document.F1.istb_cond, 'istb');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'istb[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
   nm_campos_between(document.getElementById('id_vis_isrw'), document.F1.isrw_cond, 'isrw');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'isrw[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
   nm_campos_between(document.getElementById('id_vis_isqualified'), document.F1.isqualified_cond, 'isqualified');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'isqualified[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_dlsj_dia').bind('change', function() {sc_grid_cg_qysb_ysb_valida_dia(this)});
    $('#SC_dlsj_input_2_dia').bind('change', function() {sc_grid_cg_qysb_ysb_valida_dia(this)});
    $('#SC_dlsj_input_2_mes').bind('change', function() {sc_grid_cg_qysb_ysb_valida_mes(this)});
    $('#SC_dlsj_mes').bind('change', function() {sc_grid_cg_qysb_ysb_valida_mes(this)});
 }
 function sc_grid_cg_qysb_ysb_valida_dia(obj)
 {
 ...
 function sc_grid_cg_qysb_ysb_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "cgzb/grid_cg_qysb_ysb";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_kyzt_cond'] = 'cond';
      $tp_fields['SC_kyzt'] = 'checkbox';
      $tp_fields['SC_isbsxz_cond'] = 'cond';
      $tp_fields['SC_isbsxz'] = 'checkbox';
      $tp_fields['SC_istb_cond'] = 'cond';
      $tp_fields['SC_istb'] = 'checkbox';
      $tp_fields['SC_isrw_cond'] = 'cond';
      $tp_fields['SC_isrw'] = 'checkbox';
      $tp_fields['SC_isqualified_cond'] = 'cond';
      $tp_fields['SC_isqualified'] = 'checkbox';
   ...
   function trata_campos()
   {
      ...
      $kyzt_cond_salva = $kyzt_cond; 
      if (!isset($kyzt_input_2) || $kyzt_input_2 == "")
      {
          $kyzt_input_2 = $kyzt;
      }
      $isbsxz_cond_salva = $isbsxz_cond; 
      if (!isset($isbsxz_input_2) || $isbsxz_input_2 == "")
      {
          $isbsxz_input_2 = $isbsxz;
      }
      $istb_cond_salva = $istb_cond; 
      if (!isset($istb_input_2) || $istb_input_2 == "")
      {
          $istb_input_2 = $istb;
      }
      $isrw_cond_salva = $isrw_cond; 
      if (!isset($isrw_input_2) || $isrw_input_2 == "")
      {
          $isrw_input_2 = $isrw;
      }
      $isqualified_cond_salva = $isqualified_cond; 
      if (!isset($isqualified_input_2) || $isqualified_input_2 == "")
      {
          $isqualified_input_2 = $isqualified;
      }
      ...
      if (is_array($kyzt)) {
          foreach ($kyzt as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['kyzt'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_kyzt'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($isbsxz)) {
          foreach ($isbsxz as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isbsxz'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isbsxz'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($istb)) {
          foreach ($istb as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['istb'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_istb'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($isrw)) {
          foreach ($isrw as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isrw'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isrw'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($isqualified)) {
          foreach ($isqualified as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['psq_check_ret']['isqualified'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_qysb_fld_isqualified'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['cgbbh'] = $cgbbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['cgbbh_cond'] = $cgbbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['cgbmc'] = $cgbmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['cgbmc_cond'] = $cgbmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['kyzt'] = $kyzt; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['kyzt_cond'] = $kyzt_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isbsxz'] = $isbsxz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isbsxz_cond'] = $isbsxz_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['istb'] = $istb; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['istb_cond'] = $istb_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isrw'] = $isrw; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isrw_cond'] = $isrw_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isqualified'] = $isqualified; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isqualified_cond'] = $isqualified_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_dia'] = $dlsj_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_mes'] = $dlsj_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_ano'] = $dlsj_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_dia'] = $dlsj_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_mes'] = $dlsj_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_ano'] = $dlsj_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_hor'] = $dlsj_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_min'] = $dlsj_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_seg'] = $dlsj_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_hor'] = $dlsj_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_min'] = $dlsj_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2_seg'] = $dlsj_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_cond'] = $dlsj_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['kyzt'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['kyzt'];
      $this->cmp_formatado['kyzt_input_2'] = $kyzt_input_2;
      $this->cmp_formatado['isbsxz'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isbsxz'];
      $this->cmp_formatado['isbsxz_input_2'] = $isbsxz_input_2;
      $this->cmp_formatado['istb'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['istb'];
      $this->cmp_formatado['istb_input_2'] = $istb_input_2;
      $this->cmp_formatado['isrw'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isrw'];
      $this->cmp_formatado['isrw_input_2'] = $isrw_input_2;
      $this->cmp_formatado['isqualified'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['isqualified'];
      $this->cmp_formatado['isqualified_input_2'] = $isqualified_input_2;
      ...
      {
         $this->and_or();
         if (strtoupper($kyzt_cond) == "DF" || strtoupper($kyzt_cond) == "NP")
         {
             $this->comando        .= " kyzt not in (";
             $this->comando_sum    .= " cg_qysb.kyzt not in (";
             $this->comando_filtro .= " kyzt not in (";
         }
         else
         {
             $this->comando        .= " kyzt in (";
             $this->comando_sum    .= " cg_qysb.kyzt in (";
             $this->comando_filtro .= " kyzt in (";
         }
         $x                     = count($kyzt);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label['kyzt'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      {
         $this->and_or();
         if (strtoupper($isbsxz_cond) == "DF" || strtoupper($isbsxz_cond) == "NP")
         {
             $this->comando        .= " isbsxz not in (";
             $this->comando_sum    .= " cg_qysb.isbsxz not in (";
             $this->comando_filtro .= " isbsxz not in (";
         }
         else
         {
             $this->comando        .= " isbsxz in (";
             $this->comando_sum    .= " cg_qysb.isbsxz in (";
             $this->comando_filtro .= " isbsxz in (";
         }
         $x                     = count($isbsxz);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label['isbsxz'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      {
         $this->and_or();
         if (strtoupper($istb_cond) == "DF" || strtoupper($istb_cond) == "NP")
         {
             $this->comando        .= " istb not in (";
             $this->comando_sum    .= " cg_qysb.istb not in (";
             $this->comando_filtro .= " istb not in (";
         }
         else
         {
             $this->comando        .= " istb in (";
             $this->comando_sum    .= " cg_qysb.istb in (";
             $this->comando_filtro .= " istb in (";
         }
         $x                     = count($istb);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label['istb'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      {
         $this->and_or();
         if (strtoupper($isrw_cond) == "DF" || strtoupper($isrw_cond) == "NP")
         {
             $this->comando        .= " isrw not in (";
             $this->comando_sum    .= " cg_qysb.isrw not in (";
             $this->comando_filtro .= " isrw not in (";
         }
         else
         {
             $this->comando        .= " isrw in (";
             $this->comando_sum    .= " cg_qysb.isrw in (";
             $this->comando_filtro .= " isrw in (";
         }
         $x                     = count($isrw);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label['isrw'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      $nm_aspas = "'";
      if (count($isqualified) != 0)
      {
         foreach ($isqualified as $i => $dados)
         {
            $tmp_pos = strpos($dados, "##@@");
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
      ...
      {
         $this->and_or();
         if (strtoupper($isqualified_cond) == "DF" || strtoupper($isqualified_cond) == "NP")
         {
             $this->comando        .= " isqualified not in (";
             $this->comando_sum    .= " cg_qysb.isqualified not in (";
             $this->comando_filtro .= " isqualified not in (";
         }
         else
         {
             $this->comando        .= " isqualified in (";
             $this->comando_sum    .= " cg_qysb.isqualified in (";
             $this->comando_filtro .= " isqualified in (";
         }
         $x                     = count($isqualified);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $nmgp_tab_label['isqualified'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if ($dlsj_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj'] = $val[0];
          ...
          if ($dlsj_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']['dlsj_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['where_pesq_ant'] = $this->comando . $this->comando_fim;

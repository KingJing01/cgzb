...
class grid_cg_qysb_ysb_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_cg_qysb_ysb.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_cg_qysb_ysb']['contr_erro'] = 'off'; 
   ...
   function NM_export_zbfile()
   {
         ...
         $this->zbfile = str_replace('<', '&lt;', $this->zbfile);
         $this->zbfile = str_replace('>', '&gt;', $this->zbfile);
         $this->Texto_tag .= "<td>" . $this->zbfile . "</td>\r\n";
   }
   //----- qytb
   function NM_export_qytb()
   {
         ...
         $this->qytb = str_replace('<', '&lt;', $this->qytb);
         $this->qytb = str_replace('>', '&gt;', $this->qytb);
         $this->Texto_tag .= "<td>" . $this->qytb . "</td>\r\n";
   }
   //----- cgbbh
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qysb_ysb']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_cg_qysb_ysb'] ?> :: RTF</TITLE>

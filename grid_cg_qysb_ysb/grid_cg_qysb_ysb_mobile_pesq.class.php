...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "dlsj";$Nm_numeric[] = "id";$Nm_numeric[] = "zbggbh";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_kyzt"  <?php echo $str_hide_kyzt?>> 
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_isbsxz"  <?php echo $str_hide_isbsxz?>> 
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_istb"  <?php echo $str_hide_istb?>> 
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_isrw"  <?php echo $str_hide_isrw?>> 
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_isqualified"  <?php echo $str_hide_isqualified?>> 
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_dlsj"  <?php echo $str_hide_dlsj?>>
<SPAN id="Nm_bi_dados_dlsj" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_dlsj"  style="display:''">
...
<INPUT type="hidden" id="sc_dlsj_jq">
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_dlsj"  <?php echo $str_display_dlsj; ?> class="scFilterFieldFontEven">

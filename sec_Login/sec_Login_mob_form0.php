...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags(""); } else { echo strip_tags("" . $_SESSION['SYS_NAME'] . ""); } ?></TITLE>
...
<?php
include_once("sec_Login_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('sec_Login_mob_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['recarga'];
}
?>
...
<?php
 include_once("sec_Login_mob_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['sec_Login_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['sec_Login_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_login_line" id="hidden_field_data_login" style="<?php echo $sStyleHidden_login; ?>"> <span class="scFormLabelOddFormat css_login_label"><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pswd_line" id="hidden_field_data_pswd" style="<?php echo $sStyleHidden_pswd; ?>"> <span class="scFormLabelOddFormat css_pswd_label"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
function captchaReloadImage() {
 ...
 document.getElementById("id_captcha_img").src = "sec_Login_mob_captcha_show.php?sid=" + sRand;
}
</script>
<table style="border-collapse: collapse; border-width: 0px">
 ...
 ?>
<img id="id_captcha_img" src="sec_Login_mob_captcha_show.php?sid=<?php echo md5(uniqid(time())); ?>" /></td><td><?php echo nmButtonOutput($this->arr_buttons, "bcaptchareload", "captchaReloadImage()", "captchaReloadImage()", "id_captcha_reload", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</td></tr></table></td>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("sec_Login_mob");
 parent.scAjaxDetailHeight("sec_Login_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}

...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_sec_Login_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_sec_Login_submit_form(var_login, var_pswd, var_links, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_captcha_code, var_csrf_token, do_ajax_sec_Login_submit_form_cb);

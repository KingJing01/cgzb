<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['blank_bg']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['blank_bg']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blank_bg']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank_bg']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blank_bg']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blank_bg']['glo_nm_path_doc']        = "";
//
class blank_bg_ini
{
   var $nm_cod_apl;
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_bg']['ancor_save'] = $_POST['ancor_save'];
...
// 
      ...
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blank_bg']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blank_bg']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blank_bg']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blank_bg']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blank_bg']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_bg']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_bg']['glo_nm_conexao'], $this->root . $this->path_prod, 'cgzb'); 
      } 
      else 
      { 
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           $delim  = "'";
           $delim1 = "'";
           if (isset($_SESSION['sc_session'][$this->sc_page]['blank_bg']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_bg']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blank_bg']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_bg']['SC_sep_date1'];
           }
...
//----- 
   function controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_bg']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank_bg']['sc_outra_jan']))
      {
          ...
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_bg']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank_bg') . "/";
  ...
  <table width='100%' height='100%'>
    <tr>
      <td width='100%' height='100%' valign='middle' align='center'>
        <img src='../_lib/img/grp__NM__img__NM__JwGlBg.jpg' border=0>
      </td>
    </tr>    
  </table>
</body>

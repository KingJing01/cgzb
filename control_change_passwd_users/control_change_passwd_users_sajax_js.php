  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_change_passwd_users" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_control_change_passwd_users_validate_new_password1()
  {
    var nomeCampo_new_password1 = "new_password1";
    var var_new_password1 = scAjaxGetFieldText(nomeCampo_new_password1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_change_passwd_users_validate_new_password1(var_new_password1, var_script_case_init, do_ajax_control_change_passwd_users_validate_new_password1_cb);
  } // do_ajax_control_change_passwd_users_validate_new_password1

  function do_ajax_control_change_passwd_users_validate_new_password1_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_change_passwd_users_validate_new_password1_cb

  // ---------- Validate new_password2
  function do_ajax_control_change_passwd_users_validate_new_password2()
  {
    var nomeCampo_new_password2 = "new_password2";
    var var_new_password2 = scAjaxGetFieldText(nomeCampo_new_password2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_change_passwd_users_validate_new_password2(var_new_password2, var_script_case_init, do_ajax_control_change_passwd_users_validate_new_password2_cb);
  } // do_ajax_control_change_passwd_users_validate_new_password2

  function do_ajax_control_change_passwd_users_validate_new_password2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_change_passwd_users_validate_new_password2_cb
  // ---------- Form
  function do_ajax_control_change_passwd_users_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_change_passwd_users_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_change_passwd_users_submit_form(var_new_password1, var_new_password2, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_change_passwd_users_submit_form_cb);
  } // do_ajax_control_change_passwd_users_submit_form

  function do_ajax_control_change_passwd_users_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_change_passwd_users_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_change_passwd_users_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_change_passwd_users_navigate_form

  function do_ajax_control_change_passwd_users_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_change_passwd_users_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_change_passwd_users_navigate_form_cb
  function sc_hide_control_change_passwd_users_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_change_passwd_users_form

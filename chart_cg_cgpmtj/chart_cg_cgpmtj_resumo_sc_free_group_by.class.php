...
class chart_cg_cgpmtj_resumo
{
   ...
   var $conv_col;
   var $count_ger;
   var $sc_proc_quebra_cgpm;
   var $count_cgpm;

   //---- 
   function chart_cg_cgpmtj_resumo($tipo = "")
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_cg_cgpmtj']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_cg_cgpmtj']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_cg_cgpmtj']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['campos_busca'];
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['chart_combination_type']        = 'pie3d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['chart_combination_order_field'] = '0';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_y_axys'][0] = 0;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['SC_Gb_Free_cmp']["cgpm"] = 'cgpm';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['SC_Gb_Free_sql']["cgpm"] = 'asc';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['comb_field_display_type'][1] = 'line';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['chart_display_values'][1] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_display'][1]['display'] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_order'][] = 1;
       }

      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['ajax_nav'])
      {
          $_SESSION['scriptcase']['saida_var'] = false; 
      }
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['contr_total_geral'] == "OK")
      {
          $this->array_total_cgpm = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['arr_total']['cgpm'];
      }
      else
      {
          $this->array_total_cgpm = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['arr_total']['cgpm'] = $this->array_total_cgpm;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['cgpm'] = "Cgpm";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['labels'][''] = "Cgpm"; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_control'] = array(
               'NM_Count' => array(
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['cgpm']['alin'] = "''";
       $Arr_parms['cgpm']['link'] = "N";
       $Arr_parms['cgpm']['fill'] = "true";
       $Arr_parms['cgpm']['order'] = "label";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['cgpm'] = array(0 => 'cgpm', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '0' => array(
               ...
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Cgpm")),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['summarizing_fields_order'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_cg_cgpmtj_' . session_id() . '_!!!C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__!!!.xml' : '',
                               'xml'         => 'sc_chart_cg_cgpmtj_' . session_id() . '_!!!C_' . $i_index_group . '_' . $s_index_comb . '!!!.xml',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_chart_cg_cgpmtj_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_chart_cg_cgpmtj_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_cg_cgpmtj']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_cg_cgpmtj']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_cg_cgpmtj']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_cg_cgpmtj']) . "_";
               } 
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_cg_cgpmtj_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] = "print";
      ...
      $this->total   = new chart_cg_cgpmtj_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_cgpm);
      ksort($this->array_total_cgpm);
      $this->total->quebra_geral();
   }
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_titl'] . " - " . $this->Ini->Nm_lang['lang_menu_chart_cgpmtj'] . "</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_cg_cgpmtj_ajax.js\"></script>\r\n");
      include_once($this->Ini->Apl_grafico);
      $sFusionChartModule = chart_cg_cgpmtj_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = chart_cg_cgpmtj_grafico::getChartModule('Bar');
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_cg_cgpmtj_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_cg_cgpmtj_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_cg_cgpmtj_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_cg_cgpmtj/chart_cg_cgpmtj_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['embutida'])
      {
         ...
         $nm_saida->saida("     <TD class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\">\r\n");
            ...
            $NM_btn = true;
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid) && !$this->NM_res_sem_reg)
      {
            ...
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_bar", "scChangeChartTypeButton('column3d')", "scChangeChartTypeButton('column3d')", "chart_bar_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_bar_top').css('display', 'none');\$('#chart_bar_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_bar_on", "scChangeChartTypeButton('column3d')", "scChangeChartTypeButton('column3d')", "chart_bar_on_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'bar'){\$('#chart_bar_on_top').css('display', 'none');\$('#chart_bar_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_pizza", "scChangeChartTypeButton('pie2d')", "scChangeChartTypeButton('pie2d')", "chart_pizza_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_pizza_top').css('display', 'none');\$('#chart_pizza_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_pizza_on", "scChangeChartTypeButton('pie2d')", "scChangeChartTypeButton('pie2d')", "chart_pizza_on_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'pie'){\$('#chart_pizza_on_top').css('display', 'none');\$('#chart_pizza_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
         $nm_saida->saida("     </TD> \r\n");
         ...
         if (is_file("chart_cg_cgpmtj_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_cg_cgpmtj_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['embutida'])
      {
         ...
         $nm_saida->saida("    <TR>\r\n");
         $nm_saida->saida("     <TD class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"left\">\r\n");
   $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsort_on", "scShowSort('#chart_sort_on_top')", "scShowSort('#chart_sort_on_top')", "chart_sort_on_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid) && !$this->NM_res_sem_reg)
      {
            ...
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_line", "scChangeChartTypeButton('line')", "scChangeChartTypeButton('line')", "chart_line_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_line_top').css('display', 'none');\$('#chart_line_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_line_on", "scChangeChartTypeButton('line')", "scChangeChartTypeButton('line')", "chart_line_on_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'line'){\$('#chart_line_on_top').css('display', 'none');\$('#chart_line_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_area", "scChangeChartTypeButton('area')", "scChangeChartTypeButton('area')", "chart_area_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_area_top').css('display', 'none');\$('#chart_area_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_area_on", "scChangeChartTypeButton('area')", "scChangeChartTypeButton('area')", "chart_area_on_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'area'){\$('#chart_area_on_top').css('display', 'none');\$('#chart_area_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_pizza", "scChangeChartTypeButton('pie2d')", "scChangeChartTypeButton('pie2d')", "chart_pizza_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_pizza_top').css('display', 'none');\$('#chart_pizza_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            ...
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_stack", "scChangeChartTypeButton('stackedcolumn3d')", "scChangeChartTypeButton('stackedcolumn3d')", "chart_stack_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_stack_top').css('display', 'none');\$('#chart_stack_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_stack_on", "scChangeChartTypeButton('stackedcolumn3d')", "scChangeChartTypeButton('stackedcolumn3d')", "chart_stack_on_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'stack'){\$('#chart_stack_on_top').css('display', 'none');\$('#chart_stack_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_combo", "scChangeChartTypeButton('combination3d')", "scChangeChartTypeButton('combination3d')", "chart_combo_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_combo_top').css('display', 'none');\$('#chart_combo_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_combo_on", "scChangeChartTypeButton('combination3d')", "scChangeChartTypeButton('combination3d')", "chart_combo_on_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'combo'){\$('#chart_combo_on_top').css('display', 'none');\$('#chart_combo_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_cg_cgpmtj/chart_cg_cgpmtj_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=zh_cn&conf_socor=S&is_chart_app=Y&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_cg_cgpmtj/chart_cg_cgpmtj_config_print.php?nm_opc=resumo&nm_cor=AM&language=zh_cn&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
   ...
   function monta_html_fim()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['graf_pdf'] == "S")
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_cg_cgpmtj_config_pivot.php?nome_apl=chart_cg_cgpmtj&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=zh_cn&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("</form>\r\n");
          ...
          $nm_saida->saida("   {\r\n");
          $nm_saida->saida("       window.open('" . $this->Ini->path_link . "chart_cg_cgpmtj/chart_cg_cgpmtj_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
          $nm_saida->saida("   }\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['chart_cg_cgpmtj_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_cg_cgpmtj@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
          $nm_saida->saida("  if (\"pdf\" == x)\r\n");
          $nm_saida->saida("  {\r\n");
          $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "chart_cg_cgpmtj/chart_cg_cgpmtj_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z;\r\n");
          $nm_saida->saida("  }\r\n");
          $nm_saida->saida("  else\r\n");
          $nm_saida->saida("  {\r\n");
          ...
          $nm_saida->saida(" }\r\n");
          $nm_saida->saida("</SCRIPT>\r\n");
          $nm_saida->saida("<div style=\"border-color: #888888; border-style: solid; border-width: 1px; box-shadow: 5px 5px 5px 0 #888888; position: absolute; background-color: #FFFFFF; padding: 10px 0 0 0; display: none; z-index: 1000\" id=\"sc-id-combination-table\">\r\n");
          $nm_saida->saida(" <div style=\"text-align: center; height: 30px\"><span onclick=\"scHideCombinationTable()\" class=\"scButton_default\" style=\"padding: 3px 15px\">" . $this->Ini->Nm_lang['lang_chart_button_close'] . "</span></div>\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_cg_cgpmtj_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_cg_cgpmtj/chart_cg_cgpmtj_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_charts']))
   {
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_cg_cgpmtj_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . $this->Ini->Nm_lang['lang_othr_chart_titl'] . " - " . $this->Ini->Nm_lang['lang_menu_chart_cgpmtj'] . "</span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($quebra_cgpm, $quebra_cgpm_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT id, cgbbh, cgbmc, cgpm from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT id, cgbbh, cgbmc, cgpm from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['where_pesq']; 
     $temp = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_cg_cgpmtj']['SC_Gb_Free_sql'] as $cmp_gb => $ord)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cgbbh = $rs_res->fields[1] ;  
            $this->cgbmc = $rs_res->fields[2] ;  
            $this->cgpm = $rs_res->fields[3] ;  
            $this->cgpm_orig = $this->cgpm;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cgpm, $this->cgpm_orig);
            }
   }
//

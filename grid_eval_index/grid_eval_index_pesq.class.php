...
class grid_eval_index_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_eval_index_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_eval_index_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_eval_index_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_content')
      {
          $content = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_content($content);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cpbbh')
      {
          $cpbbh = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cpbbh($cpbbh);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_dimension')
      {
          $dimension = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_dimension($dimension);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_content($content)
   {
      $content = substr($this->Db->qstr($content), 1, -1);
            $content_look = substr($this->Db->qstr($content), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct content from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and  content like '%" . $content . "%'"; 
   ...
   function lookup_ajax_id($id)
   {
      ...
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and  id like '%" . $id . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and  id like '%" . $id . "%'"; 
   ...
   function lookup_ajax_cpbbh($cpbbh)
   {
      $cpbbh = substr($this->Db->qstr($cpbbh), 1, -1);
            $cpbbh_look = substr($this->Db->qstr($cpbbh), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct cpbbh from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and  cpbbh like '%" . $cpbbh . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct cpbbh from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and  cpbbh like '%" . $cpbbh . "%'"; 
   ...
   function lookup_ajax_dimension($dimension)
   {
      $dimension = substr($this->Db->qstr($dimension), 1, -1);
            $dimension_look = substr($this->Db->qstr($dimension), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dimension from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and  dimension like '%" . $dimension . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_eval_index'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_eval_index/grid_eval_index_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_eval_index_ajax_search.js"></script>
 <script type="text/javascript" src="grid_eval_index_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_content_cond#NMF#' + search_get_sel_txt('SC_content_cond') + '@NMF@';
  str_out += 'SC_content#NMF#' + search_get_text('SC_content') + '@NMF@';
  str_out += 'id_ac_content#NMF#' + search_get_text('id_ac_content') + '@NMF@';
  ...
  str_out += 'SC_cpbbh_cond#NMF#' + search_get_sel_txt('SC_cpbbh_cond') + '@NMF@';
  str_out += 'SC_cpbbh#NMF#' + search_get_text('SC_cpbbh') + '@NMF@';
  str_out += 'id_ac_cpbbh#NMF#' + search_get_text('id_ac_cpbbh') + '@NMF@';
  str_out += 'SC_cpbbh_input_2#NMF#' + search_get_text('SC_cpbbh_input_2') + '@NMF@';
  str_out += 'SC_dimension_cond#NMF#' + search_get_sel_txt('SC_dimension_cond') + '@NMF@';
  str_out += 'SC_dimension#NMF#' + search_get_text('SC_dimension') + '@NMF@';
  str_out += 'id_ac_dimension#NMF#' + search_get_text('id_ac_dimension') + '@NMF@';
   ...
   $("#id_ac_dimension").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_dimension",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_dimension").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_dimension").val( $(this).val() );
       }
     }
   });
   $("#id_ac_content").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_content",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_content").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_content").val( $(this).val() );
       }
     }
   });
   ...
   $("#id_ac_cpbbh").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cpbbh",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_cpbbh").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cpbbh").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_eval_index'] ?></span></td>
...
<?php
   ...
   {
      global 
             $content_cond, $content, $content_autocomp,
             $id_cond, $id, $id_input_2, $id_autocomp,
             $cpbbh_cond, $cpbbh, $cpbbh_input_2, $cpbbh_autocomp,
             $dimension_cond, $dimension, $dimension_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $content = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['content']; 
          $content_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['content_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['id']; 
          $id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['id_input_2']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['id_cond']; 
          $cpbbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['cpbbh']; 
          $cpbbh_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['cpbbh_input_2']; 
          $cpbbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['cpbbh_cond']; 
          $dimension = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['dimension']; 
          $dimension_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['dimension_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['NM_operador']; 
      } 
      if (!isset($content_cond) || empty($content_cond))
      {
         $content_cond = "qp";
      }
      ...
      if (!isset($cpbbh_cond) || empty($cpbbh_cond))
      {
         $cpbbh_cond = "gt";
      }
      if (!isset($dimension_cond) || empty($dimension_cond))
      {
         $dimension_cond = "qp";
      }
      ...
      $str_hide_content = (in_array($content_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id = (in_array($id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cpbbh = (in_array($cpbbh_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_dimension = (in_array($dimension_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id = ('bw' == $id_cond) ? $display_aberto : $display_fechado;
      $str_display_cpbbh = ('bw' == $cpbbh_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($content, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $content = substr($content, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      if (!isset($cpbbh) || $cpbbh == "")
      {
          $cpbbh = "";
      }
      if (isset($cpbbh) && !empty($cpbbh))
      {
         $tmp_pos = strpos($cpbbh, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cpbbh = substr($cpbbh, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($dimension, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $dimension = substr($dimension, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_eval_index_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['content'])) ? $this->New_label['content'] : "" . $this->Ini->Nm_lang['lang_eval_index_fld_content'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_content_cond" name="content_cond" onChange="nm_campos_between(document.getElementById('id_vis_content'), this, 'content')">
       <OPTION value="qp" <?php if ("qp" == $content_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $content_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $content_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $content_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_content" <?php echo $str_hide_content?> valign="top">
 ...
 $nmgp_tab_label .= "content?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $content_look = substr($this->Db->qstr($content), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct content from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and content = '$content_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$content]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$content];
      }
      else
      {
          $sAutocompValue = $content;
      }
?>
<INPUT  type="text" id="SC_content" name="content" value="<?php echo NM_encode_input($content) ?>" size=50 alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_content" name="content_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id'])) ? $this->New_label['id'] : "" . $this->Ini->Nm_lang['lang_eval_index_fld_id'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id" <?php echo $str_hide_id?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id'])) ? $this->New_label['id'] : "" . $this->Ini->Nm_lang['lang_eval_index_fld_id'] . "";
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and id = $id_look"; 
      }
      else
      {
          $nm_comando = "select distinct id from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and id = $id_look"; 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cpbbh'])) ? $this->New_label['cpbbh'] : "" . $this->Ini->Nm_lang['lang_eval_index_fld_cpbbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cpbbh_cond" name="cpbbh_cond" onChange="nm_campos_between(document.getElementById('id_vis_cpbbh'), this, 'cpbbh')">
       <OPTION value="gt" <?php if ("gt" == $cpbbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cpbbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cpbbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $cpbbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cpbbh" <?php echo $str_hide_cpbbh?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cpbbh'])) ? $this->New_label['cpbbh'] : "" . $this->Ini->Nm_lang['lang_eval_index_fld_cpbbh'] . "";
 $nmgp_tab_label .= "cpbbh?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $cpbbh_look = substr($this->Db->qstr($cpbbh), 1, -1); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct cpbbh from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and cpbbh = $cpbbh_look"; 
      }
      else
      {
          $nm_comando = "select distinct cpbbh from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and cpbbh = $cpbbh_look"; 
      ...
      if (isset($nmgp_def_dados[0][$cpbbh]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$cpbbh];
      }
      else
      {
          $sAutocompValue = $cpbbh;
      }
?>
<INPUT  type="text" id="SC_cpbbh" name="cpbbh" value="<?php echo NM_encode_input($cpbbh) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cpbbh" name="cpbbh_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_cpbbh"  <?php echo $str_display_cpbbh; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_cpbbh_input_2" name="cpbbh_input_2" value="<?php echo NM_encode_input($cpbbh_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['dimension'])) ? $this->New_label['dimension'] : "" . $this->Ini->Nm_lang['lang_eval_index_fld_dimension'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_dimension_cond" name="dimension_cond" onChange="nm_campos_between(document.getElementById('id_vis_dimension'), this, 'dimension')">
       <OPTION value="qp" <?php if ("qp" == $dimension_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $dimension_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $dimension_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $dimension_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_dimension" <?php echo $str_hide_dimension?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['dimension'])) ? $this->New_label['dimension'] : "" . $this->Ini->Nm_lang['lang_eval_index_fld_dimension'] . "";
 $nmgp_tab_label .= "dimension?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $dimension_look = substr($this->Db->qstr($dimension), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dimension from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and dimension = '$dimension_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$dimension]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$dimension];
      }
      else
      {
          $sAutocompValue = $dimension;
      }
?>
<INPUT  type="text" id="SC_dimension" name="dimension" value="<?php echo NM_encode_input($dimension) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_dimension" name="dimension_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_eval_index']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_eval_index']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_content'), document.F1.content_cond, 'content');
   document.F1.content.value = "";
   document.F1.content_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_cpbbh'), document.F1.cpbbh_cond, 'cpbbh');
   document.F1.cpbbh.value = "";
   document.F1.cpbbh_autocomp.value = "";
   document.F1.cpbbh_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_dimension'), document.F1.dimension_cond, 'dimension');
   document.F1.dimension.value = "";
   document.F1.dimension_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_content_cond'] = 'cond';
      $tp_fields['SC_content'] = 'text_aut';
      $tp_fields['id_ac_content'] = 'text_aut';
      $tp_fields['SC_id_cond'] = 'cond';
      $tp_fields['SC_id'] = 'text_aut';
      $tp_fields['id_ac_id'] = 'text_aut';
      $tp_fields['SC_id_input_2'] = 'text';
      $tp_fields['SC_cpbbh_cond'] = 'cond';
      $tp_fields['SC_cpbbh'] = 'text_aut';
      $tp_fields['id_ac_cpbbh'] = 'text_aut';
      $tp_fields['SC_cpbbh_input_2'] = 'text';
      $tp_fields['SC_dimension_cond'] = 'cond';
      $tp_fields['SC_dimension'] = 'text_aut';
      $tp_fields['id_ac_dimension'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $content_cond, $content, $content_autocomp,
             $id_cond, $id, $id_input_2, $id_autocomp,
             $cpbbh_cond, $cpbbh, $cpbbh_input_2, $cpbbh_autocomp,
             $dimension_cond, $dimension, $dimension_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($content_autocomp) && empty($content))
      {
          $content = $content_autocomp;
      }
      if (!empty($id_autocomp) && empty($id))
      {
          $id = $id_autocomp;
      }
      if (!empty($cpbbh_autocomp) && empty($cpbbh))
      {
          $cpbbh = $cpbbh_autocomp;
      }
      if (!empty($dimension_autocomp) && empty($dimension))
      {
          $dimension = $dimension_autocomp;
      }
      $content_cond_salva = $content_cond; 
      if (!isset($content_input_2) || $content_input_2 == "")
      {
          $content_input_2 = $content;
      }
      ...
      $cpbbh_cond_salva = $cpbbh_cond; 
      if (!isset($cpbbh_input_2) || $cpbbh_input_2 == "")
      {
          $cpbbh_input_2 = $cpbbh;
      }
      $dimension_cond_salva = $dimension_cond; 
      if (!isset($dimension_input_2) || $dimension_input_2 == "")
      {
          $dimension_input_2 = $dimension;
      }
      if ($id_cond != "in")
      {
      ...
      if ($cpbbh_cond != "in")
      {
          nm_limpa_numero($cpbbh, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $cpbbh);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
          ...
          $cpbbh = implode(",", $Nm_sc_valores);
      }
      if ($cpbbh_cond != "in")
      {
          nm_limpa_numero($cpbbh_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['content'] = $content; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['content_cond'] = $content_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['id_input_2'] = $id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['cpbbh'] = $cpbbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['cpbbh_input_2'] = $cpbbh_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['cpbbh_cond'] = $cpbbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['dimension'] = $dimension; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['dimension_cond'] = $dimension_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_cond != "in" && $id_cond != "bw" && !empty($id) && !is_numeric($id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_eval_index_fld_id'] . "";
      }
      if ($id_cond == "bw" && ((!empty($id) && !is_numeric($id)) || (!empty($id_input_2) && !is_numeric($id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_eval_index_fld_id'] . "";
      }
      if ($cpbbh_cond != "in" && $cpbbh_cond != "bw" && !empty($cpbbh) && !is_numeric($cpbbh))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_eval_index_fld_cpbbh'] . "";
      }
      if ($cpbbh_cond == "bw" && ((!empty($cpbbh) && !is_numeric($cpbbh)) || (!empty($cpbbh_input_2) && !is_numeric($cpbbh_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_eval_index_fld_cpbbh'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['content'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['content'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['content'] = $content;
      }
      $id_look = substr($this->Db->qstr($id), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id))
   ...
   { 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['cpbbh'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cpbbh'] = $cpbbh;
      }
      $Conteudo = $cpbbh_input_2;
      if (strtoupper($cpbbh_cond) != "II" && strtoupper($cpbbh_cond) != "QP" && strtoupper($cpbbh_cond) != "NP" && strtoupper($cpbbh_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['cpbbh_input_2'] = $Conteudo;
      $dimension_look = substr($this->Db->qstr($dimension), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct dimension from " . $this->Ini->nm_tabela . " where cpbbh=  ' " . $_SESSION['cpbbh'] . "' and dimension = '$dimension_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['dimension'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['dimension'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['dimension'] = $dimension;
      }

      //----- $content
      $this->Date_part = false;
      if (isset($content) || $content_cond == "nu" || $content_cond == "nn" || $content_cond == "ep" || $content_cond == "ne")
      {
         $this->monta_condicao("content", $content_cond, $content, "", "content");
      }
      ...
      //----- $cpbbh
      $this->Date_part = false;
      if (isset($cpbbh) || $cpbbh_cond == "nu" || $cpbbh_cond == "nn" || $cpbbh_cond == "ep" || $cpbbh_cond == "ne")
      {
         $this->monta_condicao("cpbbh", $cpbbh_cond, $cpbbh, $cpbbh_input_2, "cpbbh");
      }

      //----- $dimension
      $this->Date_part = false;
      if (isset($dimension) || $dimension_cond == "nu" || $dimension_cond == "nn" || $dimension_cond == "ep" || $dimension_cond == "ne")
      {
         $this->monta_condicao("dimension", $dimension_cond, $dimension, "", "dimension");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_eval_index']['where_pesq_ant'] = $this->comando . $this->comando_fim;

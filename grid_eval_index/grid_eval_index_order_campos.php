<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_eval_index_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_eval_index_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['dimension'] = "dimension";
   $tab_converte["dimension"]   = "dimension";
   $tab_labels["dimension"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_index']['labels']["dimension"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_index']['labels']["dimension"] : "" . $this->Nm_lang['lang_eval_index_fld_dimension'] . "";
   $tab_ger_campos['content'] = "on";
   $tab_def_campos['content'] = "content";
   $tab_converte["content"]   = "content";
   $tab_labels["content"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_index']['labels']["content"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_index']['labels']["content"] : "" . $this->Nm_lang['lang_eval_index_fld_content'] . "";
   $tab_ger_campos['weight'] = "on";
   $tab_def_campos['weight'] = "weight";
   $tab_converte["weight"]   = "weight";
   $tab_labels["weight"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_index']['labels']["weight"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_index']['labels']["weight"] : "" . $this->Nm_lang['lang_eval_index_fld_weight'] . "";
   $tab_ger_campos['list_order'] = "on";
   $tab_def_campos['list_order'] = "list_order";
   $tab_converte["list_order"]   = "list_order";
   $tab_labels["list_order"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_eval_index']['labels']["list_order"])) ? $_SESSION['sc_session'][$sc_init]['grid_eval_index']['labels']["list_order"] : "" . $this->Nm_lang['lang_eval_index_fld_list_order'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_eval_index']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_eval_index']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_eval_index']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_eval_index']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_eval_index']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_eval_index']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_eval_index']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_eval_index']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_eval_index']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_eval_index_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_eval_index']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_eval_index']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {

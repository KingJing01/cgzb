...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["cgzb_____grid_eval_index"]))
   {
      unset($_SESSION['session_sec_aplicacao']["cgzb_____grid_eval_index"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_eval_index'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eval_index']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_eval_index']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eval_index']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_eval_index']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_eval_index']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_eval_index']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_eval_index']['embutida_filho'] as $ind => $sc_init)
          {

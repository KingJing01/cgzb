...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "cpbbh";$Nm_numeric[] = "weight";$Nm_numeric[] = "list_order";$Nm_numeric[] = "id";$Nm_numeric[] = "cpbbh";$Nm_numeric[] = "weight";$Nm_numeric[] = "list_order";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_content"  <?php echo $str_hide_content?>><?php
      $content_look = substr($this->Db->qstr($content), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_cpbbh"  <?php echo $str_hide_cpbbh?>><?php
      $cpbbh_look = substr($this->Db->qstr($cpbbh), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($cpbbh))
   { 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cpbbh" name="cpbbh_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_cpbbh"  <?php echo $str_display_cpbbh; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_cpbbh_input_2" name="cpbbh_input_2" value="<?php echo NM_encode_input($cpbbh_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_dimension"  <?php echo $str_hide_dimension?>><?php
      $dimension_look = substr($this->Db->qstr($dimension), 1, -1); 
      $nmgp_def_dados = array(); 

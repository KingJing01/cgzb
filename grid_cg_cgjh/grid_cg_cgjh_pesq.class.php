...
class grid_cg_cgjh_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_cgjh_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_cgjh_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_cgjh_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_cgjh'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_cgjh/grid_cg_cgjh_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_cgjh_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_cgjh_ajax.js"></script>
 <script type="text/javascript">
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_cgjh'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $xmbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmbh']; 
          $xmbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmbh_cond']; 
          $xmmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmmc']; 
          $xmmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmmc_cond']; 
          $xmfzr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmfzr']; 
          $xmfzr_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmfzr_cond']; 
          $zjly = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['zjly']; 
          $zjly_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['zjly_cond']; 
          $sbbm = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbbm']; 
          $sbbm_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbbm_cond']; 
          $sbrq_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_dia']; 
          $sbrq_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_mes']; 
          $sbrq_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_ano']; 
          $sbrq_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_input_2_dia']; 
          $sbrq_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_input_2_mes']; 
          $sbrq_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_input_2_ano']; 
          $sbrq_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_cond']; 
          $shzt = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['shzt']; 
          $shzt_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['shzt_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("grid_cg_cgjh_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['xmbh'])) ? $this->New_label['xmbh'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_xmbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_xmbh" <?php echo $str_hide_xmbh?> valign="top">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_xmbh" name="xmbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['xmmc'])) ? $this->New_label['xmmc'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_xmmc'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_xmmc" <?php echo $str_hide_xmmc?> valign="top">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_xmmc" name="xmmc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['xmfzr'])) ? $this->New_label['xmfzr'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_xmfzr'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_xmfzr" <?php echo $str_hide_xmfzr?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_xmfzr" name="xmfzr_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['zjly'])) ? $this->New_label['zjly'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_zjly'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_zjly" <?php echo $str_hide_zjly?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['psq_check_ret']['zjly'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['psq_check_ret']['zjly'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['sbbm'])) ? $this->New_label['sbbm'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_sbbm'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sbbm" <?php echo $str_hide_sbbm?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['psq_check_ret']['sbbm'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['psq_check_ret']['sbbm'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['sbrq'])) ? $this->New_label['sbrq'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_sbrq'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
     ...
     <TD  class="scFilterFieldEven"><SPAN id="Nm_bi_dados_sbrq" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_sbrq"  style=display:  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sbrq" <?php echo $str_hide_sbrq?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<INPUT type="hidden" id="sc_sbrq_jq">
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_sbrq"  <?php echo $str_display_sbrq; ?> class="scFilterFieldFontEven">
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['shzt'])) ? $this->New_label['shzt'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_shzt'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['psq_check_ret']['shzt'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['psq_check_ret']['shzt'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['orig_pesq'] == "grid")
   {
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_sbrq_dia').bind('change', function() {sc_grid_cg_cgjh_valida_dia(this)});
    $('#SC_sbrq_input_2_dia').bind('change', function() {sc_grid_cg_cgjh_valida_dia(this)});
    $('#SC_sbrq_input_2_mes').bind('change', function() {sc_grid_cg_cgjh_valida_mes(this)});
    $('#SC_sbrq_mes').bind('change', function() {sc_grid_cg_cgjh_valida_mes(this)});
 }
 function sc_grid_cg_cgjh_valida_dia(obj)
 {
 ...
 function sc_grid_cg_cgjh_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if (is_array($zjly)) {
          foreach ($zjly as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['psq_check_ret']['zjly'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_zjly'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($sbbm)) {
          foreach ($sbbm as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['psq_check_ret']['sbbm'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_sbbm'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($shzt)) {
          foreach ($shzt as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['psq_check_ret']['shzt'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_shzt'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmbh'] = $xmbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmbh_cond'] = $xmbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmmc'] = $xmmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmmc_cond'] = $xmmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmfzr'] = $xmfzr; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['xmfzr_cond'] = $xmfzr_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['zjly'] = $zjly; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['zjly_cond'] = $zjly_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbbm'] = $sbbm; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbbm_cond'] = $sbbm_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_dia'] = $sbrq_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_mes'] = $sbrq_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_ano'] = $sbrq_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_input_2_dia'] = $sbrq_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_input_2_mes'] = $sbrq_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_input_2_ano'] = $sbrq_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_cond'] = $sbrq_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['shzt'] = $shzt; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['shzt_cond'] = $shzt_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['zjly'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['zjly'];
      $this->cmp_formatado['zjly_input_2'] = $zjly_input_2;
      $this->cmp_formatado['sbbm'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbbm'];
      $this->cmp_formatado['sbbm_input_2'] = $sbbm_input_2;
      $this->cmp_formatado['shzt'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['shzt'];
      ...
      if (count($zjly) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label['zjly'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($sbbm) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label['sbbm'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if ($sbrq_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq'] = $val[0];
          ...
          if ($sbrq_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']['sbrq_input_2'] = $val[1];
      ...
      if (count($shzt) != 0)
      {
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $nmgp_tab_label['shzt'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_ant'] = $this->comando . $this->comando_fim;

...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
       }
   }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
   { 
   ...
   { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != 'print')
       { 
           $this->html_interativ_search();
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ajax_nav'])
           { 
               $tb_disp = (!empty($this->nm_grid_sem_reg) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_int_search']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'TB_Interativ_Search', 'value' => $tb_disp);
           } 
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_int_search'] = false;
       $nm_saida->saida("      </TD>\r\n");
       $nm_saida->saida("      <TD valign='top'>\r\n");
       $nm_saida->saida("       <table width='100%' cellspacing=0 cellpadding=0>\r\n");
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_cg_cgjh'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'];
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "pdf")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "pdf")
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] = "igual";
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'];
 }
...
//
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['doc_word'])
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['force_toolbar']);
   } 
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['mostra_edit'] = "N";
       }
   }
   ...
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_cg_cgjh", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['SC_Gb_Free_cmp']))
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_ant'];  
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campos_busca']))
   { 
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_filtro'];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] = "muda_qt_linhas";
   } 
   $this->New_label['xmbh'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_xmbh'] . "";
   $this->New_label['xmmc'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_xmmc'] . "";
   $this->New_label['ysje'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_ysje'] . "";
   $this->New_label['zjly'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_zjly'] . "";
   $this->New_label['xmfzr'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_xmfzr'] . "";
   $this->New_label['sbbm'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_sbbm'] . "";
   $this->New_label['sbrq'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_sbrq'] . "";
   $this->New_label['shzt'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_shzt'] . "";
   $this->New_label['sbr'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_sbr'] . "";
   $this->New_label['qwcgrq'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_qwcgrq'] . "";
   $this->New_label['lxr'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_lxr'] . "";
   $this->New_label['lxdh'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_lxdh'] . "";
   $this->New_label['email'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_email'] . "";
   $this->New_label['cjsj'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_cjsj'] . "";
   $this->New_label['id'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_id'] . "";
   $this->New_label['bz'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_bz'] . "";
   $this->New_label['fa'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_fa'] . "";
   $this->New_label['bg'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_bg'] . "";
   $this->New_label['ps'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_ps'] . "";
   $this->New_label['ifjs'] = "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_ifjs'] . "";
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_sql_btn_run'] = array(); 
   $this->NM_btn_run_show = ($this->Ini->SC_Link_View || $this->grid_emb_form || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida']) ? false : true;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq']) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "print" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "pdf") 
   { 
      $this->NM_btn_run_show = false;
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_cg_cgjh/grid_cg_cgjh_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_cg_cgjh_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_cg_cgjh_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid']; 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_select'] = array(); 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_select']; 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_quebra'][$nmgp_ordem])) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] = "inicio" ;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_grid'] = ""; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_quebra'][$nmgp_ordem] == "asc") 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_quebra'][$nmgp_ordem] = "desc"; 
           }   
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_quebra'][$nmgp_ordem] = "asc"; 
           }   
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp'] = $nmgp_ordem;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_quebra'][$nmgp_ordem]);  
       }   
       else   
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_grid'] = $nmgp_ordem  ; 
       }   
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao']       = "igual" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_sjshlc']['opcao_print'] = "print" ; 
   } 
// 
   $this->count_ger = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid'] == "all") 
   { 
       $this->Tot->quebra_geral() ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_total']);
       $this->Tot->quebra_geral() ; 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   { 
       $nmgp_select = "SELECT xmbh, xmmc, ysje, zjly, xmfzr, sbbm, sbrq, shzt, sbr, qwcgrq, lxr, lxdh, email, cjsj, id from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT xmbh, xmmc, ysje, zjly, xmfzr, sbbm, sbrq, shzt, sbr, qwcgrq, lxr, lxdh, email, cjsj, id from " . $this->Ini->nm_tabela; 
   } 
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "pdf" || isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['paginacao']))
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $this->sbr = $this->rs_grid->fields[8] ;  
       $this->qwcgrq = $this->rs_grid->fields[9] ;  
       $this->lxr = $this->rs_grid->fields[10] ;  
       $this->lxdh = $this->rs_grid->fields[11] ;  
       $this->email = $this->rs_grid->fields[12] ;  
       $this->cjsj = $this->rs_grid->fields[13] ;  
       $this->id = $this->rs_grid->fields[14] ;  
       $this->id = (string)$this->id;
       $this->SC_seq_register = $this->nmgp_reg_start ; 
       $this->SC_seq_page = 0;
       $this->SC_sep_quebra = false;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_cgjh'] ?> :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['pivot_charts']) : 0;
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_cg_cgjh'] . "</TITLE>\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . session_id() . "\">\r\n");
           $nm_saida->saida("   </form>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_cg_cgjh_jquery.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_cg_cgjh_ajax.js\"></script>\r\n");
           ...
           $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid']) . ";\r\n");
           $nm_saida->saida("  function scSetFixedHeaders() {\r\n");
           $nm_saida->saida("   var divScroll, gridHeaders, headerPlaceholder;\r\n");
           $nm_saida->saida("   gridHeaders = $(\".sc-ui-grid-header-row-grid_cg_cgjh-1\");\r\n");
           ...
           $nm_saida->saida("   tableOriginal = $(\"#sc-ui-grid-body-df321a22\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cg_cgjh_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
       {
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cg_cgjh_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_cg_cgjh_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_cg_cgjh_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['doc_word'])
       { 
       ...
       $nm_saida->saida("       <TABLE width='100%' cellspacing=0 cellpadding=0>\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print") 
       { 
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_grid_cg_cgjh\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_grid_cg_cgjh\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_grid_cg_cgjh\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_grid_cg_cgjh\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_grid_cg_cgjh\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_grid_cg_cgjh\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
   }  
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_cg_cgjh']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_cg_cgjh']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_cg_cgjh']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_cg_cgjh']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida']) ? "grid_cg_cgjh_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho()
 {
   global
          $nm_saida;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sv_dt_head']['fix'] = $nm_data_fixa;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")
   { 
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_cg_cgjh'] . "</span></td>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_cg_cgjh__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_cg_cgjh-" . $tmp_header_row . "\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq']) { 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_cjsj_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['field_order'] as $Cada_label)
   { 
       $NM_func_lab = "NM_label_" . $Cada_label;
       $this->$NM_func_lab();
   } 
   $nm_saida->saida("</TR>\r\n");
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_label'])
     { 
         if (isset($_SESSION['scriptcase']['saida_var']) && $_SESSION['scriptcase']['saida_var'])
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".grid_cg_cgjh_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['xmbh'])) ? $this->New_label['xmbh'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_xmbh'] . ""; 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp'] == 'xmbh')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] == "desc")
          {
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['xmmc'])) ? $this->New_label['xmmc'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_xmmc'] . ""; 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp'] == 'xmmc')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['ysje'])) ? $this->New_label['ysje'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_ysje'] . ""; 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp'] == 'ysje')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['zjly'])) ? $this->New_label['zjly'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_zjly'] . ""; 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp'] == 'zjly')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['xmfzr'])) ? $this->New_label['xmfzr'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_xmfzr'] . ""; 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['sbbm'])) ? $this->New_label['sbbm'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_sbbm'] . ""; 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp'] == 'sbbm')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['sbrq'])) ? $this->New_label['sbrq'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_sbrq'] . ""; 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp'] == 'sbrq')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['shzt'])) ? $this->New_label['shzt'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_shzt'] . ""; 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp'] == 'shzt')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['sbr'])) ? $this->New_label['sbr'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_sbr'] . ""; 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['qwcgrq'])) ? $this->New_label['qwcgrq'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_qwcgrq'] . ""; 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_cmp'] == 'qwcgrq')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['lxr'])) ? $this->New_label['lxr'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_lxr'] . ""; 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['lxdh'])) ? $this->New_label['lxdh'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_lxdh'] . ""; 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['email'])) ? $this->New_label['email'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_email'] . ""; 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['cjsj'])) ? $this->New_label['cjsj'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_cjsj'] . ""; 
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['xmbh'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['xmmc'])) ? $this->New_label['xmmc'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['xmmc'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ysje'])) ? $this->New_label['ysje'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['ysje'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['zjly'])) ? $this->New_label['zjly'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['zjly'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['xmfzr'])) ? $this->New_label['xmfzr'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['xmfzr'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['sbbm'])) ? $this->New_label['sbbm'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['sbbm'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['sbrq'])) ? $this->New_label['sbrq'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['sbrq'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['shzt'])) ? $this->New_label['shzt'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['shzt'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['splc'])) ? $this->New_label['splc'] : "操作"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['splc'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['splcxx'])) ? $this->New_label['splcxx'] : "审批信息"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['splcxx'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['sbr'])) ? $this->New_label['sbr'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['sbr'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['qwcgrq'])) ? $this->New_label['qwcgrq'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['qwcgrq'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['lxr'])) ? $this->New_label['lxr'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['lxr'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['lxdh'])) ? $this->New_label['lxdh'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['lxdh'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['email'])) ? $this->New_label['email'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['email'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cjsj'])) ? $this->New_label['cjsj'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['labels']['cjsj'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_cgjh']['lig_edit'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ajax_nav'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_refresh'])
   {
       $this->refresh_interativ_search();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_refresh'] = false;
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_cg_cgjh#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cab_embutida'] != "S")
               {
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_cg_cgjh\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_cg_cgjh\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_grid_cg_cgjh\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_grid_cg_cgjh\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_grid_cg_cgjh\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_grid_cg_cgjh\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
       $nm_saida->saida("</TABLE>\r\n");
   ...
   { 
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_cg_cgjh\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_cg_cgjh\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_grid_cg_cgjh#?#1\"";
   } 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-df321a22\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['cab_embutida'] != "S" )
      { 
...
// 
   ...
   $ini_grid = true;
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
          ...
          {
              $this->SC_seq_btn_run++;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_sql_btn_run'][$this->SC_seq_btn_run] = $this->rs_grid->fields;
          }
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final'] + 1; 
          if (!$ini_grid) {
          ...
          $_SESSION['scriptcase']['grid_cg_cgjh']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_cg_cgjh']['contr_erro'] = 'off';
          $nm_inicio_pag++;
          if (!$this->NM_flag_antigo)
          {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final']++ ; 
          }
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['mostra_edit'] != "N"){ 
              $Sc_parent = ($this->grid_emb_form_full) ? "S" : "";
              if (isset($this->Ini->sc_lig_md5["form_cg_cgjh"]) && $this->Ini->sc_lig_md5["form_cg_cgjh"] == "S")
              {
                  $Parms_Edt  = "id?#?" . str_replace('"', "@aspasd@", $this->id) . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?nmgp_opcao?#?igual?@?";
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_cg_cgjh@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
                  $Md5_Edt  = "id?#?" . str_replace('"', "@aspasd@", $this->id) . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?nmgp_opcao?#?igual?@?";
              }
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_form_cg_cgjh . "', '$this->nm_location',  '$Md5_Edt' , '_self', '', 'form_cg_cgjh', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_form_cg_cgjh . "', '$this->nm_location',  '$Md5_Edt' , '_self', '', 'form_cg_cgjh', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['mostra_edit'] == "N"){ 
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['field_order'] as $Cada_col)
          { 
              $NM_func_grid = "NM_grid_" . $Cada_col;
              $this->$NM_func_grid();
          } 
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['exibe_total'] == "S")
       { 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
 ...
 if (!$this->Ini->SC_Link_View && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && $_SESSION['scriptcase']['contr_link_emb'] != "pdf" && $conteudo != "&nbsp;"){ $this->Ind_lig_mult++;
       if (isset($this->Ini->sc_lig_md5["form_cg_sjshlc"]) && $this->Ini->sc_lig_md5["form_cg_sjshlc"] == "S") {
           ...
           $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_cg_cgjh@SC_par@" . md5($Parms_Lig);
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
       } else {
 ...
 function NM_grid_splcxx()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_splcxx_grid_line . "\"  style=\"" . $this->Css_Cmp['css_splcxx_grid_line'] . "\"  align=\"\" valign=\"\"  >\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_sjshlc']['embutida_treeview'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_pdf'] != "pdf")
          { 
              $link_div = "";
          ...
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'])
              { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['emb_lig_aba'] = array_merge($this->Ini->Init_apl_lig, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_sjshlc']['emb_lig_aba']);
              }
              else 
              { 
 ...
 {
   $this->NM_colspan  = 17;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] || $this->NM_btn_run_show)
   {
       $this->NM_colspan++;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function quebra_geral_top() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['fast_search'][2] : "";
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $UseAlias =  "S";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&embbed_groupby=Y&toolbar_pos=top', 'top')", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=0&apapel=0&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=zh_cn&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr><tr><td class=\"scBtnGrpBackground\">\r\n");
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_config_word.php?nm_cor=AM&language=zh_cn&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
          ...
          $nm_saida->saida("            </div>\r\n");
              ...
              $nm_saida->saida("           </td></tr><tr><td class=\"scBtnGrpBackground\">\r\n");
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_config_print.php?nm_opc=AM&nm_cor=AM&language=zh_cn&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      { 
        ...
        if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['new'] == "on" && $this->nmgp_botoes['insert'] == "on" && !$this->grid_emb_form)
        {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bnovo", "nm_gp_submit1('" .  $this->Ini->link_form_cg_cgjh . "', '$this->nm_location', '$Md5_Lig', '_self', 'form_cg_cgjh'); return false;", "nm_gp_submit1('" .  $this->Ini->link_form_cg_cgjh . "', '$this->nm_location', '$Md5_Lig', '_self', 'form_cg_cgjh'); return false;", "sc_b_new_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
         $NM_btn = true;
        }
          if (is_file("grid_cg_cgjh_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_cg_cgjh_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['paginacao']))
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['paginacao']))
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['nav']) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['paginacao']))
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['nav']))
          {
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            </div>\r\n");
              ...
              $nm_saida->saida("           </td></tr><tr><td class=\"scBtnGrpBackground\">\r\n");
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
   ...
   {
       global $nm_saida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label'] = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['shzt'] = (isset($this->New_label['shzt'])) ? $this->New_label['shzt'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_shzt'] . "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['sbbm'] = (isset($this->New_label['sbbm'])) ? $this->New_label['sbbm'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_sbbm'] . "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['zjly'] = (isset($this->New_label['zjly'])) ? $this->New_label['zjly'] : "" . $this->Ini->Nm_lang['lang_cg_cgjh_fld_zjly'] . "";
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['shzt'])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['shzt'])) ? "none" : "";
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['shzt'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq']))
       {
           $nm_comando .= " " .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['where_pesq'];
       }
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['shzt'])) ? "" : "none";
       ...
       foreach ($result as $dados => $qtd_result)
       {
           ...
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['shzt']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['shzt']) . "','shzt','id_int_search_shzt','shzt', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['shzt']) . "','shzt','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'shzt', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['shzt']) . "','shzt','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'shzt', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       if (count($result) > 1)
       {
           ...
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['shzt']) . "','shzt','id_int_search_shzt','shzt', '');", "nm_proc_int_search('chbx', 'tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['shzt']) . "','shzt','id_int_search_shzt','shzt', '');", "app_int_search_shzt", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['sbbm'])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['sbbm'])) ? "none" : "";
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['sbbm'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['sbbm'])) ? "" : "none";
       ...
       foreach ($result as $dados => $qtd_result)
       {
           ...
           $lin_obj  .= "  <table cellspacing=0 cellpadding=0>";
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['sbbm']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['sbbm']) . "','sbbm','id_int_search_sbbm','sbbm', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['sbbm']) . "','sbbm','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'sbbm', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['sbbm']) . "','sbbm','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'sbbm', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       if (count($result) > 1)
       {
           ...
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['sbbm']) . "','sbbm','id_int_search_sbbm','sbbm', '');", "nm_proc_int_search('chbx', 'tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['sbbm']) . "','sbbm','id_int_search_sbbm','sbbm', '');", "app_int_search_sbbm", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['zjly'])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['zjly'])) ? "none" : "";
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['zjly'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['zjly'])) ? "" : "none";
       ...
       foreach ($result as $dados => $qtd_result)
       {
           ...
           $lin_obj  .= "  <table cellspacing=0 cellpadding=0>";
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['interativ_search']['zjly']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['zjly']) . "','zjly','id_int_search_zjly','zjly', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['zjly']) . "','zjly','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'zjly', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['zjly']) . "','zjly','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'zjly', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       if (count($result) > 1)
       {
           ...
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['zjly']) . "','zjly','id_int_search_zjly','zjly', '');", "nm_proc_int_search('chbx', 'tx','" . addslashes($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['int_search_label']['zjly']) . "','zjly','id_int_search_zjly','zjly', '');", "app_int_search_zjly", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_grid_cg_cgjh\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_grid_cg_cgjh\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </div>\r\n");
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           if ($this->arr_buttons['bcons_avanca']['type'] != 'image')
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
   ...
   {
       $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('grid_cg_cgjh', $(document).innerHeight());\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
 }
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_cg_cgjh\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_cg_cgjh_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_modal']) || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_proc_container']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_proc_container'])) {
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_cg_cgjh';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_cg_cgjh');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_cg_cgjh');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_cg_cgjh');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_cg_cgjh');} \r\n");
   ...
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['grid_cg_cgjh_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_cg_cgjh@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   $nm_saida->saida("       if (\"pdf\" == x)\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_cg_cgjh/grid_cg_cgjh_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=print&tp_print=' + tp + '&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campo_psq_ret']))
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_cg_cgjh']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Doc = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Doc = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Doc = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_cg_cgjh_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_cgjh']['reg_start']))
   {
       $nm_saida->saida("      parent.scAjaxDetailStatus('grid_cg_cgjh');\r\n");
       $nm_saida->saida("      parent.scAjaxDetailHeight('grid_cg_cgjh', $(document).innerHeight());\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
 }

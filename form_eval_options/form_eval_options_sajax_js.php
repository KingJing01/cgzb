  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_eval_options" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate optionname_
  function do_ajax_form_eval_options_validate_optionname_(iNumLinha)
  {
    var nomeCampo_optionname_ = "optionname_" + iNumLinha;
    var var_optionname_ = scAjaxGetFieldText(nomeCampo_optionname_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eval_options_validate_optionname_(var_optionname_, iNumLinha, var_script_case_init, do_ajax_form_eval_options_validate_optionname__cb);
  } // do_ajax_form_eval_options_validate_optionname_

  function do_ajax_form_eval_options_validate_optionname__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "optionname_" + iLineNumber;
    }
    else
    {
      sFieldValid = "optionname_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "optionname_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "optionname_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eval_options_validate_optionname__cb

  // ---------- Validate grade_
  function do_ajax_form_eval_options_validate_grade_(iNumLinha)
  {
    var nomeCampo_grade_ = "grade_" + iNumLinha;
    var var_grade_ = scAjaxGetFieldText(nomeCampo_grade_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eval_options_validate_grade_(var_grade_, iNumLinha, var_script_case_init, do_ajax_form_eval_options_validate_grade__cb);
  } // do_ajax_form_eval_options_validate_grade_

  function do_ajax_form_eval_options_validate_grade__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "grade_" + iLineNumber;
    }
    else
    {
      sFieldValid = "grade_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "grade_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "grade_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eval_options_validate_grade__cb

  // ---------- Validate list_order_
  function do_ajax_form_eval_options_validate_list_order_(iNumLinha)
  {
    var nomeCampo_list_order_ = "list_order_" + iNumLinha;
    var var_list_order_ = scAjaxGetFieldText(nomeCampo_list_order_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eval_options_validate_list_order_(var_list_order_, iNumLinha, var_script_case_init, do_ajax_form_eval_options_validate_list_order__cb);
  } // do_ajax_form_eval_options_validate_list_order_

  function do_ajax_form_eval_options_validate_list_order__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "list_order_" + iLineNumber;
    }
    else
    {
      sFieldValid = "list_order_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "list_order_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "list_order_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_eval_options_validate_list_order__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_eval_options_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_eval_options_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_eval_options_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_eval_options_add_new_line_cb);
  } // do_ajax_form_eval_options_add_new_line

  function do_ajax_form_eval_options_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_eval_options_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_eval_options_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_eval_options_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_eval_options_backup_line_cb);
  } // do_ajax_form_eval_options_backup_line

  function do_ajax_form_eval_options_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_eval_options_backup_line_cb

  function do_ajax_form_eval_options_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_eval_options_cancel_insert

  function do_ajax_form_eval_options_cancel_update(iSeqVert)
  {
    do_ajax_form_eval_options_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_eval_options_cancel_update

  function do_ajax_form_eval_options_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_eval_options_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_eval_options_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_eval_options_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_eval_options_table_refresh_cb);
  } //  do_ajax_form_eval_options_table_refresh

  function do_ajax_form_eval_options_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_eval_options_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_eval_options_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_eval_options_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_optionname_ = scAjaxGetFieldText("optionname_" + iNumLinha);
    var var_grade_ = scAjaxGetFieldText("grade_" + iNumLinha);
    var var_list_order_ = scAjaxGetFieldText("list_order_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_eval_options_submit_form(var_optionname_, var_grade_, var_list_order_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_eval_options_submit_form_cb);
  } // do_ajax_form_eval_options_submit_form

  function do_ajax_form_eval_options_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("optionname_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("grade_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("list_order_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_eval_options_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_eval_options_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_eval_options_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("optionname_" + iNavForm);
      scAjaxHideErrorDisplay("grade_" + iNavForm);
      scAjaxHideErrorDisplay("list_order_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_eval_options_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_eval_options_navigate_form_cb);
  } // do_ajax_form_eval_options_navigate_form

  function do_ajax_form_eval_options_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_eval_options_navigate_form_cb
  function sc_hide_form_eval_options_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_eval_options_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "optionname_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "grade_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "list_order_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["optionname_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_eval_options_fld_optionname'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["grade_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_eval_options_fld_grade'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["list_order_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_eval_options_fld_list_order'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["optionname_"][iNumLinha] = "optionname_" + iNumLinha;
    ajax_field_mult["grade_"][iNumLinha] = "grade_" + iNumLinha;
    ajax_field_mult["list_order_"][iNumLinha] = "list_order_" + iNumLinha;
    ajax_field_id["optionname_" + iNumLinha] = new Array("hidden_field_label_optionname_", "hidden_field_data_optionname_" + iNumLinha);
    ajax_field_id["grade_" + iNumLinha] = new Array("hidden_field_label_grade_", "hidden_field_data_grade_" + iNumLinha);
    ajax_field_id["list_order_" + iNumLinha] = new Array("hidden_field_label_list_order_", "hidden_field_data_list_order_" + iNumLinha);
    ajax_error_count["optionname_" + iNumLinha] = "off";
    ajax_error_count["grade_" + iNumLinha] = "off";
    ajax_error_count["list_order_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["optionname_" + iNumLinha] = "off";
    ajax_read_only["grade_" + iNumLinha] = "off";
    ajax_read_only["list_order_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["optionname_" + iNumLinha] = "on";
    ajax_read_only["grade_" + iNumLinha] = "on";
    ajax_read_only["list_order_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["optionname_" + iNumLinha] = null;
    ajax_error_list["grade_" + iNumLinha] = null;
    ajax_error_list["list_order_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "optionname_": new Array(),
    "grade_": new Array(),
    "list_order_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["optionname_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["optionname_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["optionname_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["optionname_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["optionname_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["grade_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["grade_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["grade_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["grade_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["grade_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["list_order_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["list_order_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["list_order_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["list_order_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["list_order_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['optionname_'])) ? $this->nmgp_cmp_readonly['optionname_'] : 'off';
?>
    scAjaxFieldRead("optionname_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['grade_'])) ? $this->nmgp_cmp_readonly['grade_'] : 'off';
?>
    scAjaxFieldRead("grade_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['list_order_'])) ? $this->nmgp_cmp_readonly['list_order_'] : 'off';
?>
    scAjaxFieldRead("list_order_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("optionname_" + iSeq, "on");
    scAjaxFieldRead("grade_" + iSeq, "on");
    scAjaxFieldRead("list_order_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["optionname_" + iRow] || "on" == ajax_error_count["grade_" + iRow] || "on" == ajax_error_count["list_order_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_optionname_" + iRow))
        document.getElementById("hidden_field_data_optionname_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_grade_" + iRow))
        document.getElementById("hidden_field_data_grade_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_list_order_" + iRow))
        document.getElementById("hidden_field_data_list_order_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["optionname_" + iRow] && "off" == ajax_error_count["grade_" + iRow] && "off" == ajax_error_count["list_order_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["optionname_" + iRow] = "off";
        ajax_error_count["grade_" + iRow] = "off";
        ajax_error_count["list_order_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_optionname_" + iRow))
        document.getElementById("hidden_field_data_optionname_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_grade_" + iRow))
        document.getElementById("hidden_field_data_grade_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_list_order_" + iRow))
        document.getElementById("hidden_field_data_list_order_" + iRow).className = sCssLine;
    }
  }

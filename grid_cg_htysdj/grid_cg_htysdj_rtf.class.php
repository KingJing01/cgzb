...
class grid_cg_htysdj_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_cg_htysdj.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['rtf_name']);
      }
   ...
   function NM_export_ysjg()
   {
         ...
         $this->ysjg = str_replace('<', '&lt;', $this->ysjg);
         $this->ysjg = str_replace('>', '&gt;', $this->ysjg);
         $this->Texto_tag .= "<td>" . $this->ysjg . "</td>\r\n";
   }
   //----- ysjd
   function NM_export_ysjd()
   {
         ...
         $this->ysjd = str_replace('<', '&lt;', $this->ysjd);
         $this->ysjd = str_replace('>', '&gt;', $this->ysjd);
         $this->Texto_tag .= "<td>" . $this->ysjd . "</td>\r\n";
   }
   //----- ysfzr
   function NM_export_ysfzr()
   {
         ...
         $this->ysfzr = str_replace('<', '&lt;', $this->ysfzr);
         $this->ysfzr = str_replace('>', '&gt;', $this->ysfzr);
         $this->Texto_tag .= "<td>" . $this->ysfzr . "</td>\r\n";
   }
   //----- ysdjrq
   function NM_export_ysdjrq()
   {
         ...
         if (!NM_is_utf8($this->ysdjrq))
         {
             $this->ysdjrq = sc_convert_encoding($this->ysdjrq, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->ysdjrq = str_replace('<', '&lt;', $this->ysdjrq);
         $this->ysdjrq = str_replace('>', '&gt;', $this->ysdjrq);
         $this->Texto_tag .= "<td>" . $this->ysdjrq . "</td>\r\n";
   }
   //----- cgbbh
   ...
   function NM_export_sjysrq()
   {
         ...
         if (!NM_is_utf8($this->sjysrq))
         {
             $this->sjysrq = sc_convert_encoding($this->sjysrq, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->sjysrq = str_replace('<', '&lt;', $this->sjysrq);
         $this->sjysrq = str_replace('>', '&gt;', $this->sjysrq);
         $this->Texto_tag .= "<td>" . $this->sjysrq . "</td>\r\n";
   }
   //----- dlsj
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_htysdj'] ?> :: RTF</TITLE>

<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_htysdj_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_htysdj_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["htmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["htmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["htmc"] : "" . $this->Nm_lang['lang_cg_htysdj_fld_htmc'] . "";
   $tab_ger_campos['htbh'] = "on";
   $tab_def_campos['htbh'] = "htbh";
   $tab_converte["htbh"]   = "htbh";
   $tab_labels["htbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["htbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["htbh"] : "" . $this->Nm_lang['lang_cg_htysdj_fld_htbh'] . "";
   $tab_ger_campos['ysjg'] = "on";
   $tab_def_campos['ysjg'] = "ysjg";
   $tab_converte["ysjg"]   = "ysjg";
   $tab_labels["ysjg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["ysjg"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["ysjg"] : "" . $this->Nm_lang['lang_cg_htysdj_fld_ysjg'] . "";
   $tab_ger_campos['ysjd'] = "on";
   $tab_def_campos['ysjd'] = "ysjd";
   $tab_converte["ysjd"]   = "ysjd";
   $tab_labels["ysjd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["ysjd"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["ysjd"] : "" . $this->Nm_lang['lang_cg_htysdj_fld_ysjd'] . "";
   $tab_ger_campos['ysfzr'] = "on";
   $tab_def_campos['ysfzr'] = "ysfzr";
   $tab_converte["ysfzr"]   = "ysfzr";
   $tab_labels["ysfzr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["ysfzr"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["ysfzr"] : "" . $this->Nm_lang['lang_cg_htysdj_fld_ysfzr'] . "";
   $tab_ger_campos['ysdjrq'] = "on";
   $tab_def_campos['ysdjrq'] = "ysdjrq";
   $tab_converte["ysdjrq"]   = "ysdjrq";
   $tab_labels["ysdjrq"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["ysdjrq"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['labels']["ysdjrq"] : "" . $this->Nm_lang['lang_cg_htysdj_fld_ysdjrq'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_htysdj'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_htysdj_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_htysdj']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {

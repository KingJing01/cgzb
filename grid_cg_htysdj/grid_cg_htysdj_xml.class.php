...
class grid_cg_htysdj_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_cg_htysdj.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_cg_htysdj";
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->ysjg))
         {
             $this->ysjg = sc_convert_encoding($this->ysjg, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " ysjg =\"" . $this->trata_dados($this->ysjg) . "\"";
   }
   //----- ysjd
   function NM_export_ysjd()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->ysjd))
         {
             $this->ysjd = sc_convert_encoding($this->ysjd, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " ysjd =\"" . $this->trata_dados($this->ysjd) . "\"";
   }
   //----- ysfzr
   function NM_export_ysfzr()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->ysfzr))
         {
             $this->ysfzr = sc_convert_encoding($this->ysfzr, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " ysfzr =\"" . $this->trata_dados($this->ysfzr) . "\"";
   }
   //----- ysdjrq
   function NM_export_ysdjrq()
   {
         $conteudo_x = $this->ysdjrq;
         nm_conv_limpa_dado($conteudo_x, "YYYY-MM-DD");
         if (is_numeric($conteudo_x) && $conteudo_x > 0) 
         { 
             $this->nm_data->SetaData($this->ysdjrq, "YYYY-MM-DD");
             $this->ysdjrq = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "ddmmaaaa"));
         } 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->ysdjrq))
         {
             $this->ysdjrq = sc_convert_encoding($this->ysdjrq, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " ysdjrq =\"" . $this->trata_dados($this->ysdjrq) . "\"";
   }
   //----- cgbbh
   ...
   {
         $conteudo_x = $this->sjysrq;
         nm_conv_limpa_dado($conteudo_x, "YYYY-MM-DD");
         if (is_numeric($conteudo_x) && $conteudo_x > 0) 
         { 
             $this->nm_data->SetaData($this->sjysrq, "YYYY-MM-DD");
             $this->sjysrq = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "ddmmaaaa"));
         } 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->sjysrq))
         {
             $this->sjysrq = sc_convert_encoding($this->sjysrq, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " sjysrq =\"" . $this->trata_dados($this->sjysrq) . "\"";
   }
   //----- dlsj
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htysdj']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_htysdj'] ?> :: XML</TITLE>

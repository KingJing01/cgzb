...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_ygbh"  <?php echo $str_hide_ygbh?>><?php
      $ygbh_look = substr($this->Db->qstr($ygbh), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_ygxm"  <?php echo $str_hide_ygxm?>><?php
      $ygxm_look = substr($this->Db->qstr($ygxm), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_bm"  <?php echo $str_hide_bm?>>
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_zw"  <?php echo $str_hide_zw?>>
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_xb"  <?php echo $str_hide_xb?>> 
<?php

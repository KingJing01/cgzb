...
class grid_cg_staff_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_staff_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_staff_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_staff_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ygbh')
      {
          $ygbh = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ygbh($ygbh);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ygxm')
      {
          $ygxm = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ygxm($ygxm);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_ygbh($ygbh)
   {
      $ygbh = substr($this->Db->qstr($ygbh), 1, -1);
            $ygbh_look = substr($this->Db->qstr($ygbh), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ygbh from " . $this->Ini->nm_tabela . " where  ygbh like '%" . $ygbh . "%'"; 
   ...
   function lookup_ajax_ygxm($ygxm)
   {
      $ygxm = substr($this->Db->qstr($ygxm), 1, -1);
            $ygxm_look = substr($this->Db->qstr($ygxm), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ygxm from " . $this->Ini->nm_tabela . " where  ygxm like '%" . $ygxm . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_staff'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_staff/grid_cg_staff_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_staff_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_staff_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_ygbh_cond#NMF#' + search_get_sel_txt('SC_ygbh_cond') + '@NMF@';
  str_out += 'SC_ygbh#NMF#' + search_get_text('SC_ygbh') + '@NMF@';
  str_out += 'id_ac_ygbh#NMF#' + search_get_text('id_ac_ygbh') + '@NMF@';
  str_out += 'SC_ygxm_cond#NMF#' + search_get_sel_txt('SC_ygxm_cond') + '@NMF@';
  str_out += 'SC_ygxm#NMF#' + search_get_text('SC_ygxm') + '@NMF@';
  str_out += 'id_ac_ygxm#NMF#' + search_get_text('id_ac_ygxm') + '@NMF@';
  str_out += 'SC_bm_cond#NMF#' + search_get_sel_txt('SC_bm_cond') + '@NMF@';
  str_out += 'SC_bm#NMF#' + search_get_checkbox('SC_bm') + '@NMF@';
  str_out += 'SC_zw_cond#NMF#' + search_get_sel_txt('SC_zw_cond') + '@NMF@';
  str_out += 'SC_zw#NMF#' + search_get_checkbox('SC_zw') + '@NMF@';
   ...
   $("#id_ac_ygbh").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ygbh",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_ygbh").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ygbh").val( $(this).val() );
       }
     }
   });
   $("#id_ac_ygxm").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ygxm",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_ygxm").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ygxm").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_staff'] ?></span></td>
...
<?php
   ...
   {
      global 
             $ygbh_cond, $ygbh, $ygbh_autocomp,
             $ygxm_cond, $ygxm, $ygxm_autocomp,
             $bm_cond, $bm,
             $zw_cond, $zw,
             $xb_cond, $xb,
             $kyzt_cond, $kyzt,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $ygbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['ygbh']; 
          $ygbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['ygbh_cond']; 
          $ygxm = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['ygxm']; 
          $ygxm_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['ygxm_cond']; 
          $bm = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['bm']; 
          $bm_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['bm_cond']; 
          $zw = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['zw']; 
          $zw_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['zw_cond']; 
          $xb = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['xb']; 
          $xb_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['xb_cond']; 
          $kyzt = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['kyzt']; 
          $kyzt_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['kyzt_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['NM_operador']; 
      } 
      if (!isset($ygbh_cond) || empty($ygbh_cond))
      {
         $ygbh_cond = "qp";
      }
      if (!isset($ygxm_cond) || empty($ygxm_cond))
      {
         $ygxm_cond = "qp";
      }
      if (!isset($bm_cond) || empty($bm_cond))
      {
         $bm_cond = "qp";
      }
      if (!isset($zw_cond) || empty($zw_cond))
      {
         $zw_cond = "qp";
      }
      ...
      $str_hide_ygbh = (in_array($ygbh_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ygxm = (in_array($ygxm_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_bm = (in_array($bm_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_zw = (in_array($zw_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      // bm
      if (is_array($bm) && !empty($bm))
      {
         $tmp_array = array();
         $bm_val_str = "";
         foreach ($bm as $tmp_val_cmp)
         {
            if ("" != $bm_val_str)
            {
               $bm_val_str .= ", ";
      ...
      // zw
      if (is_array($zw) && !empty($zw))
      {
         $tmp_array = array();
         $zw_val_str = "";
         foreach ($zw as $tmp_val_cmp)
         {
            if ("" != $zw_val_str)
            {
               $zw_val_str .= ", ";
...
<?php
   if (is_file("grid_cg_staff_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['ygbh'])) ? $this->New_label['ygbh'] : "" . $this->Ini->Nm_lang['lang_cg_staff_fld_ygbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ygbh_cond" name="ygbh_cond" onChange="nm_campos_between(document.getElementById('id_vis_ygbh'), this, 'ygbh')">
       <OPTION value="qp" <?php if ("qp" == $ygbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ygbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ygbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ygbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ygbh" <?php echo $str_hide_ygbh?> valign="top">
 ...
 $nmgp_tab_label .= "ygbh?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $ygbh_look = substr($this->Db->qstr($ygbh), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ygbh from " . $this->Ini->nm_tabela . " where ygbh = '$ygbh_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$ygbh]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ygbh];
      }
      else
      {
          $sAutocompValue = $ygbh;
...
?>
<INPUT  type="text" id="SC_ygbh" name="ygbh" value="<?php echo NM_encode_input($ygbh) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ygbh" name="ygbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['ygxm'])) ? $this->New_label['ygxm'] : "" . $this->Ini->Nm_lang['lang_cg_staff_fld_ygxm'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ygxm_cond" name="ygxm_cond" onChange="nm_campos_between(document.getElementById('id_vis_ygxm'), this, 'ygxm')">
       <OPTION value="qp" <?php if ("qp" == $ygxm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ygxm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ygxm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ygxm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ygxm" <?php echo $str_hide_ygxm?> valign="top">
 ...
 $nmgp_tab_label .= "ygxm?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $ygxm_look = substr($this->Db->qstr($ygxm), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ygxm from " . $this->Ini->nm_tabela . " where ygxm = '$ygxm_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$ygxm]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ygxm];
      }
      else
      {
          $sAutocompValue = $ygxm;
...
?>
<INPUT  type="text" id="SC_ygxm" name="ygxm" value="<?php echo NM_encode_input($ygxm) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_ygxm" name="ygxm_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['bm'])) ? $this->New_label['bm'] : "" . $this->Ini->Nm_lang['lang_cg_staff_fld_bm'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_bm_cond" name="bm_cond" onChange="nm_campos_between(document.getElementById('id_vis_bm'), this, 'bm')">
       <OPTION value="qp" <?php if ("qp" == $bm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $bm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $bm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $bm_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_bm" <?php echo $str_hide_bm?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['bm'])) ? $this->New_label['bm'] : "" . $this->Ini->Nm_lang['lang_cg_staff_fld_bm'] . "";
 $nmgp_tab_label .= "bm?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>

<?php
      $bm_look = substr($this->Db->qstr($bm), 1, -1); 
      $nmgp_def_dados = "" ; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['bm'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['bm'][] = trim($rs->fields[0]);
      ...
      echo "<span id=\"idAjaxCheckbox_bm\">\r\n";
      echo "        <TABLE border=\"0px\" cellpadding=\"0px\">\r\n";
      echo "         <TR>\r\n";
      if (!isset($bm) || !is_array($bm))
      {
         $bm = array();
      }
      for ($j = 0; $j < sizeof($nm_opcoes); $j++)
      {
         if (!empty($nm_opcoes[$j]))
         {
            ...
            echo "           <INPUT class=\"scFilterObjectOdd\" type=\"checkbox\" id=\"SC_bm\" name=\"bm[]\" value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\" $tmp_cmp_sel $tmp_cmp_click>$nm_opc_val\r\n";
            echo "          </TD>\r\n";
            $i++;
     ...
     echo "         <TR>\r\n";
     echo "          <TD colspan=2>\r\n";
     echo "           <IMG SRC=\"" . $this->Ini->path_img_global . "/img_select_all.gif\" ALIGN=\"absmiddle\" onClick=\"nm_marca_check('bm', 'N'); return false;\" style=\"cursor: pointer\">&nbsp;\r\n";
     echo "           <IMG SRC=\"" . $this->Ini->path_img_global . "/img_select_none.gif\" ALIGN=\"absmiddle\" onClick=\"nm_limpa_check('bm', 'N'); return false;\" style=\"cursor: pointer\">\r\n";
     echo "         </TR>\r\n";
      echo "        </TABLE>\r\n";
      echo "</span>\r\n";
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['zw'])) ? $this->New_label['zw'] : "" . $this->Ini->Nm_lang['lang_cg_staff_fld_zw'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_zw_cond" name="zw_cond" onChange="nm_campos_between(document.getElementById('id_vis_zw'), this, 'zw')">
       <OPTION value="qp" <?php if ("qp" == $zw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $zw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $zw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $zw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_zw" <?php echo $str_hide_zw?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['zw'])) ? $this->New_label['zw'] : "" . $this->Ini->Nm_lang['lang_cg_staff_fld_zw'] . "";
 $nmgp_tab_label .= "zw?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>

<?php
      $zw_look = substr($this->Db->qstr($zw), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT mc, mc  FROM dm_work  ORDER BY mc"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['zw'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['zw'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
      ...
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      echo "<span id=\"idAjaxCheckbox_zw\">\r\n";
      echo "        <TABLE border=\"0px\" cellpadding=\"0px\">\r\n";
      echo "         <TR>\r\n";
      if (!isset($zw) || !is_array($zw))
      {
         $zw = array();
      }
      for ($j = 0; $j < sizeof($nm_opcoes); $j++)
      {
         if (!empty($nm_opcoes[$j]))
         {
            ...
            echo "           <INPUT class=\"scFilterObjectEven\" type=\"checkbox\" id=\"SC_zw\" name=\"zw[]\" value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\" $tmp_cmp_sel $tmp_cmp_click>$nm_opc_val\r\n";
            echo "          </TD>\r\n";
            $i++;
     ...
     echo "         <TR>\r\n";
     echo "          <TD colspan=3>\r\n";
     echo "           <IMG SRC=\"" . $this->Ini->path_img_global . "/img_select_all.gif\" ALIGN=\"absmiddle\" onClick=\"nm_marca_check('zw', 'N'); return false;\" style=\"cursor: pointer\">&nbsp;\r\n";
     echo "           <IMG SRC=\"" . $this->Ini->path_img_global . "/img_select_none.gif\" ALIGN=\"absmiddle\" onClick=\"nm_limpa_check('zw', 'N'); return false;\" style=\"cursor: pointer\">\r\n";
     echo "         </TR>\r\n";
      echo "        </TABLE>\r\n";
      echo "</span>\r\n";
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['xb'])) ? $this->New_label['xb'] : "" . $this->Ini->Nm_lang['lang_cg_staff_fld_xb'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['xb'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['xb'][] = "男";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['xb'][] = "女";
 ?>
...
<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
 ...
 <TD colspan=2>
  ...
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('xb', 'N'); return false;" style="cursor: pointer">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['kyzt'])) ? $this->New_label['kyzt'] : "" . $this->Ini->Nm_lang['lang_cg_staff_fld_kyzt'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_kyzt_cond" name="kyzt_cond" onChange="nm_campos_between(document.getElementById('id_vis_kyzt'), this, 'kyzt')">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['kyzt'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['kyzt'][] = "是";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['kyzt'][] = "否";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_kyzt" name="kyzt[]" value="是##@@是"  <?php if (in_array("是", $kyzt))  { echo " checked" ;} ?>>是</TD>
  <TD class="scFilterFieldFontEven"><INPUT class="scFilterObjectEven" type="checkbox" id="SC_kyzt" name="kyzt[]" value="否##@@否"  <?php if (in_array("否", $kyzt))  { echo " checked" ;} ?>>否</TD>
</TR><TR>
 <TD colspan=2>
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_staff']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_staff']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_ygbh'), document.F1.ygbh_cond, 'ygbh');
   document.F1.ygbh.value = "";
   document.F1.ygbh_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_ygxm'), document.F1.ygxm_cond, 'ygxm');
   document.F1.ygxm.value = "";
   document.F1.ygxm_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_bm'), document.F1.bm_cond, 'bm');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'bm[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
   nm_campos_between(document.getElementById('id_vis_zw'), document.F1.zw_cond, 'zw');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'zw[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_ygbh_cond'] = 'cond';
      $tp_fields['SC_ygbh'] = 'text_aut';
      $tp_fields['id_ac_ygbh'] = 'text_aut';
      $tp_fields['SC_ygxm_cond'] = 'cond';
      $tp_fields['SC_ygxm'] = 'text_aut';
      $tp_fields['id_ac_ygxm'] = 'text_aut';
      $tp_fields['SC_bm_cond'] = 'cond';
      $tp_fields['SC_bm'] = 'checkbox';
      $tp_fields['SC_zw_cond'] = 'cond';
      $tp_fields['SC_zw'] = 'checkbox';
   ...
   {
      global $ygbh_cond, $ygbh, $ygbh_autocomp,
             $ygxm_cond, $ygxm, $ygxm_autocomp,
             $bm_cond, $bm,
             $zw_cond, $zw,
             $xb_cond, $xb,
             $kyzt_cond, $kyzt, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($ygbh_autocomp) && empty($ygbh))
      {
          $ygbh = $ygbh_autocomp;
      }
      if (!empty($ygxm_autocomp) && empty($ygxm))
      {
          $ygxm = $ygxm_autocomp;
      }
      $ygbh_cond_salva = $ygbh_cond; 
      if (!isset($ygbh_input_2) || $ygbh_input_2 == "")
      {
          $ygbh_input_2 = $ygbh;
      }
      $ygxm_cond_salva = $ygxm_cond; 
      if (!isset($ygxm_input_2) || $ygxm_input_2 == "")
      {
          $ygxm_input_2 = $ygxm;
      }
      $bm_cond_salva = $bm_cond; 
      if (!isset($bm_input_2) || $bm_input_2 == "")
      {
          $bm_input_2 = $bm;
      }
      $zw_cond_salva = $zw_cond; 
      if (!isset($zw_input_2) || $zw_input_2 == "")
      {
          $zw_input_2 = $zw;
      }
      ...
      if (is_array($bm)) {
          foreach ($bm as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['bm'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_staff_fld_bm'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($zw)) {
          foreach ($zw as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['zw'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_staff_fld_zw'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($xb)) {
          foreach ($xb as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['xb'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_staff_fld_xb'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      if (is_array($kyzt)) {
          foreach ($kyzt as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['psq_check_ret']['kyzt'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_staff_fld_kyzt'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['ygbh'] = $ygbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['ygbh_cond'] = $ygbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['ygxm'] = $ygxm; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['ygxm_cond'] = $ygxm_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['bm'] = $bm; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['bm_cond'] = $bm_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['zw'] = $zw; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['zw_cond'] = $zw_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['xb'] = $xb; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['xb_cond'] = $xb_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['kyzt'] = $kyzt; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['kyzt_cond'] = $kyzt_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['ygbh'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ygbh'] = $ygbh;
      }
      $ygxm_look = substr($this->Db->qstr($ygxm), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ygxm from " . $this->Ini->nm_tabela . " where ygxm = '$ygxm_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['ygxm'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ygxm'] = $ygxm;
      }
      $this->cmp_formatado['bm'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['bm'];
      $this->cmp_formatado['bm_input_2'] = $bm_input_2;
      $this->cmp_formatado['zw'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['zw'];
      $this->cmp_formatado['zw_input_2'] = $zw_input_2;
      $this->cmp_formatado['xb'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['xb'];
      $this->cmp_formatado['xb_input_2'] = $xb_input_2;
      $this->cmp_formatado['kyzt'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']['kyzt'];
      $this->cmp_formatado['kyzt_input_2'] = $kyzt_input_2;

      //----- $ygbh
      $this->Date_part = false;
      if (isset($ygbh) || $ygbh_cond == "nu" || $ygbh_cond == "nn" || $ygbh_cond == "ep" || $ygbh_cond == "ne")
      {
         $this->monta_condicao("ygbh", $ygbh_cond, $ygbh, "", "ygbh");
      }

      //----- $ygxm
      $this->Date_part = false;
      if (isset($ygxm) || $ygxm_cond == "nu" || $ygxm_cond == "nn" || $ygxm_cond == "ep" || $ygxm_cond == "ne")
      {
         $this->monta_condicao("ygxm", $ygxm_cond, $ygxm, "", "ygxm");
      }
      ...
      {
         $this->and_or();
         if (strtoupper($bm_cond) == "DF" || strtoupper($bm_cond) == "NP")
         {
             $this->comando        .= " bm not in (";
             $this->comando_sum    .= " cg_staff.bm not in (";
             $this->comando_filtro .= " bm not in (";
         }
         else
         {
             $this->comando        .= " bm in (";
             $this->comando_sum    .= " cg_staff.bm in (";
             $this->comando_filtro .= " bm in (";
         }
         $x                     = count($bm);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label['bm'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      {
         $this->and_or();
         if (strtoupper($zw_cond) == "DF" || strtoupper($zw_cond) == "NP")
         {
             $this->comando        .= " zw not in (";
             $this->comando_sum    .= " cg_staff.zw not in (";
             $this->comando_filtro .= " zw not in (";
         }
         else
         {
             $this->comando        .= " zw in (";
             $this->comando_sum    .= " cg_staff.zw in (";
             $this->comando_filtro .= " zw in (";
         }
         $x                     = count($zw);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label['zw'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($xb) != 0)
      {
         ...
         if (strtoupper($xb_cond) == "DF" || strtoupper($xb_cond) == "NP")
         {
             ...
             $this->comando_sum    .= " cg_staff.xb not in (";
             $this->comando_filtro .= " xb not in (";
         }
         else
         {
             $this->comando        .= " xb in (";
             $this->comando_sum    .= " cg_staff.xb in (";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label['xb'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (count($kyzt) != 0)
      {
         ...
         if (strtoupper($kyzt_cond) == "DF" || strtoupper($kyzt_cond) == "NP")
         {
             ...
             $this->comando_sum    .= " cg_staff.kyzt not in (";
             $this->comando_filtro .= " kyzt not in (";
         }
         else
         {
             $this->comando        .= " kyzt in (";
             $this->comando_sum    .= " cg_staff.kyzt in (";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $nmgp_tab_label['kyzt'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_staff']['where_pesq_ant'] = $this->comando . $this->comando_fim;

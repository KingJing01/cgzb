<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_staff_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_staff_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['ygbh'] = "on";
   $tab_def_campos['ygbh'] = "ygbh";
   $tab_converte["ygbh"]   = "ygbh";
   $tab_labels["ygbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["ygbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["ygbh"] : "" . $this->Nm_lang['lang_cg_staff_fld_ygbh'] . "";
   $tab_ger_campos['ygxm'] = "on";
   $tab_def_campos['ygxm'] = "ygxm";
   $tab_converte["ygxm"]   = "ygxm";
   $tab_labels["ygxm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["ygxm"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["ygxm"] : "" . $this->Nm_lang['lang_cg_staff_fld_ygxm'] . "";
   $tab_ger_campos['xb'] = "on";
   $tab_def_campos['xb'] = "xb";
   $tab_converte["xb"]   = "xb";
   $tab_labels["xb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["xb"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["xb"] : "" . $this->Nm_lang['lang_cg_staff_fld_xb'] . "";
   $tab_ger_campos['bm'] = "on";
   $tab_def_campos['bm'] = "bm";
   $tab_converte["bm"]   = "bm";
   $tab_labels["bm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["bm"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["bm"] : "" . $this->Nm_lang['lang_cg_staff_fld_bm'] . "";
   $tab_ger_campos['zw'] = "on";
   $tab_def_campos['zw'] = "zw";
   $tab_converte["zw"]   = "zw";
   $tab_labels["zw"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["zw"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["zw"] : "" . $this->Nm_lang['lang_cg_staff_fld_zw'] . "";
   $tab_ger_campos['zjhm'] = "on";
   $tab_def_campos['zjhm'] = "zjhm";
   $tab_converte["zjhm"]   = "zjhm";
   $tab_labels["zjhm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["zjhm"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["zjhm"] : "" . $this->Nm_lang['lang_cg_staff_fld_zjhm'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_converte["email"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["email"] : "" . $this->Nm_lang['lang_cg_staff_fld_email'] . "";
   $tab_ger_campos['yddh'] = "on";
   $tab_def_campos['yddh'] = "yddh";
   $tab_converte["yddh"]   = "yddh";
   $tab_labels["yddh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["yddh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["yddh"] : "" . $this->Nm_lang['lang_cg_staff_fld_yddh'] . "";
   $tab_ger_campos['kyzt'] = "on";
   $tab_def_campos['kyzt'] = "kyzt";
   $tab_converte["kyzt"]   = "kyzt";
   $tab_labels["kyzt"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["kyzt"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['labels']["kyzt"] : "" . $this->Nm_lang['lang_cg_staff_fld_kyzt'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_staff']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_staff'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_staff_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_staff']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {

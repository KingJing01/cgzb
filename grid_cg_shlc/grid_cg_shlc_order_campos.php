<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_shlc_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_shlc_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['lcbh'] = "on";
   $tab_def_campos['lcbh'] = "lcbh";
   $tab_converte["lcbh"]   = "lcbh";
   $tab_labels["lcbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['labels']["lcbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['labels']["lcbh"] : "" . $this->Nm_lang['lang_cg_shlc_fld_lcbh'] . "";
   $tab_ger_campos['lcmc'] = "on";
   $tab_def_campos['lcmc'] = "lcmc";
   $tab_converte["lcmc"]   = "lcmc";
   $tab_labels["lcmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['labels']["lcmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['labels']["lcmc"] : "" . $this->Nm_lang['lang_cg_shlc_fld_lcmc'] . "";
   $tab_ger_campos['dlr'] = "on";
   $tab_def_campos['dlr'] = "dlr";
   $tab_converte["dlr"]   = "dlr";
   $tab_labels["dlr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['labels']["dlr"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['labels']["dlr"] : "" . $this->Nm_lang['lang_cg_shlc_fld_dlr'] . "";
   $tab_ger_campos['dlsj'] = "on";
   $tab_def_campos['dlsj'] = "dlsj";
   $tab_converte["dlsj"]   = "dlsj";
   $tab_labels["dlsj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['labels']["dlsj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['labels']["dlsj"] : "" . $this->Nm_lang['lang_cg_shlc_fld_dlsj'] . "";
   $tab_ger_campos['shbz'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['shbz'] = "shbz";
       $tab_converte["shbz"]   = "shbz";
   }
   else
   {
       $tab_def_campos['shbz'] = "";
   ...
   $tab_labels["shbz"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['labels']["shbz"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['labels']["shbz"] : "操作";
   $tab_ger_campos['shbz'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_shlc'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_shlc_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_shlc']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {

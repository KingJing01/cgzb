...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_cg_company/form_cg_company_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_cg_company_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_company_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['recarga'];
}
?>
...
<?php
 include_once("form_cg_company_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" enctype="multipart/form-data" 
               action="form_cg_company_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_company_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_company_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
   ...
   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col) { echo "<table style=\"border-collapse: collapse; height: 100%; width: 100%\"><tr><td style=\"vertical-align: middle; border-width: 0px; padding: 0px 2px 0px 0px\"><img id=\"SC_blk_pdf0\" src=\"" . $this->Ini->path_icones . "/" . $this->Ini->Block_img_col . "\" style=\"border: 0px; float: left\" class=\"sc-ui-block-control\"></td><td style=\"border-width: 0px; padding: 0px; width: 100%;\" class=\"scFormBlockAlign\">"; } ?>基本信息<?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col) { echo "</td></tr></table>"; } ?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gsmc_line" id="hidden_field_data_gsmc" style="<?php echo $sStyleHidden_gsmc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gsmc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gsmc_label"><span id="id_label_gsmc"><?php echo $this->nm_new_label['gsmc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['gsmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['gsmc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["gsmc"]) &&  $this->nmgp_cmp_readonly["gsmc"] == "on") { 

 ?>
<input type="hidden" name="gsmc" value="<?php echo $this->form_encode_input($gsmc) . "\">" . $gsmc . ""; ?>
<?php } else { ?>
<span id="id_read_on_gsmc" class="sc-ui-readonly-gsmc css_gsmc_line" style="<?php echo $sStyleReadLab_gsmc; ?>"><?php echo $this->form_encode_input($this->gsmc); ?></span><span id="id_read_off_gsmc" style="white-space: nowrap;<?php echo $sStyleReadInp_gsmc; ?>">
 <input class="sc-js-input scFormObjectOdd css_gsmc_obj" style="" id="id_sc_field_gsmc" type=text name="gsmc" value="<?php echo $this->form_encode_input($gsmc) ?>"
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gsjc_line" id="hidden_field_data_gsjc" style="<?php echo $sStyleHidden_gsjc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gsjc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gsjc_label"><span id="id_label_gsjc"><?php echo $this->nm_new_label['gsjc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['gsjc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['gsjc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tyshxydm_line" id="hidden_field_data_tyshxydm" style="<?php echo $sStyleHidden_tyshxydm; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tyshxydm_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tyshxydm_label"><span id="id_label_tyshxydm"><?php echo $this->nm_new_label['tyshxydm']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['tyshxydm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['tyshxydm'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qylx_line" id="hidden_field_data_qylx" style="<?php echo $sStyleHidden_qylx; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qylx_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qylx_label"><span id="id_label_qylx"><?php echo $this->nm_new_label['qylx']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['qylx']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['qylx'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gsdz_line" id="hidden_field_data_gsdz" style="<?php echo $sStyleHidden_gsdz; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gsdz_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gsdz_label"><span id="id_label_gsdz"><?php echo $this->nm_new_label['gsdz']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['gsdz']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['gsdz'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fddbr_line" id="hidden_field_data_fddbr" style="<?php echo $sStyleHidden_fddbr; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fddbr_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fddbr_label"><span id="id_label_fddbr"><?php echo $this->nm_new_label['fddbr']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['fddbr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['fddbr'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_zczb_line" id="hidden_field_data_zczb" style="<?php echo $sStyleHidden_zczb; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zczb_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_zczb_label"><span id="id_label_zczb"><?php echo $this->nm_new_label['zczb']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['zczb']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['zczb'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_clrq_line" id="hidden_field_data_clrq" style="<?php echo $sStyleHidden_clrq; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clrq_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_clrq_label"><span id="id_label_clrq"><?php echo $this->nm_new_label['clrq']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['clrq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['clrq'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_jyfw_line" id="hidden_field_data_jyfw" style="<?php echo $sStyleHidden_jyfw; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_jyfw_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_jyfw_label"><span id="id_label_jyfw"><?php echo $this->nm_new_label['jyfw']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['jyfw']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['jyfw'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_khyh_line" id="hidden_field_data_khyh" style="<?php echo $sStyleHidden_khyh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_khyh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_khyh_label"><span id="id_label_khyh"><?php echo $this->nm_new_label['khyh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['khyh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['khyh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_yhdz_line" id="hidden_field_data_yhdz" style="<?php echo $sStyleHidden_yhdz; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_yhdz_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_yhdz_label"><span id="id_label_yhdz"><?php echo $this->nm_new_label['yhdz']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_yhzh_line" id="hidden_field_data_yhzh" style="<?php echo $sStyleHidden_yhzh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_yhzh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_yhzh_label"><span id="id_label_yhzh"><?php echo $this->nm_new_label['yhzh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['yhzh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['yhzh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_lxrdh_line" id="hidden_field_data_lxrdh" style="<?php echo $sStyleHidden_lxrdh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lxrdh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_lxrdh_label"><span id="id_label_lxrdh"><?php echo $this->nm_new_label['lxrdh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['lxrdh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['lxrdh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_yyzzfile_line" id="hidden_field_data_yyzzfile" style="<?php echo $sStyleHidden_yyzzfile; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_yyzzfile_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_yyzzfile_label"><span id="id_label_yyzzfile"><?php echo $this->nm_new_label['yyzzfile']; ?></span></span><br>
...
<?php $sStyleHidden_yyzzfile_dumb = ('' == $sStyleHidden_yyzzfile) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_yyzzfile_dumb" style="<?php echo $sStyleHidden_yyzzfile_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable" width="100%" style="height: 100%;">   <tr>
    ...
    <TD colspan="1" height="20" class="scFormBlock">
     <TABLE style="padding: 0px; spacing: 0px; border-width: 0px;" width="100%" height="100%">
      <TR>
       <TD align="" valign="" class="scFormBlockFont"><?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col) { echo "<table style=\"border-collapse: collapse; height: 100%; width: 100%\"><tr><td style=\"vertical-align: middle; border-width: 0px; padding: 0px 2px 0px 0px\"><img id=\"SC_blk_pdf1\" src=\"" . $this->Ini->path_icones . "/" . $this->Ini->Block_img_col . "\" style=\"border: 0px; float: left\" class=\"sc-ui-block-control\"></td><td style=\"border-width: 0px; padding: 0px; width: 100%;\" class=\"scFormBlockAlign\">"; } ?>审核信息<?php if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col) { echo "</td></tr></table>"; } ?></TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['shyj']))
    {
...
<?php
   ...
   $shyj = $this->shyj;
   $sStyleHidden_shyj = '';
   if (isset($this->nmgp_cmp_hidden['shyj']) && $this->nmgp_cmp_hidden['shyj'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['shyj']);
       $sStyleHidden_shyj = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_shyj = 'display: none;';
   $sStyleReadInp_shyj = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['shyj']) && $this->nmgp_cmp_readonly['shyj'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['shyj']);
       $sStyleReadLab_shyj = '';
       $sStyleReadInp_shyj = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['shyj']) && $this->nmgp_cmp_hidden['shyj'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="shyj" value="<?php echo $this->form_encode_input($shyj) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_shyj_line" id="hidden_field_data_shyj" style="<?php echo $sStyleHidden_shyj; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_shyj_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_shyj_label"><span id="id_label_shyj"><?php echo $this->nm_new_label['shyj']; ?></span></span><br>
<?php
$shyj_val = str_replace('<br />', '__SC_BREAK_LINE__', nl2br($shyj));

?>

<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["shyj"]) &&  $this->nmgp_cmp_readonly["shyj"] == "on") { 

 ?>
<input type="hidden" name="shyj" value="<?php echo $this->form_encode_input($shyj) . "\">" . $shyj_val . ""; ?>
<?php } else { ?>
<span id="id_read_on_shyj" class="sc-ui-readonly-shyj css_shyj_line" style="<?php echo $sStyleReadLab_shyj; ?>"><?php echo $this->form_encode_input($shyj_val); ?></span><span id="id_read_off_shyj" style="white-space: nowrap;<?php echo $sStyleReadInp_shyj; ?>">
 <textarea  class="sc-js-input scFormObjectOdd css_shyj_obj" style="white-space: pre-wrap;" name="shyj" id="id_sc_field_shyj" rows="2" cols="36"
 alt="{datatype: 'text', maxLength: 128, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}">
<?php echo $shyj; ?>
</textarea>
</span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_shyj_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_shyj_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['shzt']))
    {
...
<?php
   ...
   $shzt = $this->shzt;
   $sStyleHidden_shzt = '';
   if (isset($this->nmgp_cmp_hidden['shzt']) && $this->nmgp_cmp_hidden['shzt'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['shzt']);
       $sStyleHidden_shzt = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_shzt = 'display: none;';
   $sStyleReadInp_shzt = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['shzt']) && $this->nmgp_cmp_readonly['shzt'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['shzt']);
       $sStyleReadLab_shzt = '';
       $sStyleReadInp_shzt = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['shzt']) && $this->nmgp_cmp_hidden['shzt'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="shzt" value="<?php echo $this->form_encode_input($shzt) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_shzt_line" id="hidden_field_data_shzt" style="<?php echo $sStyleHidden_shzt; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_shzt_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_shzt_label"><span id="id_label_shzt"><?php echo $this->nm_new_label['shzt']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['shzt']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['php_cmp_required']['shzt'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["shzt"]) &&  $this->nmgp_cmp_readonly["shzt"] == "on") { 
...
ORDER BY mc";
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->shzt_1))
          {
              foreach ($this->shzt_1 as $tmp_shzt)
              {
                  if (trim($tmp_shzt) === trim($cadaselect[1])) { $shzt_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->shzt) === trim($cadaselect[1])) { $shzt_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="shzt" value="<?php echo $this->form_encode_input($shzt) . "\">" . $shzt_look . ""; ?>
<?php } else { ?>
...
ORDER BY mc";
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_shzt\" class=\"css_shzt_line\" style=\"" .  $sStyleReadLab_shzt . "\">" . $this->form_encode_input($shzt_look) . "</span><span id=\"id_read_off_shzt\" style=\"" . $sStyleReadInp_shzt . "\">";
   echo "<div id=\"idAjaxRadio_shzt\" style=\"display: inline-block\">\r\n";
   $y = 0 ; 
   ...
   while (!empty($todo[$x])) 
   {
          ...
          echo "  <td class=\"scFormDataFontOdd css_shzt_line\">\r\n";
          echo "    <input type=radio style=\"float:left; position:relative; top: -3px;\" name=\"shzt\" value=\"$cadaradio[1]\"";
          if (trim($this->shzt) === trim($cadaradio[1])) 
          { 
              echo " checked" ; 
          } 
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_shzt_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_shzt_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_company_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_company_mob");
 parent.scAjaxDetailHeight("form_cg_company_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}

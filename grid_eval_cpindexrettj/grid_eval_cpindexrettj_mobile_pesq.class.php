...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "planbh";$Nm_numeric[] = "indexbh";$Nm_numeric[] = "zscj";$Nm_numeric[] = "weight";$Nm_numeric[] = "id";$Nm_numeric[] = "planbh";$Nm_numeric[] = "indexbh";$Nm_numeric[] = "zscj";$Nm_numeric[] = "weight";

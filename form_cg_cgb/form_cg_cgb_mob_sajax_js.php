  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cg_cgb_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cgjhbh
  function do_ajax_form_cg_cgb_mob_validate_cgjhbh()
  {
    var nomeCampo_cgjhbh = "cgjhbh";
    var var_cgjhbh = scAjaxGetFieldSelect(nomeCampo_cgjhbh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_cgb_mob_validate_cgjhbh(var_cgjhbh, var_script_case_init, do_ajax_form_cg_cgb_mob_validate_cgjhbh_cb);
  } // do_ajax_form_cg_cgb_mob_validate_cgjhbh

  function do_ajax_form_cg_cgb_mob_validate_cgjhbh_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_cgb_mob_validate_cgjhbh_cb

  // ---------- Validate cgbbh
  function do_ajax_form_cg_cgb_mob_validate_cgbbh()
  {
    var nomeCampo_cgbbh = "cgbbh";
    var var_cgbbh = scAjaxGetFieldText(nomeCampo_cgbbh);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_cgb_mob_validate_cgbbh(var_cgbbh, var_script_case_init, do_ajax_form_cg_cgb_mob_validate_cgbbh_cb);
  } // do_ajax_form_cg_cgb_mob_validate_cgbbh

  function do_ajax_form_cg_cgb_mob_validate_cgbbh_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cgbbh";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_cgb_mob_validate_cgbbh_cb

  // ---------- Validate cgbmc
  function do_ajax_form_cg_cgb_mob_validate_cgbmc()
  {
    var nomeCampo_cgbmc = "cgbmc";
    var var_cgbmc = scAjaxGetFieldText(nomeCampo_cgbmc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_cgb_mob_validate_cgbmc(var_cgbmc, var_script_case_init, do_ajax_form_cg_cgb_mob_validate_cgbmc_cb);
  } // do_ajax_form_cg_cgb_mob_validate_cgbmc

  function do_ajax_form_cg_cgb_mob_validate_cgbmc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cgbmc";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_cgb_mob_validate_cgbmc_cb

  // ---------- Validate cgpm
  function do_ajax_form_cg_cgb_mob_validate_cgpm()
  {
    var nomeCampo_cgpm = "cgpm";
    var var_cgpm = scAjaxGetFieldRadio(nomeCampo_cgpm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_cgb_mob_validate_cgpm(var_cgpm, var_script_case_init, do_ajax_form_cg_cgb_mob_validate_cgpm_cb);
  } // do_ajax_form_cg_cgb_mob_validate_cgpm

  function do_ajax_form_cg_cgb_mob_validate_cgpm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cgpm";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_cgb_mob_validate_cgpm_cb

  // ---------- Validate cgys
  function do_ajax_form_cg_cgb_mob_validate_cgys()
  {
    var nomeCampo_cgys = "cgys";
    var var_cgys = scAjaxGetFieldText(nomeCampo_cgys);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cg_cgb_mob_validate_cgys(var_cgys, var_script_case_init, do_ajax_form_cg_cgb_mob_validate_cgys_cb);
  } // do_ajax_form_cg_cgb_mob_validate_cgys

  function do_ajax_form_cg_cgb_mob_validate_cgys_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cgys";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cg_cgb_mob_validate_cgys_cb

  // ---------- Event onchange cgjhbh
  function do_ajax_form_cg_cgb_mob_event_cgjhbh_onchange()
  {
    var var_cgjhbh = scAjaxGetFieldSelect("cgjhbh");
    var var_cgys = scAjaxGetFieldText("cgys");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    scEventControl_onChange_call("cgjhbh", "");
    x_ajax_form_cg_cgb_mob_event_cgjhbh_onchange(var_cgjhbh, var_cgys, var_script_case_init, do_ajax_form_cg_cgb_mob_event_cgjhbh_onchange_cb);
  } // do_ajax_form_cg_cgb_mob_event_cgjhbh_onchange

  function do_ajax_form_cg_cgb_mob_event_cgjhbh_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cgjhbh";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cg_cgb_mob_event_cgjhbh_onchange_cb
  // ---------- Form
  function do_ajax_form_cg_cgb_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cg_cgb_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cgjhbh = scAjaxGetFieldSelect("cgjhbh");
    var var_cgbbh = scAjaxGetFieldText("cgbbh");
    var var_cgbmc = scAjaxGetFieldText("cgbmc");
    var var_cgpm = scAjaxGetFieldRadio("cgpm");
    var var_cgys = scAjaxGetFieldText("cgys");
    ...
    scAjaxProcOn();
    x_ajax_form_cg_cgb_mob_submit_form(var_cgjhbh, var_cgbbh, var_cgbmc, var_cgpm, var_cgys, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cg_cgb_mob_submit_form_cb);
  } // do_ajax_form_cg_cgb_mob_submit_form

  function do_ajax_form_cg_cgb_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("cgjhbh");
      scAjaxHideErrorDisplay("cgbbh");
      scAjaxHideErrorDisplay("cgbmc");
      scAjaxHideErrorDisplay("cgpm");
      scAjaxHideErrorDisplay("cgys");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_cg_cgb_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_cg_cgb_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cg_cgb_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cg_cgb_mob_navigate_form_cb);
  } // do_ajax_form_cg_cgb_mob_navigate_form

  function do_ajax_form_cg_cgb_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_cg_cgb_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cg_cgb_mob_navigate_form_cb
  function sc_hide_form_cg_cgb_mob_form()
  {
  ...
  ajax_field_list[0] = "cgjhbh";
  ajax_field_list[1] = "cgbbh";
  ajax_field_list[2] = "cgbmc";
  ajax_field_list[3] = "cgpm";
  ajax_field_list[4] = "cgys";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cgjhbh": {"label": "<?php echo $this->Ini->Nm_lang['lang_cg_cgjh_fld_xmmc'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cgbbh": {"label": "<?php echo $this->Ini->Nm_lang['lang_cg_cgb_fld_cgbbh'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cgbmc": {"label": "<?php echo $this->Ini->Nm_lang['lang_cg_cgb_fld_cgbmc'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cgpm": {"label": "<?php echo $this->Ini->Nm_lang['lang_cg_cgb_fld_cgpm'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cgys": {"label": "<?php echo $this->Ini->Nm_lang['lang_cg_cgb_fld_cgys'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["cgjhbh"][1] = "cgjhbh";
  ajax_field_mult["cgbbh"][1] = "cgbbh";
  ajax_field_mult["cgbmc"][1] = "cgbmc";
  ajax_field_mult["cgpm"][1] = "cgpm";
  ajax_field_mult["cgys"][1] = "cgys";

  var ajax_field_id = {
    "cgjhbh": new Array("hidden_field_label_cgjhbh", "hidden_field_data_cgjhbh"),
    ...
    "cgpm": new Array("hidden_field_label_cgpm", "hidden_field_data_cgpm"),
    "cgys": new Array("hidden_field_label_cgys", "hidden_field_data_cgys")
  };

...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_groups_apps'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_groups_apps'] . ""); } ?></TITLE>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<TR align="center">
 <TD colspan="3">
     <table  style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%" cellpadding="0" cellspacing="0">
       <tr valign="middle">
         <td align="left" ><span class="scFormHeaderFont"> <?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_groups_apps'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_sec_groups_apps'] . ""; } ?> </span></td>
...
{ 
   ...
   if ($this->Embutida_form && empty($this->form_vert_sec_form_sec_groups_apps))
   {
       $sc_seq_vert = 0;
           ...
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['app_name_']))
           {
               $this->nmgp_cmp_readonly['app_name_'] = 'on';
           }
   foreach ($this->form_vert_sec_form_sec_groups_apps as $sc_seq_vert => $sc_lixo)
   {
       ...
       if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["app_name_"]) &&  $this->nmgp_cmp_readonly["app_name_"] == "on"))
       {
       ...
       $this->lookup_app_name_($look_rpc_app_name_);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_app_name__line" id="hidden_field_data_app_name_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_app_name_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_app_name__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_app_name_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["app_name_"]) &&  $this->nmgp_cmp_readonly["app_name_"] == "on")) { 

 ?>
<input type="hidden" name="app_name_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($app_name_) . "\"><span id=\"id_ajax_label_app_name_" . $sc_seq_vert . "\">" . $app_name_ . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_app_name_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-app_name_<?php echo $sc_seq_vert ?> css_app_name__line" style="<?php echo $sStyleReadLab_app_name_; ?>"><?php echo $this->form_encode_input($this->app_name_); ?></span><span id="id_read_off_app_name_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_app_name_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_app_name__obj" style="" id="id_sc_field_app_name_<?php echo $sc_seq_vert ?>" type=text name="app_name_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($app_name_) ?>"
 size=50 maxlength=128 alt="{datatype: 'text', maxLength: 128, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
 <SPAN id="id_lookup_app_name_<?php echo $sc_seq_vert ?>"><?php echo $look_rpc_app_name_; ?></SPAN></td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_app_name_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_app_name_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php  if (in_array("Y", $this->priv_access__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);"  style="float:left; position:relative; top: -3px;"><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php  if (in_array("Y", $this->priv_insert__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);"  style="float:left; position:relative; top: -3px;"><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php  if (in_array("Y", $this->priv_delete__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);"  style="float:left; position:relative; top: -3px;"><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php  if (in_array("Y", $this->priv_update__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);"  style="float:left; position:relative; top: -3px;"><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php  if (in_array("Y", $this->priv_export__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);"  style="float:left; position:relative; top: -3px;"><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php  if (in_array("Y", $this->priv_print__1))  { echo " checked" ;} ?> onClick="nm_check_insert(<?php echo $sc_seq_vert ?>);"  style="float:left; position:relative; top: -3px;"><?php echo $this->Ini->Nm_lang['lang_opt_yes']; ?></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_sec_groups_apps']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>

<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_company_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_company_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['gsmc'] = "on";
   $tab_def_campos['gsmc'] = "gsmc";
   $tab_converte["gsmc"]   = "gsmc";
   $tab_labels["gsmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["gsmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["gsmc"] : "" . $this->Nm_lang['lang_cg_company_fld_gsmc'] . "";
   $tab_ger_campos['fddbr'] = "on";
   $tab_def_campos['fddbr'] = "fddbr";
   $tab_converte["fddbr"]   = "fddbr";
   $tab_labels["fddbr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["fddbr"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["fddbr"] : "" . $this->Nm_lang['lang_cg_company_fld_fddbr'] . "";
   $tab_ger_campos['zczb'] = "on";
   $tab_def_campos['zczb'] = "zczb";
   $tab_converte["zczb"]   = "zczb";
   $tab_labels["zczb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["zczb"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["zczb"] : "" . $this->Nm_lang['lang_cg_company_fld_zczb'] . "";
   $tab_ger_campos['lxr'] = "on";
   $tab_def_campos['lxr'] = "lxr";
   $tab_converte["lxr"]   = "lxr";
   $tab_labels["lxr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["lxr"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["lxr"] : "" . $this->Nm_lang['lang_cg_company_fld_lxr'] . "";
   $tab_ger_campos['lxrdh'] = "on";
   $tab_def_campos['lxrdh'] = "lxrdh";
   $tab_converte["lxrdh"]   = "lxrdh";
   $tab_labels["lxrdh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["lxrdh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["lxrdh"] : "" . $this->Nm_lang['lang_cg_company_fld_lxrdh'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_converte["email"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["email"] : "" . $this->Nm_lang['lang_cg_company_fld_email'] . "";
   $tab_ger_campos['shzt'] = "on";
   $tab_def_campos['shzt'] = "shzt";
   $tab_converte["shzt"]   = "shzt";
   $tab_labels["shzt"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["shzt"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_company']['labels']["shzt"] : "" . $this->Nm_lang['lang_cg_company_fld_shzt'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_company']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_company']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_company']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_company']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_company']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_company']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_company']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_company']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_company']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_company'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_company_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_company']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_company']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {

...
class grid_cg_company_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_company_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_company_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_company_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_gsjc')
      {
          $gsjc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_gsjc($gsjc);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_qylx')
      {
          $qylx = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_qylx($qylx);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_khyh')
      {
          $khyh = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_khyh($khyh);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_shzt')
      {
          $shzt = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_shzt($shzt);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_gsjc($gsjc)
   {
      $gsjc = substr($this->Db->qstr($gsjc), 1, -1);
            $gsjc_look = substr($this->Db->qstr($gsjc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct gsjc from " . $this->Ini->nm_tabela . " where  gsjc like '%" . $gsjc . "%'"; 
   ...
   function lookup_ajax_qylx($qylx)
   {
      $qylx = substr($this->Db->qstr($qylx), 1, -1);
            $qylx_look = substr($this->Db->qstr($qylx), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct qylx from " . $this->Ini->nm_tabela . " where  qylx like '%" . $qylx . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_khyh($khyh)
   {
      $khyh = substr($this->Db->qstr($khyh), 1, -1);
            $khyh_look = substr($this->Db->qstr($khyh), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct khyh from " . $this->Ini->nm_tabela . " where  khyh like '%" . $khyh . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_shzt($shzt)
   {
      $shzt = substr($this->Db->qstr($shzt), 1, -1);
            $shzt_look = substr($this->Db->qstr($shzt), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct shzt from " . $this->Ini->nm_tabela . " where  shzt like '%" . $shzt . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_company'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_company/grid_cg_company_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_company_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_company_ajax.js"></script>
 <script type="text/javascript">
...
function scJQCalendarAdd() {
  $("#sc_clrq_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = '01/';
          var_dt_ini += document.getElementById('SC_clrq_mes').value + '/';
          var_dt_ini += document.getElementById('SC_clrq_ano').value;
          document.getElementById('sc_clrq_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_clrq_mes').value = aParts[1];
          document.getElementById('SC_clrq_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_clrq_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = '01/';
          var_dt_ini += document.getElementById('SC_clrq_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_clrq_input_2_ano').value;
          document.getElementById('sc_clrq_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_clrq_input_2_mes').value = aParts[1];
          document.getElementById('SC_clrq_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_gsjc_cond#NMF#' + search_get_sel_txt('SC_gsjc_cond') + '@NMF@';
  str_out += 'SC_gsjc#NMF#' + search_get_text('SC_gsjc') + '@NMF@';
  str_out += 'id_ac_gsjc#NMF#' + search_get_text('id_ac_gsjc') + '@NMF@';
  str_out += 'SC_qylx_cond#NMF#' + search_get_sel_txt('SC_qylx_cond') + '@NMF@';
  str_out += 'SC_qylx#NMF#' + search_get_text('SC_qylx') + '@NMF@';
  str_out += 'id_ac_qylx#NMF#' + search_get_text('id_ac_qylx') + '@NMF@';
  str_out += 'SC_khyh_cond#NMF#' + search_get_sel_txt('SC_khyh_cond') + '@NMF@';
  str_out += 'SC_khyh#NMF#' + search_get_text('SC_khyh') + '@NMF@';
  str_out += 'id_ac_khyh#NMF#' + search_get_text('id_ac_khyh') + '@NMF@';
  str_out += 'SC_clrq_cond#NMF#' + search_get_sel_txt('SC_clrq_cond') + '@NMF@';
  str_out += 'SC_clrq_dia#NMF#' + search_get_sel_txt('SC_clrq_dia') + '@NMF@';
  str_out += 'SC_clrq_mes#NMF#' + search_get_sel_txt('SC_clrq_mes') + '@NMF@';
  str_out += 'SC_clrq_ano#NMF#' + search_get_sel_txt('SC_clrq_ano') + '@NMF@';
  str_out += 'SC_clrq_input_2_dia#NMF#' + search_get_sel_txt('SC_clrq_input_2_dia') + '@NMF@';
  str_out += 'SC_clrq_input_2_mes#NMF#' + search_get_sel_txt('SC_clrq_input_2_mes') + '@NMF@';
  str_out += 'SC_clrq_input_2_ano#NMF#' + search_get_sel_txt('SC_clrq_input_2_ano') + '@NMF@';
  str_out += 'SC_shzt_cond#NMF#' + search_get_sel_txt('SC_shzt_cond') + '@NMF@';
  str_out += 'SC_shzt#NMF#' + search_get_text('SC_shzt') + '@NMF@';
  str_out += 'id_ac_shzt#NMF#' + search_get_text('id_ac_shzt') + '@NMF@';
   ...
   $("#id_ac_shzt").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_shzt",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_shzt").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_shzt").val( $(this).val() );
       }
     }
   });
   $("#id_ac_gsjc").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_gsjc",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_gsjc").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_gsjc").val( $(this).val() );
       }
     }
   });
   $("#id_ac_qylx").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_qylx",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_qylx").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_qylx").val( $(this).val() );
       }
     }
   });
   $("#id_ac_khyh").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_khyh",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_khyh").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_khyh").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_company'] ?></span></td>
...
<?php
   ...
   {
      global 
             $gsjc_cond, $gsjc, $gsjc_autocomp,
             $qylx_cond, $qylx, $qylx_autocomp,
             $khyh_cond, $khyh, $khyh_autocomp,
             $clrq_cond, $clrq, $clrq_dia, $clrq_mes, $clrq_ano, $clrq_input_2_dia, $clrq_input_2_mes, $clrq_input_2_ano,
             $shzt_cond, $shzt, $shzt_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $gsjc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['gsjc']; 
          $gsjc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['gsjc_cond']; 
          $qylx = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['qylx']; 
          $qylx_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['qylx_cond']; 
          $khyh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['khyh']; 
          $khyh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['khyh_cond']; 
          $clrq_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_dia']; 
          $clrq_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_mes']; 
          $clrq_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_ano']; 
          $clrq_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_input_2_dia']; 
          $clrq_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_input_2_mes']; 
          $clrq_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_input_2_ano']; 
          $clrq_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_cond']; 
          $shzt = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['shzt']; 
          $shzt_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['shzt_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['NM_operador']; 
      } 
      if (!isset($gsjc_cond) || empty($gsjc_cond))
      {
         $gsjc_cond = "qp";
      }
      if (!isset($qylx_cond) || empty($qylx_cond))
      {
         $qylx_cond = "qp";
      }
      if (!isset($khyh_cond) || empty($khyh_cond))
      {
         $khyh_cond = "qp";
      }
      if (!isset($clrq_cond) || empty($clrq_cond))
      {
         $clrq_cond = "eq";
      }
      ...
      $str_hide_gsjc = (in_array($gsjc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_qylx = (in_array($qylx_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_khyh = (in_array($khyh_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_clrq = (in_array($clrq_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_shzt = (in_array($shzt_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_clrq = ('bw' == $clrq_cond) ? $display_aberto : $display_fechado;

      if (!isset($gsjc) || $gsjc == "")
      {
          $gsjc = "";
      }
      if (isset($gsjc) && !empty($gsjc))
      {
         $tmp_pos = strpos($gsjc, "##@@");
         if ($tmp_pos === false)
         { }
...
<?php
   if (is_file("grid_cg_company_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['gsjc'])) ? $this->New_label['gsjc'] : "" . $this->Ini->Nm_lang['lang_cg_company_fld_gsjc'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_gsjc_cond" name="gsjc_cond" onChange="nm_campos_between(document.getElementById('id_vis_gsjc'), this, 'gsjc')">
       <OPTION value="qp" <?php if ("qp" == $gsjc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $gsjc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $gsjc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $gsjc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_gsjc" <?php echo $str_hide_gsjc?> valign="top">
 ...
 $nmgp_tab_label .= "gsjc?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $gsjc_look = substr($this->Db->qstr($gsjc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct gsjc from " . $this->Ini->nm_tabela . " where gsjc = '$gsjc_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$gsjc]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$gsjc];
      }
      else
      {
          $sAutocompValue = $gsjc;
...
?>
<INPUT  type="text" id="SC_gsjc" name="gsjc" value="<?php echo NM_encode_input($gsjc) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_gsjc" name="gsjc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['qylx'])) ? $this->New_label['qylx'] : "" . $this->Ini->Nm_lang['lang_cg_company_fld_qylx'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_qylx_cond" name="qylx_cond" onChange="nm_campos_between(document.getElementById('id_vis_qylx'), this, 'qylx')">
       <OPTION value="qp" <?php if ("qp" == $qylx_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $qylx_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $qylx_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $qylx_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_qylx" <?php echo $str_hide_qylx?> valign="top">
 ...
 $nmgp_tab_label .= "qylx?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $qylx_look = substr($this->Db->qstr($qylx), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct qylx from " . $this->Ini->nm_tabela . " where qylx = '$qylx_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$qylx]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$qylx];
      }
      else
      {
          $sAutocompValue = $qylx;
...
?>
<INPUT  type="text" id="SC_qylx" name="qylx" value="<?php echo NM_encode_input($qylx) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_qylx" name="qylx_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['khyh'])) ? $this->New_label['khyh'] : "" . $this->Ini->Nm_lang['lang_cg_company_fld_khyh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_khyh_cond" name="khyh_cond" onChange="nm_campos_between(document.getElementById('id_vis_khyh'), this, 'khyh')">
       <OPTION value="qp" <?php if ("qp" == $khyh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $khyh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $khyh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $khyh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_khyh" <?php echo $str_hide_khyh?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['khyh'])) ? $this->New_label['khyh'] : "" . $this->Ini->Nm_lang['lang_cg_company_fld_khyh'] . "";
 $nmgp_tab_label .= "khyh?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $khyh_look = substr($this->Db->qstr($khyh), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct khyh from " . $this->Ini->nm_tabela . " where khyh = '$khyh_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$khyh]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$khyh];
      }
      else
      {
          $sAutocompValue = $khyh;
...
?>
<INPUT  type="text" id="SC_khyh" name="khyh" value="<?php echo NM_encode_input($khyh) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_khyh" name="khyh_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['clrq'])) ? $this->New_label['clrq'] : "" . $this->Ini->Nm_lang['lang_cg_company_fld_clrq'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_clrq_cond" name="clrq_cond" onChange="nm_campos_between(document.getElementById('id_vis_clrq'), this, 'clrq')">
       <OPTION value="eq" <?php if ("eq" == $clrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $clrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $clrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $clrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_clrq" <?php echo $str_hide_clrq?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['clrq'])) ? $this->New_label['clrq'] : "" . $this->Ini->Nm_lang['lang_cg_company_fld_clrq'] . "";
 $nmgp_tab_label .= "clrq?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_clrq_mes" name="clrq_mes" value="<?php echo NM_encode_input($clrq_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.clrq_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_clrq_ano" name="clrq_ano" value="<?php echo NM_encode_input($clrq_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<INPUT type="hidden" id="sc_clrq_jq">
        <SPAN id="id_css_clrq"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_clrq"  <?php echo $str_display_clrq; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_clrq_input_2_mes" name="clrq_input_2_mes" value="<?php echo NM_encode_input($clrq_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.clrq_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_clrq_input_2_ano" name="clrq_input_2_ano" value="<?php echo NM_encode_input($clrq_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
         <INPUT type="hidden" id="sc_clrq_jq2">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['shzt'])) ? $this->New_label['shzt'] : "" . $this->Ini->Nm_lang['lang_cg_company_fld_shzt'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
      $shzt_look = substr($this->Db->qstr($shzt), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct shzt from " . $this->Ini->nm_tabela . " where shzt = '$shzt_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$shzt]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$shzt];
      }
      else
      {
          $sAutocompValue = $shzt;
...
?>
<INPUT  type="text" id="SC_shzt" name="shzt" value="<?php echo NM_encode_input($shzt) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_shzt" name="shzt_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_company']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_company']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_gsjc'), document.F1.gsjc_cond, 'gsjc');
   document.F1.gsjc.value = "";
   document.F1.gsjc_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_qylx'), document.F1.qylx_cond, 'qylx');
   document.F1.qylx.value = "";
   document.F1.qylx_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_khyh'), document.F1.khyh_cond, 'khyh');
   document.F1.khyh.value = "";
   document.F1.khyh_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_clrq'), document.F1.clrq_cond, 'clrq');
   document.F1.clrq_mes.value = "";
   document.F1.clrq_ano.value = "";
   document.F1.clrq_input_2_mes.value = "";
   document.F1.clrq_input_2_ano.value = "";
   nm_campos_between(document.getElementById('id_vis_shzt'), document.F1.shzt_cond, 'shzt');
   document.F1.shzt.value = "";
   document.F1.shzt_autocomp.value = "";
 }
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_clrq_input_2_mes').bind('change', function() {sc_grid_cg_company_valida_mes(this)});
    $('#SC_clrq_mes').bind('change', function() {sc_grid_cg_company_valida_mes(this)});
 }
 function sc_grid_cg_company_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_gsjc_cond'] = 'cond';
      $tp_fields['SC_gsjc'] = 'text_aut';
      $tp_fields['id_ac_gsjc'] = 'text_aut';
      $tp_fields['SC_qylx_cond'] = 'cond';
      $tp_fields['SC_qylx'] = 'text_aut';
      $tp_fields['id_ac_qylx'] = 'text_aut';
      $tp_fields['SC_khyh_cond'] = 'cond';
      $tp_fields['SC_khyh'] = 'text_aut';
      $tp_fields['id_ac_khyh'] = 'text_aut';
      $tp_fields['SC_clrq_cond'] = 'cond';
      $tp_fields['SC_clrq_dia'] = 'text';
      $tp_fields['SC_clrq_mes'] = 'text';
      $tp_fields['SC_clrq_ano'] = 'text';
      $tp_fields['SC_clrq_input_2_dia'] = 'text';
      $tp_fields['SC_clrq_input_2_mes'] = 'text';
      $tp_fields['SC_clrq_input_2_ano'] = 'text';
      $tp_fields['SC_shzt_cond'] = 'cond';
      $tp_fields['SC_shzt'] = 'text_aut';
      $tp_fields['id_ac_shzt'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $gsjc_cond, $gsjc, $gsjc_autocomp,
             $qylx_cond, $qylx, $qylx_autocomp,
             $khyh_cond, $khyh, $khyh_autocomp,
             $clrq_cond, $clrq, $clrq_dia, $clrq_mes, $clrq_ano, $clrq_input_2_dia, $clrq_input_2_mes, $clrq_input_2_ano,
             $shzt_cond, $shzt, $shzt_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($gsjc_autocomp) && empty($gsjc))
      {
          $gsjc = $gsjc_autocomp;
      }
      if (!empty($qylx_autocomp) && empty($qylx))
      {
          $qylx = $qylx_autocomp;
      }
      if (!empty($khyh_autocomp) && empty($khyh))
      {
          $khyh = $khyh_autocomp;
      }
      if (!empty($shzt_autocomp) && empty($shzt))
      {
          $shzt = $shzt_autocomp;
      }
      $gsjc_cond_salva = $gsjc_cond; 
      if (!isset($gsjc_input_2) || $gsjc_input_2 == "")
      {
          $gsjc_input_2 = $gsjc;
      }
      $qylx_cond_salva = $qylx_cond; 
      if (!isset($qylx_input_2) || $qylx_input_2 == "")
      {
          $qylx_input_2 = $qylx;
      }
      $khyh_cond_salva = $khyh_cond; 
      if (!isset($khyh_input_2) || $khyh_input_2 == "")
      {
          $khyh_input_2 = $khyh;
      }
      $clrq_cond_salva = $clrq_cond; 
      if (!isset($clrq_input_2_dia) || $clrq_input_2_dia == "")
      {
          $clrq_input_2_dia = $clrq_dia;
      }
      if (!isset($clrq_input_2_mes) || $clrq_input_2_mes == "")
      {
          $clrq_input_2_mes = $clrq_mes;
      }
      if (!isset($clrq_input_2_ano) || $clrq_input_2_ano == "")
      {
          $clrq_input_2_ano = $clrq_ano;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['gsjc'] = $gsjc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['gsjc_cond'] = $gsjc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['qylx'] = $qylx; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['qylx_cond'] = $qylx_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['khyh'] = $khyh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['khyh_cond'] = $khyh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_dia'] = $clrq_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_mes'] = $clrq_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_ano'] = $clrq_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_input_2_dia'] = $clrq_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_input_2_mes'] = $clrq_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_input_2_ano'] = $clrq_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_cond'] = $clrq_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['shzt'] = $shzt; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['shzt_cond'] = $shzt_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['gsjc'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['gsjc'] = $gsjc;
      }
      $qylx_look = substr($this->Db->qstr($qylx), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct qylx from " . $this->Ini->nm_tabela . " where qylx = '$qylx_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['qylx'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['qylx'] = $qylx;
      }
      $khyh_look = substr($this->Db->qstr($khyh), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct khyh from " . $this->Ini->nm_tabela . " where khyh = '$khyh_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['khyh'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['khyh'] = $khyh;
      }
      $shzt_look = substr($this->Db->qstr($shzt), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct shzt from " . $this->Ini->nm_tabela . " where shzt = '$shzt_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['shzt'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['shzt'] = $shzt;
      }

      //----- $gsjc
      $this->Date_part = false;
      if (isset($gsjc) || $gsjc_cond == "nu" || $gsjc_cond == "nn" || $gsjc_cond == "ep" || $gsjc_cond == "ne")
      {
         $this->monta_condicao("gsjc", $gsjc_cond, $gsjc, "", "gsjc");
      }

      //----- $qylx
      $this->Date_part = false;
      if (isset($qylx) || $qylx_cond == "nu" || $qylx_cond == "nn" || $qylx_cond == "ep" || $qylx_cond == "ne")
      {
         $this->monta_condicao("qylx", $qylx_cond, $qylx, "", "qylx");
      }

      //----- $khyh
      $this->Date_part = false;
      if (isset($khyh) || $khyh_cond == "nu" || $khyh_cond == "nn" || $khyh_cond == "ep" || $khyh_cond == "ne")
      {
         $this->monta_condicao("khyh", $khyh_cond, $khyh, "", "khyh");
      }
      ...
      if ($clrq_cond != "TP")
      {
          $clrq_cond = strtoupper($clrq_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $clrq_ano;
          $Dtxt .= $clrq_mes;
          ...
          if ($clrq_cond == "BW")
          {
              $val[1]['ano'] = $clrq_input_2_ano;
              $val[1]['mes'] = $clrq_input_2_mes;
              $val[1]['dia'] = $clrq_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $clrq_cond , "", "data");
          $clrq = $val[0];
          $this->cmp_formatado['clrq'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['clrq'], "YYYY-MM-DD");
          $this->cmp_formatado['clrq'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "mY"));
          if ($clrq_cond == "BW")
          {
              $clrq_input_2     = $val[1];
              $this->cmp_formatado['clrq_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']['clrq_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['clrq_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['clrq_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "mY"));
          }
          if (!empty($Dtxt) || $clrq_cond == "NU" || $clrq_cond == "NN"|| $clrq_cond == "EP"|| $clrq_cond == "NE")
          {
              $this->monta_condicao("clrq", $clrq_cond, $clrq, $clrq_input_2, 'clrq', 'DATE');
          }
      }

      //----- $shzt
      $this->Date_part = false;
      if (isset($shzt) || $shzt_cond == "nu" || $shzt_cond == "nn" || $shzt_cond == "ep" || $shzt_cond == "ne")
      {
         $this->monta_condicao("shzt", $shzt_cond, $shzt, "", "shzt");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_company']['where_pesq_ant'] = $this->comando . $this->comando_fim;

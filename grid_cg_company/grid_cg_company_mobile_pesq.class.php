...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "clrq";$Nm_datas[] = "shsj";$Nm_numeric[] = "id";$Nm_numeric[] = "zczb";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_gsjc"  <?php echo $str_hide_gsjc?>><?php
      $gsjc_look = substr($this->Db->qstr($gsjc), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_qylx"  <?php echo $str_hide_qylx?>><?php
      $qylx_look = substr($this->Db->qstr($qylx), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_khyh"  <?php echo $str_hide_khyh?>><?php
      $khyh_look = substr($this->Db->qstr($khyh), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_clrq"  <?php echo $str_hide_clrq?>>
<?php
  $Form_base = "mmyyyy";
  $date_format_show = "";
...
<INPUT type="hidden" id="sc_clrq_jq">
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_clrq"  <?php echo $str_display_clrq; ?> class="scFilterFieldFontEven">
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_shzt"  <?php echo $str_hide_shzt?>><?php
      $shzt_look = substr($this->Db->qstr($shzt), 1, -1); 
      $nmgp_def_dados = array(); 

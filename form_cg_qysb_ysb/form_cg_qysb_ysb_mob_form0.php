...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_menu_cg_qysb_ysb'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_menu_cg_qysb_ysb'] . ""); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_cg_qysb_ysb/form_cg_qysb_ysb_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_cg_qysb_ysb_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_qysb_ysb_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['recarga'];
}
?>
...
<?php
 include_once("form_cg_qysb_ysb_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="form_cg_qysb_ysb_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_qysb_ysb_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_qysb_ysb_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_menu_cg_qysb_ysb'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_menu_cg_qysb_ysb'] . ""; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cgbbh_line" id="hidden_field_data_cgbbh" style="<?php echo $sStyleHidden_cgbbh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cgbbh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cgbbh_label"><span id="id_label_cgbbh"><?php echo $this->nm_new_label['cgbbh']; ?></span></span><br><input type="hidden" name="cgbbh" value="<?php echo $this->form_encode_input($cgbbh); ?>"><span id="id_ajax_label_cgbbh"><?php echo nl2br($cgbbh); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_qymc_line" id="hidden_field_data_qymc" style="<?php echo $sStyleHidden_qymc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qymc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_qymc_label"><span id="id_label_qymc"><?php echo $this->nm_new_label['qymc']; ?></span></span><br><input type="hidden" name="qymc" value="<?php echo $this->form_encode_input($qymc); ?>"><span id="id_ajax_label_qymc"><?php echo nl2br($qymc); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_isbsxz_line" id="hidden_field_data_isbsxz" style="<?php echo $sStyleHidden_isbsxz; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isbsxz_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_isbsxz_label"><span id="id_label_isbsxz"><?php echo $this->nm_new_label['isbsxz']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['php_cmp_required']['isbsxz']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['php_cmp_required']['isbsxz'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><input type="hidden" name="isbsxz" value="<?php echo $this->form_encode_input($isbsxz); ?>"><span id="id_ajax_label_isbsxz"><?php echo nl2br($isbsxz); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_istb_line" id="hidden_field_data_istb" style="<?php echo $sStyleHidden_istb; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_istb_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_istb_label"><span id="id_label_istb"><?php echo $this->nm_new_label['istb']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['php_cmp_required']['istb']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['php_cmp_required']['istb'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><input type="hidden" name="istb" value="<?php echo $this->form_encode_input($istb); ?>"><span id="id_ajax_label_istb"><?php echo nl2br($istb); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_isrw_line" id="hidden_field_data_isrw" style="<?php echo $sStyleHidden_isrw; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isrw_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_isrw_label"><span id="id_label_isrw"><?php echo $this->nm_new_label['isrw']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['php_cmp_required']['isrw']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['php_cmp_required']['isrw'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><input type="hidden" name="isrw" value="<?php echo $this->form_encode_input($isrw); ?>"><span id="id_ajax_label_isrw"><?php echo nl2br($isrw); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_isqualified_line" id="hidden_field_data_isqualified" style="<?php echo $sStyleHidden_isqualified; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isqualified_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_isqualified_label"><span id="id_label_isqualified"><?php echo $this->nm_new_label['isqualified']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['php_cmp_required']['isqualified']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['php_cmp_required']['isqualified'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br><input type="hidden" name="isqualified" value="<?php echo $this->form_encode_input($isqualified); ?>"><span id="id_ajax_label_isqualified"><?php echo nl2br($isqualified); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sm_line" id="hidden_field_data_sm" style="<?php echo $sStyleHidden_sm; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sm_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sm_label"><span id="id_label_sm"><?php echo $this->nm_new_label['sm']; ?></span></span><br><input type="hidden" name="sm" value="<?php echo $this->form_encode_input($sm); ?>"><span id="id_ajax_label_sm"><?php echo nl2br($sm); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_kyzt_line" id="hidden_field_data_kyzt" style="<?php echo $sStyleHidden_kyzt; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_kyzt_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_kyzt_label"><span id="id_label_kyzt"><?php echo $this->nm_new_label['kyzt']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['php_cmp_required']['kyzt']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['php_cmp_required']['kyzt'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['Lookup_kyzt'][] = '是'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['Lookup_kyzt'][] = '否'; ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_qysb_ysb_mob");
 parent.scAjaxDetailHeight("form_cg_qysb_ysb_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}

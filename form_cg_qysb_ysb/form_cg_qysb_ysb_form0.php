...
<?php
include_once("form_cg_qysb_ysb_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_qysb_ysb_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['recarga'];
}
?>
...
<?php
 include_once("form_cg_qysb_ysb_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_qysb_ysb'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_qysb_ysb'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_isbsxz_label" id="hidden_field_label_isbsxz" style="<?php echo $sStyleHidden_isbsxz; ?>"><span id="id_label_isbsxz"><?php echo $this->nm_new_label['isbsxz']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['php_cmp_required']['isbsxz']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['php_cmp_required']['isbsxz'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_isbsxz_line" id="hidden_field_data_isbsxz" style="<?php echo $sStyleHidden_isbsxz; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isbsxz_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="isbsxz" value="<?php echo $this->form_encode_input($isbsxz); ?>"><span id="id_ajax_label_isbsxz"><?php echo nl2br($isbsxz); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_istb_label" id="hidden_field_label_istb" style="<?php echo $sStyleHidden_istb; ?>"><span id="id_label_istb"><?php echo $this->nm_new_label['istb']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['php_cmp_required']['istb']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['php_cmp_required']['istb'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_istb_line" id="hidden_field_data_istb" style="<?php echo $sStyleHidden_istb; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_istb_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="istb" value="<?php echo $this->form_encode_input($istb); ?>"><span id="id_ajax_label_istb"><?php echo nl2br($istb); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_isrw_label" id="hidden_field_label_isrw" style="<?php echo $sStyleHidden_isrw; ?>"><span id="id_label_isrw"><?php echo $this->nm_new_label['isrw']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['php_cmp_required']['isrw']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['php_cmp_required']['isrw'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_isrw_line" id="hidden_field_data_isrw" style="<?php echo $sStyleHidden_isrw; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isrw_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="isrw" value="<?php echo $this->form_encode_input($isrw); ?>"><span id="id_ajax_label_isrw"><?php echo nl2br($isrw); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_isqualified_label" id="hidden_field_label_isqualified" style="<?php echo $sStyleHidden_isqualified; ?>"><span id="id_label_isqualified"><?php echo $this->nm_new_label['isqualified']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['php_cmp_required']['isqualified']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['php_cmp_required']['isqualified'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_isqualified_line" id="hidden_field_data_isqualified" style="<?php echo $sStyleHidden_isqualified; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isqualified_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="isqualified" value="<?php echo $this->form_encode_input($isqualified); ?>"><span id="id_ajax_label_isqualified"><?php echo nl2br($isqualified); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sm_line" id="hidden_field_data_sm" style="<?php echo $sStyleHidden_sm; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sm_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="sm" value="<?php echo $this->form_encode_input($sm); ?>"><span id="id_ajax_label_sm"><?php echo nl2br($sm); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_kyzt_label" id="hidden_field_label_kyzt" style="<?php echo $sStyleHidden_kyzt; ?>"><span id="id_label_kyzt"><?php echo $this->nm_new_label['kyzt']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['php_cmp_required']['kyzt']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['php_cmp_required']['kyzt'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['Lookup_kyzt'][] = '是'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['Lookup_kyzt'][] = '否'; ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_qysb_ysb']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_qysb_ysb");
 parent.scAjaxDetailHeight("form_cg_qysb_ysb", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}

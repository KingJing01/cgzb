...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_qytb_view"]))
   {
      unset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_qytb_view"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_qytb_view']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_qytb_view']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_qytb_view']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_qytb_view']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cg_qytb_view']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cg_qytb_view']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cg_qytb_view']['embutida_filho'] as $ind => $sc_init)
          {

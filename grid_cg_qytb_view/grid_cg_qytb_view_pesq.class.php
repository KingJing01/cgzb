...
class grid_cg_qytb_view_pesq
{
    ...
    * @access  public
    */
   function grid_cg_qytb_view_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_qytb_view_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_qytb_view_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_qytb_view_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_zbggbh')
      {
          $zbggbh = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_zbggbh($zbggbh);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_qylogin')
      {
          $qylogin = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_qylogin($qylogin);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_lxr')
      {
          $lxr = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_lxr($lxr);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_qymc')
      {
          $qymc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_qymc($qymc);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_zbggbh($zbggbh)
   {
      $zbggbh = substr($this->Db->qstr($zbggbh), 1, -1);
            $zbggbh_look = substr($this->Db->qstr($zbggbh), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct zbggbh from " . $this->Ini->nm_tabela . " where  zbggbh like '%" . $zbggbh . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct zbggbh from " . $this->Ini->nm_tabela . " where  zbggbh like '%" . $zbggbh . "%'"; 
   ...
   function lookup_ajax_qylogin($qylogin)
   {
      $qylogin = substr($this->Db->qstr($qylogin), 1, -1);
            $qylogin_look = substr($this->Db->qstr($qylogin), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct qylogin from " . $this->Ini->nm_tabela . " where  qylogin like '%" . $qylogin . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_lxr($lxr)
   {
      $lxr = substr($this->Db->qstr($lxr), 1, -1);
            $lxr_look = substr($this->Db->qstr($lxr), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct lxr from " . $this->Ini->nm_tabela . " where  lxr like '%" . $lxr . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_qymc($qymc)
   {
      $qymc = substr($this->Db->qstr($qymc), 1, -1);
            $qymc_look = substr($this->Db->qstr($qymc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct qymc from " . $this->Ini->nm_tabela . " where  qymc like '%" . $qymc . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_cg_qytb_view'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_qytb_view/grid_cg_qytb_view_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_qytb_view_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_qytb_view_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_id_input_2#NMF#' + search_get_text('SC_id_input_2') + '@NMF@';
  str_out += 'SC_zbggbh_cond#NMF#' + search_get_sel_txt('SC_zbggbh_cond') + '@NMF@';
  str_out += 'SC_zbggbh#NMF#' + search_get_text('SC_zbggbh') + '@NMF@';
  str_out += 'id_ac_zbggbh#NMF#' + search_get_text('id_ac_zbggbh') + '@NMF@';
  str_out += 'SC_zbggbh_input_2#NMF#' + search_get_text('SC_zbggbh_input_2') + '@NMF@';
  ...
  str_out += 'SC_qylogin_cond#NMF#' + search_get_sel_txt('SC_qylogin_cond') + '@NMF@';
  str_out += 'SC_qylogin#NMF#' + search_get_text('SC_qylogin') + '@NMF@';
  str_out += 'id_ac_qylogin#NMF#' + search_get_text('id_ac_qylogin') + '@NMF@';
  str_out += 'SC_lxr_cond#NMF#' + search_get_sel_txt('SC_lxr_cond') + '@NMF@';
  str_out += 'SC_lxr#NMF#' + search_get_text('SC_lxr') + '@NMF@';
  str_out += 'id_ac_lxr#NMF#' + search_get_text('id_ac_lxr') + '@NMF@';
  str_out += 'SC_qymc_cond#NMF#' + search_get_sel_txt('SC_qymc_cond') + '@NMF@';
  str_out += 'SC_qymc#NMF#' + search_get_text('SC_qymc') + '@NMF@';
  str_out += 'id_ac_qymc#NMF#' + search_get_text('id_ac_qymc') + '@NMF@';
   ...
   $("#id_ac_qymc").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_qymc",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_qymc").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_qymc").val( $(this).val() );
       }
     }
   });
   $("#id_ac_zbggbh").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_zbggbh",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_zbggbh").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_zbggbh").val( $(this).val() );
       }
     }
   });
   $("#id_ac_qylogin").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_qylogin",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_qylogin").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_qylogin").val( $(this).val() );
       }
     }
   });
   $("#id_ac_lxr").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_lxr",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_cg_qytb_view'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $id_cond, $id, $id_input_2, $id_autocomp,
             $zbggbh_cond, $zbggbh, $zbggbh_input_2, $zbggbh_autocomp,
             $cgbbh_cond, $cgbbh, $cgbbh_autocomp,
             $qylogin_cond, $qylogin, $qylogin_autocomp,
             $lxr_cond, $lxr, $lxr_autocomp,
             $qymc_cond, $qymc, $qymc_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cgbmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['cgbmc']; 
          $cgbmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['cgbmc_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['id']; 
          $id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['id_input_2']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['id_cond']; 
          $zbggbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['zbggbh']; 
          $zbggbh_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['zbggbh_input_2']; 
          $zbggbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['zbggbh_cond']; 
          $cgbbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['cgbbh']; 
          $cgbbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['cgbbh_cond']; 
          $qylogin = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['qylogin']; 
          $qylogin_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['qylogin_cond']; 
          $lxr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['lxr']; 
          $lxr_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['lxr_cond']; 
          $qymc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['qymc']; 
          $qymc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['qymc_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($zbggbh_cond) || empty($zbggbh_cond))
      {
         $zbggbh_cond = "gt";
      }
      ...
      if (!isset($qylogin_cond) || empty($qylogin_cond))
      {
         $qylogin_cond = "qp";
      }
      if (!isset($lxr_cond) || empty($lxr_cond))
      {
         $lxr_cond = "qp";
      }
      if (!isset($qymc_cond) || empty($qymc_cond))
      {
         $qymc_cond = "qp";
      }
      ...
      $str_hide_zbggbh = (in_array($zbggbh_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cgbbh = (in_array($cgbbh_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_qylogin = (in_array($qylogin_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_lxr = (in_array($lxr_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_qymc = (in_array($qymc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id = ('bw' == $id_cond) ? $display_aberto : $display_fechado;
      $str_display_zbggbh = ('bw' == $zbggbh_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($zbggbh) || $zbggbh == "")
      {
          $zbggbh = "";
      }
      if (isset($zbggbh) && !empty($zbggbh))
      {
         $tmp_pos = strpos($zbggbh, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $zbggbh = substr($zbggbh, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($qylogin) || $qylogin == "")
      {
          $qylogin = "";
      }
      if (isset($qylogin) && !empty($qylogin))
      {
         $tmp_pos = strpos($qylogin, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $qylogin = substr($qylogin, 0, $tmp_pos);
         }
      }
      if (!isset($lxr) || $lxr == "")
      {
...
<?php
   if (is_file("grid_cg_qytb_view_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgbmc'])) ? $this->New_label['cgbmc'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_cgbmc'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cgbmc_cond" name="cgbmc_cond" onChange="nm_campos_between(document.getElementById('id_vis_cgbmc'), this, 'cgbmc')">
...
?>
<INPUT  type="text" id="SC_cgbmc" name="cgbmc" value="<?php echo NM_encode_input($cgbmc) ?>" size=50 alt="{datatype: 'text', maxLength: 64, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cgbmc" name="cgbmc_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id'])) ? $this->New_label['id'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_id'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_cond" name="id_cond" onChange="nm_campos_between(document.getElementById('id_vis_id'), this, 'id')">
       ...
       <OPTION value="bw" <?php if ("bw" == $id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id" <?php echo $str_hide_id?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id'])) ? $this->New_label['id'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_id'] . "";
...
?>
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id" name="id_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id"  <?php echo $str_display_id; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_input_2" name="id_input_2" value="<?php echo NM_encode_input($id_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['zbggbh'])) ? $this->New_label['zbggbh'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_zbggbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_zbggbh_cond" name="zbggbh_cond" onChange="nm_campos_between(document.getElementById('id_vis_zbggbh'), this, 'zbggbh')">
       <OPTION value="gt" <?php if ("gt" == $zbggbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $zbggbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $zbggbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $zbggbh_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_zbggbh" <?php echo $str_hide_zbggbh?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['zbggbh'])) ? $this->New_label['zbggbh'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_zbggbh'] . "";
 $nmgp_tab_label .= "zbggbh?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $zbggbh_look = substr($this->Db->qstr($zbggbh), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($zbggbh))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct zbggbh from " . $this->Ini->nm_tabela . " where zbggbh = $zbggbh_look"; 
      }
      else
      {
          $nm_comando = "select distinct zbggbh from " . $this->Ini->nm_tabela . " where zbggbh = $zbggbh_look"; 
      ...
      if (isset($nmgp_def_dados[0][$zbggbh]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$zbggbh];
      }
      else
      {
          $sAutocompValue = $zbggbh;
      }
?>
<INPUT  type="text" id="SC_zbggbh" name="zbggbh" value="<?php echo NM_encode_input($zbggbh) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_zbggbh" name="zbggbh_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_zbggbh"  <?php echo $str_display_zbggbh; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_zbggbh_input_2" name="zbggbh_input_2" value="<?php echo NM_encode_input($zbggbh_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cgbbh'])) ? $this->New_label['cgbbh'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_cgbbh'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cgbbh_cond" name="cgbbh_cond" onChange="nm_campos_between(document.getElementById('id_vis_cgbbh'), this, 'cgbbh')">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cgbbh" name="cgbbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['qylogin'])) ? $this->New_label['qylogin'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_qylogin'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_qylogin_cond" name="qylogin_cond" onChange="nm_campos_between(document.getElementById('id_vis_qylogin'), this, 'qylogin')">
       <OPTION value="qp" <?php if ("qp" == $qylogin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $qylogin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $qylogin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $qylogin_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_qylogin" <?php echo $str_hide_qylogin?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['qylogin'])) ? $this->New_label['qylogin'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_qylogin'] . "";
 $nmgp_tab_label .= "qylogin?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $qylogin_look = substr($this->Db->qstr($qylogin), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct qylogin from " . $this->Ini->nm_tabela . " where qylogin = '$qylogin_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$qylogin]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$qylogin];
      }
      else
      {
          $sAutocompValue = $qylogin;
      }
?>
<INPUT  type="text" id="SC_qylogin" name="qylogin" value="<?php echo NM_encode_input($qylogin) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_qylogin" name="qylogin_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['lxr'])) ? $this->New_label['lxr'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_lxr'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_lxr_cond" name="lxr_cond" onChange="nm_campos_between(document.getElementById('id_vis_lxr'), this, 'lxr')">
       <OPTION value="qp" <?php if ("qp" == $lxr_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $lxr_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $lxr_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $lxr_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_lxr" <?php echo $str_hide_lxr?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['lxr'])) ? $this->New_label['lxr'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_lxr'] . "";
 $nmgp_tab_label .= "lxr?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $lxr_look = substr($this->Db->qstr($lxr), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct lxr from " . $this->Ini->nm_tabela . " where lxr = '$lxr_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$lxr]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$lxr];
      }
      else
      {
          $sAutocompValue = $lxr;
...
?>
<INPUT  type="text" id="SC_lxr" name="lxr" value="<?php echo NM_encode_input($lxr) ?>" size=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_lxr" name="lxr_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['qymc'])) ? $this->New_label['qymc'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_qymc'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_qymc_cond" name="qymc_cond" onChange="nm_campos_between(document.getElementById('id_vis_qymc'), this, 'qymc')">
       <OPTION value="qp" <?php if ("qp" == $qymc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $qymc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $qymc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $qymc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_qymc" <?php echo $str_hide_qymc?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['qymc'])) ? $this->New_label['qymc'] : "" . $this->Ini->Nm_lang['lang_cg_qytb_fld_qymc'] . "";
 $nmgp_tab_label .= "qymc?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $qymc_look = substr($this->Db->qstr($qymc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct qymc from " . $this->Ini->nm_tabela . " where qymc = '$qymc_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$qymc]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$qymc];
      }
      else
      {
          $sAutocompValue = $qymc;
...
?>
<INPUT  type="text" id="SC_qymc" name="qymc" value="<?php echo NM_encode_input($qymc) ?>" size=50 alt="{datatype: 'text', maxLength: 64, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_qymc" name="qymc_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_qytb_view']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_qytb_view']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_zbggbh'), document.F1.zbggbh_cond, 'zbggbh');
   document.F1.zbggbh.value = "";
   document.F1.zbggbh_autocomp.value = "";
   document.F1.zbggbh_input_2.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_qylogin'), document.F1.qylogin_cond, 'qylogin');
   document.F1.qylogin.value = "";
   document.F1.qylogin_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_lxr'), document.F1.lxr_cond, 'lxr');
   document.F1.lxr.value = "";
   document.F1.lxr_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_qymc'), document.F1.qymc_cond, 'qymc');
   document.F1.qymc.value = "";
   document.F1.qymc_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "cgzb/grid_cg_qytb_view";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_id_input_2'] = 'text';
      $tp_fields['SC_zbggbh_cond'] = 'cond';
      $tp_fields['SC_zbggbh'] = 'text_aut';
      $tp_fields['id_ac_zbggbh'] = 'text_aut';
      $tp_fields['SC_zbggbh_input_2'] = 'text';
      $tp_fields['SC_cgbbh_cond'] = 'cond';
      $tp_fields['SC_cgbbh'] = 'text_aut';
      $tp_fields['id_ac_cgbbh'] = 'text_aut';
      $tp_fields['SC_qylogin_cond'] = 'cond';
      $tp_fields['SC_qylogin'] = 'text_aut';
      $tp_fields['id_ac_qylogin'] = 'text_aut';
      $tp_fields['SC_lxr_cond'] = 'cond';
      $tp_fields['SC_lxr'] = 'text_aut';
      $tp_fields['id_ac_lxr'] = 'text_aut';
      $tp_fields['SC_qymc_cond'] = 'cond';
      $tp_fields['SC_qymc'] = 'text_aut';
      $tp_fields['id_ac_qymc'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $cgbmc_cond, $cgbmc, $cgbmc_autocomp,
             $id_cond, $id, $id_input_2, $id_autocomp,
             $zbggbh_cond, $zbggbh, $zbggbh_input_2, $zbggbh_autocomp,
             $cgbbh_cond, $cgbbh, $cgbbh_autocomp,
             $qylogin_cond, $qylogin, $qylogin_autocomp,
             $lxr_cond, $lxr, $lxr_autocomp,
             $qymc_cond, $qymc, $qymc_autocomp, $nmgp_tab_label;
      ...
      if (!empty($zbggbh_autocomp) && empty($zbggbh))
      {
          $zbggbh = $zbggbh_autocomp;
      }
      if (!empty($cgbbh_autocomp) && empty($cgbbh))
      {
          $cgbbh = $cgbbh_autocomp;
      }
      if (!empty($qylogin_autocomp) && empty($qylogin))
      {
          $qylogin = $qylogin_autocomp;
      }
      if (!empty($lxr_autocomp) && empty($lxr))
      {
          $lxr = $lxr_autocomp;
      }
      if (!empty($qymc_autocomp) && empty($qymc))
      {
          $qymc = $qymc_autocomp;
      }
      ...
      $zbggbh_cond_salva = $zbggbh_cond; 
      if (!isset($zbggbh_input_2) || $zbggbh_input_2 == "")
      {
          $zbggbh_input_2 = $zbggbh;
      }
      ...
      $qylogin_cond_salva = $qylogin_cond; 
      if (!isset($qylogin_input_2) || $qylogin_input_2 == "")
      {
          $qylogin_input_2 = $qylogin;
      }
      $lxr_cond_salva = $lxr_cond; 
      if (!isset($lxr_input_2) || $lxr_input_2 == "")
      {
          $lxr_input_2 = $lxr;
      }
      $qymc_cond_salva = $qymc_cond; 
      if (!isset($qymc_input_2) || $qymc_input_2 == "")
      {
          $qymc_input_2 = $qymc;
      }
      if ($id_cond != "in")
      ...
      if ($id_cond != "in")
      {
          nm_limpa_numero($id_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($zbggbh_cond != "in")
      {
          nm_limpa_numero($zbggbh, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $zbggbh);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
          ...
          $zbggbh = implode(",", $Nm_sc_valores);
      }
      if ($zbggbh_cond != "in")
      {
          nm_limpa_numero($zbggbh_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['cgbmc'] = $cgbmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['cgbmc_cond'] = $cgbmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['id_input_2'] = $id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['zbggbh'] = $zbggbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['zbggbh_input_2'] = $zbggbh_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['zbggbh_cond'] = $zbggbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['cgbbh'] = $cgbbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['cgbbh_cond'] = $cgbbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['qylogin'] = $qylogin; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['qylogin_cond'] = $qylogin_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['lxr'] = $lxr; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['lxr_cond'] = $lxr_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['qymc'] = $qymc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['qymc_cond'] = $qymc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_cond != "in" && $id_cond != "bw" && !empty($id) && !is_numeric($id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_cg_qytb_fld_id'] . "";
      }
      if ($id_cond == "bw" && ((!empty($id) && !is_numeric($id)) || (!empty($id_input_2) && !is_numeric($id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_cg_qytb_fld_id'] . "";
      }
      if ($zbggbh_cond != "in" && $zbggbh_cond != "bw" && !empty($zbggbh) && !is_numeric($zbggbh))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_cg_qytb_fld_zbggbh'] . "";
      }
      if ($zbggbh_cond == "bw" && ((!empty($zbggbh) && !is_numeric($zbggbh)) || (!empty($zbggbh_input_2) && !is_numeric($zbggbh_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_cg_qytb_fld_zbggbh'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      $this->cmp_formatado['id_input_2'] = $Conteudo;
      $zbggbh_look = substr($this->Db->qstr($zbggbh), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($zbggbh))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['zbggbh'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['zbggbh'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['zbggbh'] = $zbggbh;
      }
      $Conteudo = $zbggbh_input_2;
      if (strtoupper($zbggbh_cond) != "II" && strtoupper($zbggbh_cond) != "QP" && strtoupper($zbggbh_cond) != "NP" && strtoupper($zbggbh_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['zbggbh_input_2'] = $Conteudo;
      $cgbbh_look = substr($this->Db->qstr($cgbbh), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cgbbh from " . $this->Ini->nm_tabela . " where cgbbh = '$cgbbh_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['qylogin'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['qylogin'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['qylogin'] = $qylogin;
      }
      $lxr_look = substr($this->Db->qstr($lxr), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct lxr from " . $this->Ini->nm_tabela . " where lxr = '$lxr_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['lxr'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['lxr'] = $lxr;
      }
      $qymc_look = substr($this->Db->qstr($qymc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct qymc from " . $this->Ini->nm_tabela . " where qymc = '$qymc_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['qymc'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['qymc'] = $qymc;
      }
      ...
      {
         $this->monta_condicao("id", $id_cond, $id, $id_input_2, "id");
      }

      //----- $zbggbh
      $this->Date_part = false;
      if (isset($zbggbh) || $zbggbh_cond == "nu" || $zbggbh_cond == "nn" || $zbggbh_cond == "ep" || $zbggbh_cond == "ne")
      {
         $this->monta_condicao("zbggbh", $zbggbh_cond, $zbggbh, $zbggbh_input_2, "zbggbh");
      }
      ...
      //----- $qylogin
      $this->Date_part = false;
      if (isset($qylogin) || $qylogin_cond == "nu" || $qylogin_cond == "nn" || $qylogin_cond == "ep" || $qylogin_cond == "ne")
      {
         $this->monta_condicao("qylogin", $qylogin_cond, $qylogin, "", "qylogin");
      }

      //----- $lxr
      $this->Date_part = false;
      if (isset($lxr) || $lxr_cond == "nu" || $lxr_cond == "nn" || $lxr_cond == "ep" || $lxr_cond == "ne")
      {
         $this->monta_condicao("lxr", $lxr_cond, $lxr, "", "lxr");
      }

      //----- $qymc
      $this->Date_part = false;
      if (isset($qymc) || $qymc_cond == "nu" || $qymc_cond == "nn" || $qymc_cond == "ep" || $qymc_cond == "ne")
      {
         $this->monta_condicao("qymc", $qymc_cond, $qymc, "", "qymc");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_qytb_view']['where_pesq_ant'] = $this->comando . $this->comando_fim;

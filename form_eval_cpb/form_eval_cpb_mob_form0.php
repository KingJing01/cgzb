...
<?php
include_once("form_eval_cpb_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_eval_cpb_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['recarga'];
}
?>
...
<?php
 include_once("form_eval_cpb_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_eval_cpb_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_eval_cpb_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mc_line" id="hidden_field_data_mc" style="<?php echo $sStyleHidden_mc; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_mc_label"><span id="id_label_mc"><?php echo $this->nm_new_label['mc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['php_cmp_required']['mc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['php_cmp_required']['mc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_intro_line" id="hidden_field_data_intro" style="<?php echo $sStyleHidden_intro; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_intro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_intro_label"><span id="id_label_intro"><?php echo $this->nm_new_label['intro']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['php_cmp_required']['intro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['php_cmp_required']['intro'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sfzg_line" id="hidden_field_data_sfzg" style="<?php echo $sStyleHidden_sfzg; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sfzg_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sfzg_label"><span id="id_label_sfzg"><?php echo $this->nm_new_label['sfzg']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['php_cmp_required']['sfzg']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['php_cmp_required']['sfzg'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['Lookup_sfzg'][] = '是'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['Lookup_sfzg'][] = '否'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_isdefault_line" id="hidden_field_data_isdefault" style="<?php echo $sStyleHidden_isdefault; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isdefault_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_isdefault_label"><span id="id_label_isdefault"><?php echo $this->nm_new_label['isdefault']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['php_cmp_required']['isdefault']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['php_cmp_required']['isdefault'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['Lookup_isdefault'][] = '是'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['Lookup_isdefault'][] = '否'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cpindex_line" id="hidden_field_data_cpindex" style="<?php echo $sStyleHidden_cpindex; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_cpindex_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cpindex_label"><span id="id_label_cpindex"><?php echo $this->nm_new_label['cpindex']; ?></span></span><br>
<?php
 ...
 if (isset($this->Ini->sc_lig_md5["grid_eval_index"]) && $this->Ini->sc_lig_md5["grid_eval_index"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_eval_cpb_mob@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
     $Md5_Lig  = "NMSC_inicial*scininicio*scout";
 }
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_eval_cpb_mob_empty.htm' : $this->Ini->link_grid_eval_index_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=550' . $parms_lig_cons;
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cpb_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_eval_cpb_mob");
 parent.scAjaxDetailHeight("form_eval_cpb_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}

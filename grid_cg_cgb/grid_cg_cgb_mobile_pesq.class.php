...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "b_id";$Nm_numeric[] = "b_cgys";$Nm_numeric[] = "b_cgjhbh";$Nm_numeric[] = "j_ysje";$Nm_numeric[] = "b_id";$Nm_numeric[] = "b_cgys";$Nm_numeric[] = "b_cgjhbh";$Nm_numeric[] = "j_ysje";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_b_cgbbh"  <?php echo $str_hide_b_cgbbh?>><?php
      $b_cgbbh_look = substr($this->Db->qstr($b_cgbbh), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_b_cgbmc"  <?php echo $str_hide_b_cgbmc?>><?php
      $b_cgbmc_look = substr($this->Db->qstr($b_cgbmc), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_j_xmbh"  <?php echo $str_hide_j_xmbh?>><?php
      $j_xmbh_look = substr($this->Db->qstr($j_xmbh), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_j_xmmc"  <?php echo $str_hide_j_xmmc?>><?php
      $j_xmmc_look = substr($this->Db->qstr($j_xmmc), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_b_cgpm"  <?php echo $str_hide_b_cgpm?>>
<?php

<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_cgb_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_cgb_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['j_xmmc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['j_xmmc'] = "j_xmmc";
       $tab_converte["j_xmmc"]   = "j_xmmc";
   }
   else
   {
       $tab_def_campos['j_xmmc'] = "j.xmmc";
       $tab_converte["j.xmmc"]   = "j_xmmc";
   }
   $tab_labels["j_xmmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['labels']["j_xmmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['labels']["j_xmmc"] : "" . $this->Nm_lang['lang_cg_cgjh_fld_xmmc'] . "";
   $tab_ger_campos['b_cgbbh'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_cgbbh'] = "b_cgbbh";
       $tab_converte["b_cgbbh"]   = "b_cgbbh";
   }
   else
   {
       $tab_def_campos['b_cgbbh'] = "b.cgbbh";
       $tab_converte["b.cgbbh"]   = "b_cgbbh";
   }
   $tab_labels["b_cgbbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['labels']["b_cgbbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['labels']["b_cgbbh"] : "" . $this->Nm_lang['lang_cg_cgb_fld_cgbbh'] . "";
   $tab_ger_campos['b_cgbmc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_cgbmc'] = "b_cgbmc";
       $tab_converte["b_cgbmc"]   = "b_cgbmc";
   }
   else
   {
       $tab_def_campos['b_cgbmc'] = "b.cgbmc";
       $tab_converte["b.cgbmc"]   = "b_cgbmc";
   }
   $tab_labels["b_cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['labels']["b_cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['labels']["b_cgbmc"] : "" . $this->Nm_lang['lang_cg_cgb_fld_cgbmc'] . "";
   $tab_ger_campos['b_cgpm'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_cgpm'] = "b_cgpm";
       $tab_converte["b_cgpm"]   = "b_cgpm";
   }
   else
   {
       $tab_def_campos['b_cgpm'] = "b.cgpm";
       $tab_converte["b.cgpm"]   = "b_cgpm";
   }
   $tab_labels["b_cgpm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['labels']["b_cgpm"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['labels']["b_cgpm"] : "" . $this->Nm_lang['lang_cg_cgb_fld_cgpm'] . "";
   $tab_ger_campos['b_cgys'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_cgys'] = "b_cgys";
       $tab_converte["b_cgys"]   = "b_cgys";
   }
   else
   {
       $tab_def_campos['b_cgys'] = "b.cgys";
       $tab_converte["b.cgys"]   = "b_cgys";
   }
   $tab_labels["b_cgys"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['labels']["b_cgys"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['labels']["b_cgys"] : "" . $this->Nm_lang['lang_cg_cgb_fld_cgys'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_cgb'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_cgb_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_cgb']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {

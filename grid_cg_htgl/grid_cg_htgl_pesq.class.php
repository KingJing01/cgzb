...
class grid_cg_htgl_pesq
{
   ...
   function grid_cg_htgl_pesq()
   {
      ...
      $this->qdrq_opc_bi[] = "CY";
      $this->qdrq_opc_bi[] = "LY";
      $this->qdrq_opc_bi[] = "M24";
      $this->qdrq_opc_bi[] = "M18";
      $this->qdrq_opc_bi[] = "YY";
      $this->qdrq_opc_bi[] = "M6";
      $this->qdrq_opc_bi[] = "M3";
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_htgl_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_htgl_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_htgl_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_qydw')
      {
          $qydw = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_qydw($qydw);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_qydw($qydw)
   {
      $qydw = substr($this->Db->qstr($qydw), 1, -1);
            $qydw_look = substr($this->Db->qstr($qydw), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct qydw from " . $this->Ini->nm_tabela . " where  qydw like '%" . $qydw . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "qdrq";$Nm_datas[] = "zbdqrq";$Nm_datas[] = "shsj";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_htgl'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_htgl/grid_cg_htgl_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_htgl_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_htgl_ajax.js"></script>
 <script type="text/javascript">
...
function scJQCalendarAdd() {
  $("#sc_qdrq_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_qdrq_dia').value + '/';
          var_dt_ini += document.getElementById('SC_qdrq_mes').value + '/';
          var_dt_ini += document.getElementById('SC_qdrq_ano').value;
          document.getElementById('sc_qdrq_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_qdrq_dia').value = aParts[0];
          document.getElementById('SC_qdrq_mes').value = aParts[1];
          document.getElementById('SC_qdrq_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_qdrq_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_qdrq_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_qdrq_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_qdrq_input_2_ano').value;
          document.getElementById('sc_qdrq_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_qdrq_input_2_dia').value = aParts[0];
          document.getElementById('SC_qdrq_input_2_mes').value = aParts[1];
          document.getElementById('SC_qdrq_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_qydw_cond#NMF#' + search_get_sel_txt('SC_qydw_cond') + '@NMF@';
  str_out += 'SC_qydw#NMF#' + search_get_text('SC_qydw') + '@NMF@';
  str_out += 'id_ac_qydw#NMF#' + search_get_text('id_ac_qydw') + '@NMF@';
  str_out += 'SC_qdrq_cond#NMF#' + search_get_sel_txt('SC_qdrq_cond') + '@NMF@';
  opc = search_get_sel_txt('SC_qdrq_cond');
  if (opc != "TP" && opc != "HJ" && opc != "OT" && opc != "U7" && opc != "SP" && opc != "US" && opc != "MM" && opc != "UM" && opc != "AM" && opc != "PS" && opc != "SS" && opc != "P3" && opc != "PM" && opc != "P7" && opc != "CY" && opc != "LY" && opc != "YY" && opc != "M6" && opc != "M3" && opc != "M18" && opc != "M24")
  {
      str_out += 'SC_qdrq_dia#NMF#' + search_get_sel_txt('SC_qdrq_dia') + '@NMF@';
      str_out += 'SC_qdrq_mes#NMF#' + search_get_sel_txt('SC_qdrq_mes') + '@NMF@';
      str_out += 'SC_qdrq_ano#NMF#' + search_get_sel_txt('SC_qdrq_ano') + '@NMF@';
      str_out += 'SC_qdrq_input_2_dia#NMF#' + search_get_sel_txt('SC_qdrq_input_2_dia') + '@NMF@';
      str_out += 'SC_qdrq_input_2_mes#NMF#' + search_get_sel_txt('SC_qdrq_input_2_mes') + '@NMF@';
      str_out += 'SC_qdrq_input_2_ano#NMF#' + search_get_sel_txt('SC_qdrq_input_2_ano') + '@NMF@';
  }
   ...
   $("#id_ac_qydw").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_qydw",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_qydw").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_qydw").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_cg_htgl'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $qydw_cond, $qydw, $qydw_autocomp,
             $qdrq_cond, $qdrq, $qdrq_dia, $qdrq_mes, $qdrq_ano, $qdrq_input_2_dia, $qdrq_input_2_mes, $qdrq_input_2_ano,
             $shzt_cond, $shzt,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $htbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['htbh']; 
          $htbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['htbh_cond']; 
          $htmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['htmc']; 
          $htmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['htmc_cond']; 
          $cgbbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgbbh']; 
          $cgbbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgbbh_cond']; 
          $cgbmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgbmc']; 
          $cgbmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgbmc_cond']; 
          $cgybh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgybh']; 
          $cgybh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgybh_cond']; 
          $cgyxm = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgyxm']; 
          $cgyxm_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgyxm_cond']; 
          $qydw = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qydw']; 
          $qydw_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qydw_cond']; 
          $qdrq_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_dia']; 
          $qdrq_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_mes']; 
          $qdrq_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_ano']; 
          $qdrq_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_input_2_dia']; 
          $qdrq_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_input_2_mes']; 
          $qdrq_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_input_2_ano']; 
          $qdrq_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_cond']; 
          $shzt = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['shzt']; 
          $shzt_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['shzt_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($qydw_cond) || empty($qydw_cond))
      {
         $qydw_cond = "qp";
      }
      if (!isset($qdrq_cond) || empty($qdrq_cond))
      {
         $qdrq_cond = "TP";
      }
      ...
      if (isset($qdrq_cond) && in_array($qdrq_cond, $this->qdrq_opc_bi))
      {
         $Temp_cond = $qdrq_cond;
         $this->process_cond_bi($Temp_cond, $BI_data1, $BI_data2);
         $qdrq_dia = substr($BI_data1, 0, 2);
         $qdrq_mes = substr($BI_data1, 2, 2);
         $qdrq_ano = substr($BI_data1, 4);
         $qdrq_input_2_dia = substr($BI_data2, 0, 2);
         $qdrq_input_2_mes = substr($BI_data2, 2, 2);
         $qdrq_input_2_ano = substr($BI_data2, 4);
         $Script_BI .= "  formata_bi_qdrq('" . $qdrq_cond . "');\r\n";
      }
      ...
      $str_hide_qydw = (in_array($qydw_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_qdrq = (in_array($qdrq_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_shzt = (in_array($shzt_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_qdrq = ('bw' == $qdrq_cond) ? $display_aberto : $display_fechado;
...
<?php
   if (is_file("grid_cg_htgl_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['htbh'])) ? $this->New_label['htbh'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_htbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_htbh" name="htbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['htmc'])) ? $this->New_label['htmc'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_htmc'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_htmc" name="htmc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgbbh'])) ? $this->New_label['cgbbh'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_cgbbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cgbbh" name="cgbbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cgbmc'])) ? $this->New_label['cgbmc'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_cgbmc'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cgbmc" name="cgbmc_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgybh'])) ? $this->New_label['cgybh'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_cgybh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cgybh" <?php echo $str_hide_cgybh?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cgybh" name="cgybh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cgyxm'])) ? $this->New_label['cgyxm'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_cgyxm'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cgyxm" <?php echo $str_hide_cgyxm?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cgyxm" name="cgyxm_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['qydw'])) ? $this->New_label['qydw'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_qydw'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_qydw_cond" name="qydw_cond" onChange="nm_campos_between(document.getElementById('id_vis_qydw'), this, 'qydw')">
       <OPTION value="qp" <?php if ("qp" == $qydw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $qydw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $qydw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $qydw_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_qydw" <?php echo $str_hide_qydw?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['qydw'])) ? $this->New_label['qydw'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_qydw'] . "";
 $nmgp_tab_label .= "qydw?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $qydw_look = substr($this->Db->qstr($qydw), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct qydw from " . $this->Ini->nm_tabela . " where qydw = '$qydw_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$qydw]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$qydw];
      }
      else
      {
          $sAutocompValue = $qydw;
...
?>
<INPUT  type="text" id="SC_qydw" name="qydw" value="<?php echo NM_encode_input($qydw) ?>" size=32 alt="{datatype: 'text', maxLength: 64, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_qydw" name="qydw_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['qdrq'])) ? $this->New_label['qdrq'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_qdrq'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_qdrq_cond" name="qdrq_cond" onChange="nm_campos_between(document.getElementById('id_vis_qdrq'), this, 'qdrq')">
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_spec'] ?>">
       <OPTION value="TP" <?php if ("TP" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_ever'] ?></OPTION>
       <OPTION value="HJ" <?php if ("HJ" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
       <OPTION value="OT" <?php if ("OT" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
       <OPTION value="U7" <?php if ("U7" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lst7'] ?></OPTION>
       <OPTION value="SP" <?php if ("SP" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lstw'] ?></OPTION>
       <OPTION value="US" <?php if ("US" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lstw_bsnd'] ?></OPTION>
       <OPTION value="MM" <?php if ("MM" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_this_mnth'] ?></OPTION>
       <OPTION value="UM" <?php if ("UM" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_mnth'] ?></OPTION>
       <OPTION value="CY" <?php if ("CY" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_curr_year'] ?></OPTION>
       <OPTION value="LY" <?php if ("LY" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_year'] ?></OPTION>
       <OPTION value="M24" <?php if ("M24" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_24mo'] ?></OPTION>
       <OPTION value="M18" <?php if ("M18" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_18mo'] ?></OPTION>
       <OPTION value="YY" <?php if ("YY" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_12mo'] ?></OPTION>
       <OPTION value="M6" <?php if ("M6" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_06mo'] ?></OPTION>
       <OPTION value="M3" <?php if ("M3" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_03mo'] ?></OPTION>
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_nrml'] ?>">
       <OPTION value="eq" <?php if ("eq" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $qdrq_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven"><SPAN id="Nm_bi_dados_qdrq" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_qdrq"  style=display:  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_qdrq" <?php echo $str_hide_qdrq?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['qdrq'])) ? $this->New_label['qdrq'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_qdrq'] . "";
 $nmgp_tab_label .= "qdrq?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_qdrq_dia" name="qdrq_dia" value="<?php echo NM_encode_input($qdrq_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.qdrq_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_qdrq_mes" name="qdrq_mes" value="<?php echo NM_encode_input($qdrq_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.qdrq_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_qdrq_ano" name="qdrq_ano" value="<?php echo NM_encode_input($qdrq_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<INPUT type="hidden" id="sc_qdrq_jq">
        <SPAN id="id_css_qdrq"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_qdrq"  <?php echo $str_display_qdrq; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_qdrq_input_2_dia" name="qdrq_input_2_dia" value="<?php echo NM_encode_input($qdrq_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.qdrq_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_qdrq_input_2_mes" name="qdrq_input_2_mes" value="<?php echo NM_encode_input($qdrq_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.qdrq_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_qdrq_input_2_ano" name="qdrq_input_2_ano" value="<?php echo NM_encode_input($qdrq_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
         <INPUT type="hidden" id="sc_qdrq_jq2">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['shzt'])) ? $this->New_label['shzt'] : "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_shzt'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_shzt" <?php echo $str_hide_shzt?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['psq_check_ret']['shzt'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['psq_check_ret']['shzt'][] = trim($rs->fields[0]);
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_htgl']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_htgl']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_qydw'), document.F1.qydw_cond, 'qydw');
   document.F1.qydw.value = "";
   document.F1.qydw_autocomp.value = "";
   var opc_bi = document.F1.qdrq_cond.value;
   ...
   {
       document.F1.qdrq_cond.value = 'TP';
   }
   nm_campos_between(document.getElementById('id_vis_qdrq'), document.F1.qdrq_cond, 'qdrq');
   document.F1.qdrq_dia.value = "";
   document.F1.qdrq_mes.value = "";
   document.F1.qdrq_ano.value = "";
   document.F1.qdrq_input_2_dia.value = "";
   document.F1.qdrq_input_2_mes.value = "";
   document.F1.qdrq_input_2_ano.value = "";
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_qdrq_dia').bind('change', function() {sc_grid_cg_htgl_valida_dia(this)});
    $('#SC_qdrq_input_2_dia').bind('change', function() {sc_grid_cg_htgl_valida_dia(this)});
    $('#SC_qdrq_input_2_mes').bind('change', function() {sc_grid_cg_htgl_valida_mes(this)});
    $('#SC_qdrq_mes').bind('change', function() {sc_grid_cg_htgl_valida_mes(this)});
 }
 function sc_grid_cg_htgl_valida_dia(obj)
 {
 ...
 function sc_grid_cg_htgl_valida_mes(obj)
 {
...
function formata_bi_qdrq(opc)
{
   if (opc != "TP" && opc != "HJ" && opc != "OT" && opc != "U7" && opc != "SP" && opc != "US" && opc != "MM" && opc != "UM" && opc != "AM" && opc != "PS" && opc != "SS" && opc != "P3" && opc != "PM" && opc != "P7" && opc != "CY" && opc != "LY" && opc != "YY" && opc != "M6" && opc != "M3" && opc != "M18" && opc != "M24")
   {
       document.getElementById('Nm_bi_dados_qdrq').style.display = 'none';
       document.getElementById('opc_bi_TP_qdrq').style.display = '';
       return;
   }
   if (opc == "TP")
   {
       document.getElementById('Nm_bi_dados_qdrq').style.display = 'none';
       document.getElementById('opc_bi_TP_qdrq').style.display = 'none';
       return;
   }
<?php
   $date_format_show = "";
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.qdrq_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.qdrq_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.qdrq_ano.value" : "";
       $Prim = false;
   }
?> 
...
<?php
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.qdrq_input_2_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.qdrq_input_2_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.qdrq_input_2_ano.value" : "";
       $Prim = false;
   }
?> 
   saida += <?php echo $date_format_show ?>;
   }
   document.getElementById('Nm_bi_dados_qdrq').innerHTML = saida;
   document.getElementById('opc_bi_TP_qdrq').style.display = 'none';
   document.getElementById('Nm_bi_dados_qdrq').style.display = '';
}
<?php
  echo $Script_BI;
?>
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_qydw_cond'] = 'cond';
      $tp_fields['SC_qydw'] = 'text_aut';
      $tp_fields['id_ac_qydw'] = 'text_aut';
      $tp_fields['SC_qdrq_cond'] = 'cond';
      $tp_fields['SC_qdrq_dia'] = 'text';
      $tp_fields['SC_qdrq_mes'] = 'text';
      $tp_fields['SC_qdrq_ano'] = 'text';
      $tp_fields['SC_qdrq_input_2_dia'] = 'text';
      $tp_fields['SC_qdrq_input_2_mes'] = 'text';
      $tp_fields['SC_qdrq_input_2_ano'] = 'text';
   ...
   function trata_campos()
   {
      ...
      if (!empty($qydw_autocomp) && empty($qydw))
      {
          $qydw = $qydw_autocomp;
      }
      ...
      $qydw_cond_salva = $qydw_cond; 
      if (!isset($qydw_input_2) || $qydw_input_2 == "")
      {
          $qydw_input_2 = $qydw;
      }
      $qdrq_cond_salva = $qdrq_cond; 
      if (!isset($qdrq_input_2_dia) || $qdrq_input_2_dia == "")
      {
          $qdrq_input_2_dia = $qdrq_dia;
      }
      if (!isset($qdrq_input_2_mes) || $qdrq_input_2_mes == "")
      {
          $qdrq_input_2_mes = $qdrq_mes;
      }
      if (!isset($qdrq_input_2_ano) || $qdrq_input_2_ano == "")
      {
          $qdrq_input_2_ano = $qdrq_ano;
      }
      ...
      if (is_array($shzt)) {
          foreach ($shzt as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['psq_check_ret']['shzt'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_htgl_fld_shzt'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['htbh'] = $htbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['htbh_cond'] = $htbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['htmc'] = $htmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['htmc_cond'] = $htmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgbbh'] = $cgbbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgbbh_cond'] = $cgbbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgbmc'] = $cgbmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgbmc_cond'] = $cgbmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgybh'] = $cgybh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgybh_cond'] = $cgybh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgyxm'] = $cgyxm; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['cgyxm_cond'] = $cgyxm_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qydw'] = $qydw; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qydw_cond'] = $qydw_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_dia'] = $qdrq_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_mes'] = $qdrq_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_ano'] = $qdrq_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_input_2_dia'] = $qdrq_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_input_2_mes'] = $qdrq_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_input_2_ano'] = $qdrq_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_cond'] = $qdrq_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['shzt'] = $shzt; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['shzt_cond'] = $shzt_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['qydw'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['qydw'] = $qydw;
      }
      $this->cmp_formatado['shzt'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['shzt'];
      ...
      //----- $qydw
      $this->Date_part = false;
      if (isset($qydw) || $qydw_cond == "nu" || $qydw_cond == "nn" || $qydw_cond == "ep" || $qydw_cond == "ne")
      {
         $this->monta_condicao("qydw", $qydw_cond, $qydw, "", "qydw");
      }
      ...
      if ($qdrq_cond != "TP")
      {
          $qdrq_cond = strtoupper($qdrq_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $qdrq_ano;
          $Dtxt .= $qdrq_mes;
          ...
          if ($qdrq_cond == "BW")
          {
              $val[1]['ano'] = $qdrq_input_2_ano;
              $val[1]['mes'] = $qdrq_input_2_mes;
              $val[1]['dia'] = $qdrq_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $qdrq_cond , "", "data");
          $qdrq = $val[0];
          $this->cmp_formatado['qdrq'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['qdrq'], "YYYY-MM-DD");
          $this->cmp_formatado['qdrq'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($qdrq_cond == "BW")
          {
              $qdrq_input_2     = $val[1];
              $this->cmp_formatado['qdrq_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']['qdrq_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['qdrq_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['qdrq_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $qdrq_cond == "NU" || $qdrq_cond == "NN"|| $qdrq_cond == "EP"|| $qdrq_cond == "NE")
          {
              $this->monta_condicao("qdrq", $qdrq_cond, $qdrq, $qdrq_input_2, 'qdrq', 'DATE');
          }
      }
      ...
      if (count($shzt) != 0)
      {
         ...
         if (strtoupper($shzt_cond) == "DF" || strtoupper($shzt_cond) == "NP")
         {
             ...
             $this->comando_sum    .= " cg_htgl.shzt not in (";
             $this->comando_filtro .= " shzt not in (";
         }
         else
         {
             $this->comando        .= " shzt in (";
             $this->comando_sum    .= " cg_htgl.shzt in (";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $nmgp_tab_label['shzt'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_htgl']['where_pesq_ant'] = $this->comando . $this->comando_fim;

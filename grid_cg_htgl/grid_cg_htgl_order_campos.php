<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_htgl_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_htgl_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['htbh'] = "on";
   $tab_def_campos['htbh'] = "htbh";
   $tab_converte["htbh"]   = "htbh";
   $tab_labels["htbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["htbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["htbh"] : "" . $this->Nm_lang['lang_cg_htgl_fld_htbh'] . "";
   $tab_ger_campos['htmc'] = "on";
   $tab_def_campos['htmc'] = "htmc";
   $tab_converte["htmc"]   = "htmc";
   $tab_labels["htmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["htmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["htmc"] : "" . $this->Nm_lang['lang_cg_htgl_fld_htmc'] . "";
   $tab_ger_campos['qdrq'] = "on";
   $tab_def_campos['qdrq'] = "qdrq";
   $tab_converte["qdrq"]   = "qdrq";
   $tab_labels["qdrq"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["qdrq"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["qdrq"] : "" . $this->Nm_lang['lang_cg_htgl_fld_qdrq'] . "";
   $tab_ger_campos['qydw'] = "on";
   $tab_def_campos['qydw'] = "qydw";
   $tab_converte["qydw"]   = "qydw";
   $tab_labels["qydw"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["qydw"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["qydw"] : "" . $this->Nm_lang['lang_cg_htgl_fld_qydw'] . "";
   $tab_ger_campos['htje'] = "on";
   $tab_def_campos['htje'] = "htje";
   $tab_converte["htje"]   = "htje";
   $tab_labels["htje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["htje"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["htje"] : "" . $this->Nm_lang['lang_cg_htgl_fld_htje'] . "";
   $tab_ger_campos['shzt'] = "on";
   $tab_def_campos['shzt'] = "shzt";
   $tab_converte["shzt"]   = "shzt";
   $tab_labels["shzt"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["shzt"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["shzt"] : "" . $this->Nm_lang['lang_cg_htgl_fld_shzt'] . "";
   ...
   $tab_labels["splc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["splc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["splc"] : "操作";
   ...
   $tab_labels["splcxx"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["splcxx"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['labels']["splcxx"] : "审批信息";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_htgl'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_htgl_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_htgl']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {

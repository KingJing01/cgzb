...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "qdrq";$Nm_datas[] = "zbdqrq";$Nm_datas[] = "shsj";$Nm_numeric[] = "id";$Nm_numeric[] = "htje";$Nm_numeric[] = "zbj";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_qydw"  <?php echo $str_hide_qydw?>><?php
      $qydw_look = substr($this->Db->qstr($qydw), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_qdrq"  <?php echo $str_hide_qdrq?>>
<SPAN id="Nm_bi_dados_qdrq" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_qdrq"  style="display:''">
...
<INPUT type="hidden" id="sc_qdrq_jq">
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_qdrq"  <?php echo $str_display_qdrq; ?> class="scFilterFieldFontEven">

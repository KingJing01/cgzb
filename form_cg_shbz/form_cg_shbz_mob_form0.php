...
<?php
include_once("form_cg_shbz_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_shbz_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['recarga'];
}
?>
...
<?php
 include_once("form_cg_shbz_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_shbz_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_shbz_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_bzmc_line" id="hidden_field_data_bzmc" style="<?php echo $sStyleHidden_bzmc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bzmc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_bzmc_label"><span id="id_label_bzmc"><?php echo $this->nm_new_label['bzmc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['bzmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['bzmc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ms_line" id="hidden_field_data_ms" style="<?php echo $sStyleHidden_ms; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ms_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ms_label"><span id="id_label_ms"><?php echo $this->nm_new_label['ms']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['ms']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['ms'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_isqs_line" id="hidden_field_data_isqs" style="<?php echo $sStyleHidden_isqs; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isqs_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_isqs_label"><span id="id_label_isqs"><?php echo $this->nm_new_label['isqs']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['isqs']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['isqs'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['Lookup_isqs'][] = '是'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['Lookup_isqs'][] = '否'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_isjs_line" id="hidden_field_data_isjs" style="<?php echo $sStyleHidden_isjs; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isjs_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_isjs_label"><span id="id_label_isjs"><?php echo $this->nm_new_label['isjs']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['isjs']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['isjs'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['Lookup_isjs'][] = '是'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['Lookup_isjs'][] = '否'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_yhlx_line" id="hidden_field_data_yhlx" style="<?php echo $sStyleHidden_yhlx; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_yhlx_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_yhlx_label"><span id="id_label_yhlx"><?php echo $this->nm_new_label['yhlx']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['yhlx']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['yhlx'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_bmlx_line" id="hidden_field_data_bmlx" style="<?php echo $sStyleHidden_bmlx; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bmlx_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_bmlx_label"><span id="id_label_bmlx"><?php echo $this->nm_new_label['bmlx']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_isgdyh_line" id="hidden_field_data_isgdyh" style="<?php echo $sStyleHidden_isgdyh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isgdyh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_isgdyh_label"><span id="id_label_isgdyh"><?php echo $this->nm_new_label['isgdyh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['isgdyh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['isgdyh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['Lookup_isgdyh'][] = '是'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['Lookup_isgdyh'][] = '否'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_gdyh_line" id="hidden_field_data_gdyh" style="<?php echo $sStyleHidden_gdyh; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_gdyh_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_gdyh_label"><span id="id_label_gdyh"><?php echo $this->nm_new_label['gdyh']; ?></span></span><br>
...
<span id="id_read_on_gdyh" class="sc-ui-readonly-gdyh css_gdyh_line" style="<?php echo $sStyleReadLab_gdyh; ?>"><?php echo $this->form_encode_input($this->gdyh); ?></span><span id="id_read_off_gdyh" style="white-space: nowrap;<?php echo $sStyleReadInp_gdyh; ?>">
 ...
 size=32 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["sec_grid_sec_users"]) && $this->Ini->sc_lig_md5["sec_grid_sec_users"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cg_shbz_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_listorder_line" id="hidden_field_data_listorder" style="<?php echo $sStyleHidden_listorder; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_listorder_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_listorder_label"><span id="id_label_listorder"><?php echo $this->nm_new_label['listorder']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['listorder']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['php_cmp_required']['listorder'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_shbz_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_shbz_mob");
 parent.scAjaxDetailHeight("form_cg_shbz_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}

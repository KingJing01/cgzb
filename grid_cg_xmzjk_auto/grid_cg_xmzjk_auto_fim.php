...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_xmzjk_auto"]))
   {
      unset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_xmzjk_auto"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_xmzjk_auto']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_xmzjk_auto']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_xmzjk_auto']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_xmzjk_auto']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cg_xmzjk_auto']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_cg_xmzjk_auto</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cg_xmzjk_auto']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cg_xmzjk_auto']['embutida_filho'] as $ind => $sc_init)
          {

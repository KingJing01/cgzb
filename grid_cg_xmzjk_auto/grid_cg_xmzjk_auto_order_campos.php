<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_xmzjk_auto_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_xmzjk_auto_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["zjbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["zjbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["zjbh"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_zjbh'] . "";
   $tab_ger_campos['xm'] = "on";
   $tab_def_campos['xm'] = "xm";
   $tab_converte["xm"]   = "xm";
   $tab_labels["xm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["xm"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["xm"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_xm'] . "";
   $tab_ger_campos['xb'] = "on";
   $tab_def_campos['xb'] = "xb";
   $tab_converte["xb"]   = "xb";
   $tab_labels["xb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["xb"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["xb"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_xb'] . "";
   $tab_ger_campos['zc'] = "on";
   $tab_def_campos['zc'] = "zc";
   $tab_converte["zc"]   = "zc";
   $tab_labels["zc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["zc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["zc"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_zc'] . "";
   $tab_ger_campos['yddh'] = "on";
   $tab_def_campos['yddh'] = "yddh";
   $tab_converte["yddh"]   = "yddh";
   $tab_labels["yddh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["yddh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["yddh"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_yddh'] . "";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_converte["email"]   = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['labels']["email"] : "" . $this->Nm_lang['lang_cg_xmzjk_fld_email'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_cg_xmzjk'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_xmzjk_auto_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_xmzjk_auto']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {

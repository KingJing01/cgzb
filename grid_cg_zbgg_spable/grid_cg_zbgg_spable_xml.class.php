...
class grid_cg_zbgg_spable_xml
{
   ...
   //---- 
   function grid_cg_zbgg_spable_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_cg_zbgg_spable.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_cg_zbgg_spable";
...
$_SESSION['scriptcase']['grid_cg_zbgg_spable']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->qysb))
         {
             $this->qysb = sc_convert_encoding($this->qysb, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " qysb =\"" . $this->trata_dados($this->qysb) . "\"";
   }
   //----- cgfs
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_cg_zbgg_spable'] ?> :: XML</TITLE>

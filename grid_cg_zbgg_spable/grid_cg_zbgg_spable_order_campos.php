<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_cg_zbgg_spable_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_cg_zbgg_spable_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["cgbbh"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["cgbbh"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["cgbbh"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_cgbbh'] . "";
   $tab_ger_campos['cgbmc'] = "on";
   $tab_def_campos['cgbmc'] = "cgbmc";
   $tab_converte["cgbmc"]   = "cgbmc";
   $tab_labels["cgbmc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["cgbmc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["cgbmc"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_cgbmc'] . "";
   $tab_ger_campos['bzj'] = "on";
   $tab_def_campos['bzj'] = "bzj";
   $tab_converte["bzj"]   = "bzj";
   $tab_labels["bzj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["bzj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["bzj"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_bzj'] . "";
   $tab_ger_campos['bsf'] = "on";
   $tab_def_campos['bsf'] = "bsf";
   $tab_converte["bsf"]   = "bsf";
   $tab_labels["bsf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["bsf"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["bsf"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_bsf'] . "";
   $tab_ger_campos['zbkssj'] = "on";
   $tab_def_campos['zbkssj'] = "zbkssj";
   $tab_converte["zbkssj"]   = "zbkssj";
   $tab_labels["zbkssj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["zbkssj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["zbkssj"] : "" . $this->Nm_lang['lang_cg_zbgg_fld_zbkssj'] . "";
   $tab_ger_campos['qysb'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['qysb'] = "qysb";
       $tab_converte["qysb"]   = "qysb";
   }
   else
   {
       $tab_def_campos['qysb'] = "";
   ...
   $tab_labels["qysb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["qysb"])) ? $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['labels']["qysb"] : "操作";
   $tab_ger_campos['qysb'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_menu_cg_zbgg_spable'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_cg_zbgg_spable_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cg_zbgg_spable']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {

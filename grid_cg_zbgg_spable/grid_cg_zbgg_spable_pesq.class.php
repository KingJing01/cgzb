...
class grid_cg_zbgg_spable_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_cg_zbgg_spable_pesq()
   {
      $this->zbkssj_opc_bi[] = "TP";
      $this->zbkssj_opc_bi[] = "HJ";
      $this->zbkssj_opc_bi[] = "OT";
      $this->zbkssj_opc_bi[] = "U7";
      $this->zbkssj_opc_bi[] = "SP";
      $this->zbkssj_opc_bi[] = "US";
      $this->zbkssj_opc_bi[] = "MM";
      $this->zbkssj_opc_bi[] = "UM";
      $this->zbkssj_opc_bi[] = "AM";
      $this->zbkssj_opc_bi[] = "PS";
      $this->zbkssj_opc_bi[] = "SS";
      $this->zbkssj_opc_bi[] = "P3";
      $this->zbkssj_opc_bi[] = "PM";
      $this->zbkssj_opc_bi[] = "P7";
      $this->zbkssj_opc_bi[] = "CY";
      $this->zbkssj_opc_bi[] = "LY";
      $this->zbkssj_opc_bi[] = "M24";
      $this->zbkssj_opc_bi[] = "M18";
      $this->zbkssj_opc_bi[] = "YY";
      $this->zbkssj_opc_bi[] = "M6";
      $this->zbkssj_opc_bi[] = "M3";
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cg_zbgg_spable_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cg_zbgg_spable_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cg_zbgg_spable_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_cgbbh($cgbbh)
   {
      ...
      $nm_comando = "select distinct cgbbh from " . $this->Ini->nm_tabela . " where shzt='通过' and  cgbbh like '%" . $cgbbh . "%'"; 
   ...
   function lookup_ajax_cgbmc($cgbmc)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cgbmc from " . $this->Ini->nm_tabela . " where shzt='通过' and  cgbmc like '%" . $cgbmc . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "bskssj";$Nm_datas[] = "bsjssj";$Nm_datas[] = "xckssj";$Nm_datas[] = "xcjssj";$Nm_datas[] = "zbkssj";$Nm_datas[] = "zbjssj";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_cg_zbgg_spable'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cg_zbgg_spable/grid_cg_zbgg_spable_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cg_zbgg_spable_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cg_zbgg_spable_ajax.js"></script>
 <script type="text/javascript">
...
function scJQCalendarAdd() {
  $("#sc_zbkssj_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_zbkssj_dia').value + '/';
          var_dt_ini += document.getElementById('SC_zbkssj_mes').value + '/';
          var_dt_ini += document.getElementById('SC_zbkssj_ano').value;
          document.getElementById('sc_zbkssj_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_zbkssj_dia').value = aParts[0];
          document.getElementById('SC_zbkssj_mes').value = aParts[1];
          document.getElementById('SC_zbkssj_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_zbkssj_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_zbkssj_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_zbkssj_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_zbkssj_input_2_ano').value;
          document.getElementById('sc_zbkssj_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_zbkssj_input_2_dia').value = aParts[0];
          document.getElementById('SC_zbkssj_input_2_mes').value = aParts[1];
          document.getElementById('SC_zbkssj_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_zbkssj_cond#NMF#' + search_get_sel_txt('SC_zbkssj_cond') + '@NMF@';
  opc = search_get_sel_txt('SC_zbkssj_cond');
  if (opc != "TP" && opc != "HJ" && opc != "OT" && opc != "U7" && opc != "SP" && opc != "US" && opc != "MM" && opc != "UM" && opc != "AM" && opc != "PS" && opc != "SS" && opc != "P3" && opc != "PM" && opc != "P7" && opc != "CY" && opc != "LY" && opc != "YY" && opc != "M6" && opc != "M3" && opc != "M18" && opc != "M24")
  {
      str_out += 'SC_zbkssj_dia#NMF#' + search_get_sel_txt('SC_zbkssj_dia') + '@NMF@';
      str_out += 'SC_zbkssj_mes#NMF#' + search_get_sel_txt('SC_zbkssj_mes') + '@NMF@';
      str_out += 'SC_zbkssj_ano#NMF#' + search_get_sel_txt('SC_zbkssj_ano') + '@NMF@';
      str_out += 'SC_zbkssj_input_2_dia#NMF#' + search_get_sel_txt('SC_zbkssj_input_2_dia') + '@NMF@';
      str_out += 'SC_zbkssj_input_2_mes#NMF#' + search_get_sel_txt('SC_zbkssj_input_2_mes') + '@NMF@';
      str_out += 'SC_zbkssj_input_2_ano#NMF#' + search_get_sel_txt('SC_zbkssj_input_2_ano') + '@NMF@';
  }
  str_out += 'SC_zbkssj_hor#NMF#' + search_get_sel_txt('SC_zbkssj_hor') + '@NMF@';
  str_out += 'SC_zbkssj_min#NMF#' + search_get_sel_txt('SC_zbkssj_min') + '@NMF@';
  str_out += 'SC_zbkssj_seg#NMF#' + search_get_sel_txt('SC_zbkssj_seg') + '@NMF@';
  str_out += 'SC_zbkssj_input_2_hor#NMF#' + search_get_sel_txt('SC_zbkssj_input_2_hor') + '@NMF@';
  str_out += 'SC_zbkssj_input_2_min#NMF#' + search_get_sel_txt('SC_zbkssj_input_2_min') + '@NMF@';
  str_out += 'SC_zbkssj_input_2_seg#NMF#' + search_get_sel_txt('SC_zbkssj_input_2_seg') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_menu_cg_zbgg_spable'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $cgfs_cond, $cgfs,
             $zbkssj_cond, $zbkssj, $zbkssj_dia, $zbkssj_mes, $zbkssj_ano, $zbkssj_hor, $zbkssj_min, $zbkssj_seg, $zbkssj_input_2_dia, $zbkssj_input_2_mes, $zbkssj_input_2_ano, $zbkssj_input_2_min, $zbkssj_input_2_hor, $zbkssj_input_2_seg,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cgbbh = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgbbh']; 
          $cgbbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgbbh_cond']; 
          $cgbmc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgbmc']; 
          $cgbmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgbmc_cond']; 
          $cgfs = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgfs']; 
          $cgfs_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgfs_cond']; 
          $zbkssj_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_dia']; 
          $zbkssj_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_mes']; 
          $zbkssj_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_ano']; 
          $zbkssj_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_dia']; 
          $zbkssj_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_mes']; 
          $zbkssj_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_ano']; 
          $zbkssj_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_hor']; 
          $zbkssj_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_min']; 
          $zbkssj_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_seg']; 
          $zbkssj_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_hor']; 
          $zbkssj_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_min']; 
          $zbkssj_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_seg']; 
          $zbkssj_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($zbkssj_cond) || empty($zbkssj_cond))
      {
         $zbkssj_cond = "TP";
      }
      if (isset($zbkssj_cond) && in_array($zbkssj_cond, $this->zbkssj_opc_bi))
      {
         $Temp_cond = $zbkssj_cond;
         $this->process_cond_bi($Temp_cond, $BI_data1, $BI_data2);
         $zbkssj_dia = substr($BI_data1, 0, 2);
         $zbkssj_mes = substr($BI_data1, 2, 2);
         $zbkssj_ano = substr($BI_data1, 4);
         $zbkssj_input_2_dia = substr($BI_data2, 0, 2);
         $zbkssj_input_2_mes = substr($BI_data2, 2, 2);
         $zbkssj_input_2_ano = substr($BI_data2, 4);
         $Script_BI .= "  formata_bi_zbkssj('" . $zbkssj_cond . "');\r\n";
      }
      ...
      $str_hide_zbkssj = (in_array($zbkssj_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_zbkssj = ('bw' == $zbkssj_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($zbkssj) || $zbkssj == "")
      {
          $zbkssj = "";
      }
      if (isset($zbkssj) && !empty($zbkssj))
      {
         $tmp_pos = strpos($zbkssj, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $zbkssj = substr($zbkssj, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_cg_zbgg_spable_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgbbh'])) ? $this->New_label['cgbbh'] : "" . $this->Ini->Nm_lang['lang_cg_zbgg_fld_cgbbh'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<?php
      $cgbbh_look = substr($this->Db->qstr($cgbbh), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cgbbh from " . $this->Ini->nm_tabela . " where shzt='通过' and cgbbh = '$cgbbh_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cgbbh" name="cgbbh_autocomp" size="32" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cgbmc'])) ? $this->New_label['cgbmc'] : "" . $this->Ini->Nm_lang['lang_cg_zbgg_fld_cgbmc'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
      $cgbmc_look = substr($this->Db->qstr($cgbmc), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cgbmc from " . $this->Ini->nm_tabela . " where shzt='通过' and cgbmc = '$cgbmc_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cgbmc" name="cgbmc_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cgfs'])) ? $this->New_label['cgfs'] : "" . $this->Ini->Nm_lang['lang_cg_zbgg_fld_cgfs'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cgfs" <?php echo $str_hide_cgfs?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['psq_check_ret']['cgfs'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['psq_check_ret']['cgfs'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['zbkssj'])) ? $this->New_label['zbkssj'] : "" . $this->Ini->Nm_lang['lang_cg_zbgg_fld_zbkssj'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_zbkssj_cond" name="zbkssj_cond" onChange="nm_campos_between(document.getElementById('id_vis_zbkssj'), this, 'zbkssj')">
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_spec'] ?>">
       <OPTION value="TP" <?php if ("TP" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_ever'] ?></OPTION>
       <OPTION value="HJ" <?php if ("HJ" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
       <OPTION value="OT" <?php if ("OT" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
       <OPTION value="U7" <?php if ("U7" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lst7'] ?></OPTION>
       <OPTION value="SP" <?php if ("SP" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lstw'] ?></OPTION>
       <OPTION value="US" <?php if ("US" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_lstw_bsnd'] ?></OPTION>
       <OPTION value="MM" <?php if ("MM" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_this_mnth'] ?></OPTION>
       <OPTION value="UM" <?php if ("UM" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_mnth'] ?></OPTION>
       <OPTION value="AM" <?php if ("AM" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tomw'] ?></OPTION>
       <OPTION value="PS" <?php if ("PS" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nxtw_mond_frid'] ?></OPTION>
       <OPTION value="SS" <?php if ("SS" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nxtw_mond_sund'] ?></OPTION>
       <OPTION value="P3" <?php if ("P3" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nx30'] ?></OPTION>
       <OPTION value="PM" <?php if ("PM" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_next_mnth'] ?></OPTION>
       <OPTION value="P7" <?php if ("P7" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nxt7'] ?></OPTION>
       <OPTION value="CY" <?php if ("CY" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_curr_year'] ?></OPTION>
       <OPTION value="LY" <?php if ("LY" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_year'] ?></OPTION>
       <OPTION value="M24" <?php if ("M24" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_24mo'] ?></OPTION>
       <OPTION value="M18" <?php if ("M18" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_18mo'] ?></OPTION>
       <OPTION value="YY" <?php if ("YY" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_12mo'] ?></OPTION>
       <OPTION value="M6" <?php if ("M6" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_06mo'] ?></OPTION>
       <OPTION value="M3" <?php if ("M3" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_03mo'] ?></OPTION>
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_nrml'] ?>">
       <OPTION value="eq" <?php if ("eq" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $zbkssj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven"><SPAN id="Nm_bi_dados_zbkssj" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_zbkssj"  style=display:  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_zbkssj" <?php echo $str_hide_zbkssj?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['zbkssj'])) ? $this->New_label['zbkssj'] : "" . $this->Ini->Nm_lang['lang_cg_zbgg_fld_zbkssj'] . "";
 $nmgp_tab_label .= "zbkssj?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_zbkssj_dia" name="zbkssj_dia" value="<?php echo NM_encode_input($zbkssj_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.zbkssj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_zbkssj_mes" name="zbkssj_mes" value="<?php echo NM_encode_input($zbkssj_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.zbkssj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_zbkssj_ano" name="zbkssj_ano" value="<?php echo NM_encode_input($zbkssj_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<INPUT type="hidden" id="sc_zbkssj_jq">
        <SPAN id="id_css_zbkssj"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_zbkssj"  <?php echo $str_display_zbkssj; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_zbkssj_input_2_dia" name="zbkssj_input_2_dia" value="<?php echo NM_encode_input($zbkssj_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.zbkssj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_zbkssj_input_2_mes" name="zbkssj_input_2_mes" value="<?php echo NM_encode_input($zbkssj_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.zbkssj_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_zbkssj_input_2_ano" name="zbkssj_input_2_ano" value="<?php echo NM_encode_input($zbkssj_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
         <INPUT type="hidden" id="sc_zbkssj_jq2">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cg_zbgg_spable']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cg_zbgg_spable']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   var opc_bi = document.F1.zbkssj_cond.value;
   if (opc_bi == 'TP' || opc_bi == 'HJ' || opc_bi == 'OT' || opc_bi == 'U7' || opc_bi == 'SP' || opc_bi == 'US' || opc_bi == 'MM' || opc_bi == 'UM' || opc_bi == 'AM' || opc_bi == 'PS' || opc_bi == 'SS' || opc_bi == 'P3' || opc_bi == 'PM' || opc_bi == 'P7' || opc_bi == 'CY' || opc_bi == 'LY' || opc_bi == 'M24' || opc_bi == 'M18' || opc_bi == 'YY' || opc_bi == 'M6' || opc_bi == 'M3')
   {
       document.F1.zbkssj_cond.value = 'TP';
   }
   nm_campos_between(document.getElementById('id_vis_zbkssj'), document.F1.zbkssj_cond, 'zbkssj');
   document.F1.zbkssj_dia.value = "";
   document.F1.zbkssj_mes.value = "";
   document.F1.zbkssj_ano.value = "";
   document.F1.zbkssj_input_2_dia.value = "";
   document.F1.zbkssj_input_2_mes.value = "";
   document.F1.zbkssj_input_2_ano.value = "";
 }
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_zbkssj_dia').bind('change', function() {sc_grid_cg_zbgg_spable_valida_dia(this)});
    $('#SC_zbkssj_input_2_dia').bind('change', function() {sc_grid_cg_zbgg_spable_valida_dia(this)});
    $('#SC_zbkssj_input_2_mes').bind('change', function() {sc_grid_cg_zbgg_spable_valida_mes(this)});
    $('#SC_zbkssj_mes').bind('change', function() {sc_grid_cg_zbgg_spable_valida_mes(this)});
 }
 function sc_grid_cg_zbgg_spable_valida_dia(obj)
 {
 ...
 function sc_grid_cg_zbgg_spable_valida_mes(obj)
 {
...
function formata_bi_zbkssj(opc)
{
   if (opc != "TP" && opc != "HJ" && opc != "OT" && opc != "U7" && opc != "SP" && opc != "US" && opc != "MM" && opc != "UM" && opc != "AM" && opc != "PS" && opc != "SS" && opc != "P3" && opc != "PM" && opc != "P7" && opc != "CY" && opc != "LY" && opc != "YY" && opc != "M6" && opc != "M3" && opc != "M18" && opc != "M24")
   {
       document.getElementById('Nm_bi_dados_zbkssj').style.display = 'none';
       document.getElementById('opc_bi_TP_zbkssj').style.display = '';
       return;
   }
   if (opc == "TP")
   {
       document.getElementById('Nm_bi_dados_zbkssj').style.display = 'none';
       document.getElementById('opc_bi_TP_zbkssj').style.display = 'none';
       return;
   }
<?php
   $date_format_show = "";
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.zbkssj_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.zbkssj_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.zbkssj_ano.value" : "";
       $Prim = false;
   }
?> 
...
<?php
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.zbkssj_input_2_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.zbkssj_input_2_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.zbkssj_input_2_ano.value" : "";
       $Prim = false;
   }
?> 
   saida += <?php echo $date_format_show ?>;
   }
   document.getElementById('Nm_bi_dados_zbkssj').innerHTML = saida;
   document.getElementById('opc_bi_TP_zbkssj').style.display = 'none';
   document.getElementById('Nm_bi_dados_zbkssj').style.display = '';
}
<?php
  echo $Script_BI;
?>
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "cgzb/grid_cg_zbgg_spable";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_zbkssj_cond'] = 'cond';
      $tp_fields['SC_zbkssj_dia'] = 'text';
      $tp_fields['SC_zbkssj_mes'] = 'text';
      $tp_fields['SC_zbkssj_ano'] = 'text';
      $tp_fields['SC_zbkssj_input_2_dia'] = 'text';
      $tp_fields['SC_zbkssj_input_2_mes'] = 'text';
      $tp_fields['SC_zbkssj_input_2_ano'] = 'text';
      $tp_fields['SC_zbkssj_hor'] = 'text';
      $tp_fields['SC_zbkssj_min'] = 'text';
      $tp_fields['SC_zbkssj_seg'] = 'text';
      $tp_fields['SC_zbkssj_input_2_hor'] = 'text';
      $tp_fields['SC_zbkssj_input_2_min'] = 'text';
      $tp_fields['SC_zbkssj_input_2_seg'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $cgbbh_cond, $cgbbh, $cgbbh_autocomp,
             $cgbmc_cond, $cgbmc, $cgbmc_autocomp,
             $cgfs_cond, $cgfs,
             $zbkssj_cond, $zbkssj, $zbkssj_dia, $zbkssj_mes, $zbkssj_ano, $zbkssj_hor, $zbkssj_min, $zbkssj_seg, $zbkssj_input_2_dia, $zbkssj_input_2_mes, $zbkssj_input_2_ano, $zbkssj_input_2_min, $zbkssj_input_2_hor, $zbkssj_input_2_seg, $nmgp_tab_label;
      ...
      $zbkssj_cond_salva = $zbkssj_cond; 
      if (!isset($zbkssj_input_2_dia) || $zbkssj_input_2_dia == "")
      {
          $zbkssj_input_2_dia = $zbkssj_dia;
      }
      if (!isset($zbkssj_input_2_mes) || $zbkssj_input_2_mes == "")
      {
          $zbkssj_input_2_mes = $zbkssj_mes;
      }
      if (!isset($zbkssj_input_2_ano) || $zbkssj_input_2_ano == "")
      {
          $zbkssj_input_2_ano = $zbkssj_ano;
      }
      if (!isset($zbkssj_input_2_hor) || $zbkssj_input_2_hor == "")
      {
          $zbkssj_input_2_hor = $zbkssj_hor;
      }
      if (!isset($zbkssj_input_2_min) || $zbkssj_input_2_min == "")
      {
          $zbkssj_input_2_min = $zbkssj_min;
      }
      if (!isset($zbkssj_input_2_seg) || $zbkssj_input_2_seg == "")
      {
          $zbkssj_input_2_seg = $zbkssj_seg;
      }
      if (is_array($cgfs)) {
          foreach ($cgfs as $I => $Val) {
              ...
              if (trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['psq_check_ret']['cgfs'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_cg_zbgg_fld_cgfs'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgbbh'] = $cgbbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgbbh_cond'] = $cgbbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgbmc'] = $cgbmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgbmc_cond'] = $cgbmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgfs'] = $cgfs; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgfs_cond'] = $cgfs_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_dia'] = $zbkssj_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_mes'] = $zbkssj_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_ano'] = $zbkssj_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_dia'] = $zbkssj_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_mes'] = $zbkssj_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_ano'] = $zbkssj_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_hor'] = $zbkssj_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_min'] = $zbkssj_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_seg'] = $zbkssj_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_hor'] = $zbkssj_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_min'] = $zbkssj_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2_seg'] = $zbkssj_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_cond'] = $zbkssj_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['cgfs'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['cgfs'];
      ...
      if (count($cgfs) != 0)
      {
         ...
         if (strtoupper($cgfs_cond) == "DF" || strtoupper($cgfs_cond) == "NP")
         {
             ...
             $this->comando_sum    .= " cg_zbgg.cgfs not in (";
             $this->comando_filtro .= " cgfs not in (";
         }
         else
         {
             $this->comando        .= " cgfs in (";
             $this->comando_sum    .= " cg_zbgg.cgfs in (";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $nmgp_tab_label['cgfs'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if ($zbkssj_cond != "TP")
      {
          $zbkssj_cond = strtoupper($zbkssj_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $zbkssj_ano;
          $Dtxt .= $zbkssj_mes;
          ...
          $Dtxt .= $zbkssj_min;
          $Dtxt .= $zbkssj_seg;
          $val[0]['ano'] = $zbkssj_ano;
          $val[0]['mes'] = $zbkssj_mes;
          $val[0]['dia'] = $zbkssj_dia;
          $val[0]['hor'] = $zbkssj_hor;
          $val[0]['min'] = $zbkssj_min;
          $val[0]['seg'] = $zbkssj_seg;
          if ($zbkssj_cond == "BW")
          {
              $val[1]['ano'] = $zbkssj_input_2_ano;
              $val[1]['mes'] = $zbkssj_input_2_mes;
              $val[1]['dia'] = $zbkssj_input_2_dia;
              $val[1]['hor'] = $zbkssj_input_2_hor;
              $val[1]['min'] = $zbkssj_input_2_min;
              $val[1]['seg'] = $zbkssj_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "DATETIME", $zbkssj_cond , "", "datahora");
          $zbkssj = $val[0];
          $this->cmp_formatado['zbkssj'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['zbkssj'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['zbkssj'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($zbkssj_cond == "BW")
          {
              $zbkssj_input_2     = $val[1];
              $this->cmp_formatado['zbkssj_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']['zbkssj_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['zbkssj_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['zbkssj_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $zbkssj_cond == "NU" || $zbkssj_cond == "NN"|| $zbkssj_cond == "EP"|| $zbkssj_cond == "NE")
          {
              $this->monta_condicao("zbkssj", $zbkssj_cond, $zbkssj, $zbkssj_input_2, 'zbkssj', 'DATETIME');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg_spable']['where_pesq_ant'] = $this->comando . $this->comando_fim;

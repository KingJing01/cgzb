...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "bskssj";$Nm_datas[] = "bsjssj";$Nm_datas[] = "xckssj";$Nm_datas[] = "xcjssj";$Nm_datas[] = "zbkssj";$Nm_datas[] = "zbjssj";$Nm_numeric[] = "id";$Nm_numeric[] = "bzj";$Nm_numeric[] = "bsf";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_zbkssj"  <?php echo $str_hide_zbkssj?>>
<SPAN id="Nm_bi_dados_zbkssj" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_zbkssj"  style="display:''">
...
<INPUT type="hidden" id="sc_zbkssj_jq">
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_zbkssj"  <?php echo $str_display_zbkssj; ?> class="scFilterFieldFontEven">

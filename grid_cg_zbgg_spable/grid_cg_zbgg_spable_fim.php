...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_zbgg_spable"]))
   {
      unset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_zbgg_spable"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_zbgg_spable']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_zbgg_spable']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_zbgg_spable']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_zbgg_spable']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cg_zbgg_spable']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_cg_zbgg_spable</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cg_zbgg_spable']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cg_zbgg_spable']['embutida_filho'] as $ind => $sc_init)
          {

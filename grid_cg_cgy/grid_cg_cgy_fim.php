...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_cgy"]))
   {
      unset($_SESSION['session_sec_aplicacao']["cgzb_____grid_cg_cgy"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cg_cgy'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_cgy']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_cgy']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cg_cgy']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cg_cgy']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cg_cgy']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cg_cgy']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cg_cgy']['embutida_filho'] as $ind => $sc_init)
          {

...
class search_eval_cg_qytb_temp_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function search_eval_cg_qytb_temp_pesq()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cg_zbgg']['opc_psq'] = false; 
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . search_eval_cg_qytb_temp_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . search_eval_cg_qytb_temp_pack_protect_string($Tipo_filter[0]) . "\">.." . search_eval_cg_qytb_temp_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         if ($nome == "cpbmc") {$nomeX = "";}
         $nome = $nomeX;
         $nome_sum = "eval_cg_qytb_temp.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . SC_dir_app_name('form_eval_cg_qytb_temp') . "/";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_eval_cg_qytb_temp'] ?></TITLE>
...
<INPUT type="hidden" name="nmgp_parms" value="NM_where_filter_form?#?<?php echo NM_encode_input($this->comando_filtro); ?>?@?cpbbh?#?<?php echo str_replace("'", "@aspass@", $_SESSION['v_cpbbh']); ?>?@?SC_glo_par_cpbbh?#?v_cpbbh?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?"/>
</FORM>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>search_eval_cg_qytb_temp/search_eval_cg_qytb_temp_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="search_eval_cg_qytb_temp_ajax_search.js"></script>
 <script type="text/javascript" src="search_eval_cg_qytb_temp_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_cpbmc_cond#NMF#' + search_get_sel_txt('SC_cpbmc_cond') + '@NMF@';
  str_out += 'SC_cpbmc#NMF#' + search_get_select('SC_cpbmc') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_eval_cg_qytb_temp'] ?></span></td>
...
<?php
   ...
   {
      global 
             $zbggbh_cond, $zbggbh, $zbggbh_autocomp,
             $cpbmc_cond, $cpbmc,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['search_eval_cg_qytb_temp']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['search_eval_cg_qytb_temp']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['search_eval_cg_qytb_temp']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $zbggbh = $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']['zbggbh']; 
          $zbggbh_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']['zbggbh_cond']; 
          $cpbmc = $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']['cpbmc']; 
          $cpbmc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']['cpbmc_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']['NM_operador']; 
      } 
      if (!isset($zbggbh_cond) || empty($zbggbh_cond))
      {
         $zbggbh_cond = "eq";
      }
      if (!isset($cpbmc_cond) || empty($cpbmc_cond))
      {
         $cpbmc_cond = "eq";
      }
      ...
      $str_hide_cpbmc = (in_array($cpbmc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($cpbmc) || $cpbmc == "")
      {
          $cpbmc = "";
      }
      if (isset($cpbmc) && !empty($cpbmc))
      {
         $tmp_pos = strpos($cpbmc, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cpbmc = substr($cpbmc, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("search_eval_cg_qytb_temp_help.txt"))
   {
      $Arq_WebHelp = file("search_eval_cg_qytb_temp_help.txt"); 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['zbggbh'])) ? $this->New_label['zbggbh'] : "" . $this->Ini->Nm_lang['lang_eval_cg_qytb_temp_fld_zbggbh'] . ""; ?> <span class="scFilterRequiredOdd">*</span></TD>
     <TD class="scFilterFieldOdd"> 
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_zbggbh" <?php echo $str_hide_zbggbh?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['zbggbh'])) ? $this->New_label['zbggbh'] : "" . $this->Ini->Nm_lang['lang_eval_cg_qytb_temp_fld_zbggbh'] . "";
...
<?php
  if (isset($this->Ini->sc_lig_md5["grid_cg_zbgg"]) && $this->Ini->sc_lig_md5["grid_cg_zbgg"] == "S") {
      $Parms_Lig  = "nmgp_parms_ret*scinF1,zbggbh_autocomp,id*scout";
      $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@search_eval_cg_qytb_temp@SC_par@" . md5($Parms_Lig);
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
  } else {
      $Md5_Lig  = "nmgp_parms_ret*scinF1,zbggbh_autocomp,id*scout";
  }
  $Cod_Btn = nmButtonOutput($this->arr_buttons, "bform_captura", "nm_submit_cap('" . $this->Ini->link_grid_cg_zbgg_cons_psq . "', '" . $Md5_Lig . "')", "nm_submit_cap('" . $this->Ini->link_grid_cg_zbgg_cons_psq . "', '" . $Md5_Lig . "')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
...
&nbsp;<?php echo $Cod_Btn ?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cpbmc'])) ? $this->New_label['cpbmc'] : "" . $this->Ini->Nm_lang['lang_eval_cpb_fld_mc'] . ""; ?> <span class="scFilterRequiredOdd">*</span></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cpbmc_cond" name="cpbmc_cond" onChange="nm_campos_between(document.getElementById('id_vis_cpbmc'), this, 'cpbmc')">
       <OPTION value="eq"><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cpbmc" <?php echo $str_hide_cpbmc?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cpbmc'])) ? $this->New_label['cpbmc'] : "" . $this->Ini->Nm_lang['lang_eval_cpb_fld_mc'] . "";
 $nmgp_tab_label .= "cpbmc?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>

<?php
      $cpbmc_look = substr($this->Db->qstr($cpbmc), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT      id,     mc FROM      eval_cpb ORDER BY ID DESC"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['psq_check_ret']['cpbmc'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['psq_check_ret']['cpbmc'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_cpbmc">
      <SELECT class="scFilterObjectEven" id="SC_cpbmc" name="cpbmc"  size="1">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $cpbmc)
            {
                    $cpbmc_sel = ($nm_opc_cod === $cpbmc) ? "selected" : "";
            }
            else
            {
               $cpbmc_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $cpbmc_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['orig_pesq'] == "grid")
   {
...
?>
 ...
 <form name="FCAP" action="" method="post" target="_blank"> 
   <input type="hidden" name="SC_lig_apl_orig" value="search_eval_cg_qytb_temp"/>
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_cpbmc'), document.F1.cpbmc_cond, 'cpbmc');
   document.F1.cpbmc.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "cgzb/search_eval_cg_qytb_temp";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("zh_cn");
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "search_eval_cg_qytb_temp/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_cpbmc_cond'] = 'cond';
      $tp_fields['SC_cpbmc'] = 'select';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $zbggbh_cond, $zbggbh, $zbggbh_autocomp,
             $cpbmc_cond, $cpbmc, $nmgp_tab_label;
      ...
      $cpbmc_cond_salva = $cpbmc_cond; 
      if (!isset($cpbmc_input_2) || $cpbmc_input_2 == "")
      {
          $cpbmc_input_2 = $cpbmc;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca'];
      }
      if ($zbggbh_cond != "in")
      {
      ...
      if ($zbggbh_cond != "nu" && $zbggbh_cond != "nn" && $zbggbh_cond != "ep" && $zbggbh_cond != "ne")
      {
          if ($zbggbh == "")
          {
              if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_eval_cg_qytb_temp_fld_zbggbh'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          }
      }
      if ($cpbmc_cond != "nu" && $cpbmc_cond != "nn" && $cpbmc_cond != "ep" && $cpbmc_cond != "ne")
      {
          if ($cpbmc == "")
          {
              if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_eval_cpb_fld_mc'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          }
      }
      $tmp_pos = strpos($cpbmc, "##@@");
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($cpbmc, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['psq_check_ret']['cpbmc'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_eval_cpb_fld_mc'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']['zbggbh'] = $zbggbh; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']['zbggbh_cond'] = $zbggbh_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']['cpbmc'] = $cpbmc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']['cpbmc_cond'] = $cpbmc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($zbggbh_cond != "in" && $zbggbh_cond != "bw" && !empty($zbggbh) && !is_numeric($zbggbh))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_eval_cg_qytb_temp_fld_zbggbh'] . "";
      }
      ...
      $_SESSION['scriptcase']['search_eval_cg_qytb_temp']['contr_erro'] = 'on';
if (!isset($_SESSION['v_cpbbh'])) {$_SESSION['v_cpbbh'] = "";}
if (!isset($this->sc_temp_v_cpbbh)) {$this->sc_temp_v_cpbbh = (isset($_SESSION['v_cpbbh'])) ? $_SESSION['v_cpbbh'] : "";}
 $this->sc_temp_v_cpbbh =$cpbmc ;
$strsql = "delete from eval_cg_qytb_temp where zbggbh='".$zbggbh ."'";
     ...
     $nm_select = $strsql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         $rf->Close();
      ;
$strsql = "insert into eval_cg_qytb_temp(tbbh,zbggbh,cgbbh,cgbmc,qylogin,lxr,qymc,bj,jsfile,swfile,qtfile,tjsj,isflag)
select id as tbbh,zbggbh,cgbbh,cgbmc,qylogin,lxr,qymc,bj,jsfile,swfile,qtfile,tjsj,'Y' as isflag from cg_qytb where zbggbh='".$zbggbh ."'";
     ...
     $nm_select = $strsql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         $rf->Close();
      ;
if (isset($this->sc_temp_v_cpbbh)) {$_SESSION['v_cpbbh'] = $this->sc_temp_v_cpbbh;}
$_SESSION['scriptcase']['search_eval_cg_qytb_temp']['contr_erro'] = 'off'; 
   ...
   { 
      ...
      $this->cmp_formatado['cpbmc'] = $Conteudo;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca_ant']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca'];
      }
      ...
      {
         $this->monta_condicao("zbggbh", $zbggbh_cond, $zbggbh, "", "zbggbh");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['search_eval_cg_qytb_temp']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['form_eval_cg_qytb_temp']['where_filtro'] = $this->comando_filtro;
      $this->retorna_pesq();
   }
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "cpbmc" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }

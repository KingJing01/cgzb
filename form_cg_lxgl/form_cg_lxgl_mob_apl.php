...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['ysly']))
          {
              $this->ysly = $this->NM_ajax_info['param']['ysly'];
          }
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_cg_lxgl_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_cg_lxgl_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("zh_cn");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['upload_field_info']['fa'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_cg_lxgl_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['upload_field_info']['bg'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_cg_lxgl_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl_mob']['upload_field_info']['ps'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_cg_lxgl_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cg_lxgl_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cg_lxgl_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_lxgl_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_lxgl_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_cg_lxgl_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_lxgl_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_cg_lxgl'] . "";
      ...
      $this->Db = $this->Ini->Db; 
      $this->nm_new_label['ysly'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysly'] . '';
      $this->nm_new_label['xmbh'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmbh'] . '';
      $this->nm_new_label['xmmc'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmmc'] . '';
      $this->nm_new_label['ysje'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysje'] . '';
      $this->nm_new_label['zjly'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_zjly'] . '';
      $this->nm_new_label['xmfzr'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmfzr'] . '';
      $this->nm_new_label['sbrq'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbrq'] . '';
      $this->nm_new_label['sbbm'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbbm'] . '';
      $this->nm_new_label['sbr'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbr'] . '';
      $this->nm_new_label['qwcgrq'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_qwcgrq'] . '';
      $this->nm_new_label['lxr'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_lxr'] . '';
      $this->nm_new_label['lxdh'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_lxdh'] . '';
      $this->nm_new_label['email'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_email'] . '';
      $this->nm_new_label['bz'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_bz'] . '';
      $this->nm_new_label['fa'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_fa'] . '';
      $this->nm_new_label['bg'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_bg'] . '';
      $this->nm_new_label['ps'] = '' . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ps'] . '';
      ...
      $_SESSION['scriptcase']['error_icon']['form_cg_lxgl_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_cg_lxgl_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->fa_ul_name]))
          {
              $this->NM_ajax_info['param']['fa_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->fa_ul_name];
          }
      ...
      elseif (isset($this->fa_ul_name) && '' != $this->fa_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->fa_ul_name]))
          {
              $this->fa_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->fa_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->bg_ul_name]))
          {
              $this->NM_ajax_info['param']['bg_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->bg_ul_name];
          }
      ...
      elseif (isset($this->bg_ul_name) && '' != $this->bg_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->bg_ul_name]))
          {
              $this->bg_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->bg_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->ps_ul_name]))
          {
              $this->NM_ajax_info['param']['ps_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->ps_ul_name];
          }
      ...
      elseif (isset($this->ps_ul_name) && '' != $this->ps_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->ps_ul_name]))
          {
              $this->ps_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_field_ul_name'][$this->ps_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_cg_lxgl_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_cg_lxgl/form_cg_lxgl_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_cg_lxgl_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_cg_lxgl_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_cg_lxgl_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_cg_lxgl/form_cg_lxgl_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_cg_lxgl_mob_erro.class.php"); 
      }
      $this->Erro      = new form_cg_lxgl_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      if (isset($this->ysly)) { $this->nm_limpa_alfa($this->ysly); }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          if ('validate_ysly' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'ysly');
          }
          ...
          form_cg_lxgl_mob_pack_ajax_response();
          exit;
      }
      if (isset($this->sc_inline_call) && 'Y' == $this->sc_inline_call)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_cg_lxgl_mob']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_cg_lxgl_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_cg_lxgl_mob', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
...
//--------------------------------------------------------------------------------------
   ...
   function Recupera_Nome_Campo($campo) 
   {
       ...
       {
           case 'ysly':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysly'] . "";
               break;
           case 'xmbh':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmbh'] . "";
               break;
           case 'xmmc':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmmc'] . "";
               break;
           case 'ysje':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysje'] . "";
               break;
           case 'zjly':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_zjly'] . "";
               break;
           case 'xmfzr':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmfzr'] . "";
               break;
           case 'sbbm':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbbm'] . "";
               break;
           case 'sbrq':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbrq'] . "";
               break;
           case 'sbr':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbr'] . "";
               break;
           case 'qwcgrq':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_qwcgrq'] . "";
               break;
           case 'lxr':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_lxr'] . "";
               break;
           case 'lxdh':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_lxdh'] . "";
               break;
           case 'email':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_email'] . "";
               break;
           case 'bz':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_bz'] . "";
               break;
           case 'fa':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_fa'] . "";
               break;
           case 'bg':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_bg'] . "";
               break;
           case 'ps':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ps'] . "";
               break;
           case 'id':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_id'] . "";
               break;
           case 'cjsj':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_cjsj'] . "";
               break;
           case 'shzt':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_shzt'] . "";
               break;
           case 'ifjs':
               return "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ifjs'] . "";
               break;
       }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_cg_lxgl_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_cg_lxgl_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_cg_lxgl_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_cg_lxgl_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ('' == $filtro || 'ysly' == $filtro)
        $this->ValidateField_ysly($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
    ...
    function ValidateField_ysly(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->ysly == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['ysly']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['ysly'] == "on"))
      {
          $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysly'] . "" ; 
          if (!isset($Campos_Erros['ysly']))
          {
              $Campos_Erros['ysly'] = array();
          }
          $Campos_Erros['ysly'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          if (!isset($this->NM_ajax_info['errList']['ysly']) || !is_array($this->NM_ajax_info['errList']['ysly']))
          {
              $this->NM_ajax_info['errList']['ysly'] = array();
          }
          $this->NM_ajax_info['errList']['ysly'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->ysly) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_ysly']) && !in_array($this->ysly, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_ysly']))
          {
              ...
              $Campos_Erros['ysly'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($this->NM_ajax_info['errList']['ysly']) || !is_array($this->NM_ajax_info['errList']['ysly']))
              {
                  $this->NM_ajax_info['errList']['ysly'] = array();
              }
              $this->NM_ajax_info['errList']['ysly'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
          }
    } // ValidateField_ysly
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['xmbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['xmbh'] == "on")) 
      { 
          if ($this->xmbh == "")  
          { 
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmbh'] . "" ; 
      ...
      { 
          ...
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmbh'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['xmbh']))
              {
                  $Campos_Erros['xmbh'] = array();
              }
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['xmmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['xmmc'] == "on")) 
      { 
          if ($this->xmmc == "")  
          { 
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmmc'] . "" ; 
      ...
      { 
          ...
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmmc'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 64 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['xmmc']))
              {
                  $Campos_Erros['xmmc'] = array();
              }
    ...
    function ValidateField_ysje(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysje'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->ysje, 4, 2, -0, 999999, "N") == false)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysje'] . "; " ; 
                  if (!isset($Campos_Erros['ysje']))
                  {
                      $Campos_Erros['ysje'] = array();
                  }
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['ysje']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['ysje'] == "on") 
           { 
              $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ysje'] . "" ; 
              if (!isset($Campos_Erros['ysje']))
              {
                  $Campos_Erros['ysje'] = array();
              }
    ...
    {
        global $teste_validade;
      if ($this->zjly == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['zjly']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['zjly'] == "on"))
      {
          $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_zjly'] . "" ; 
          ...
          if (!empty($this->zjly) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_zjly']) && !in_array($this->zjly, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_zjly']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['zjly']))
              {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['xmfzr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['xmfzr'] == "on")) 
      { 
          if ($this->xmfzr == "")  
          { 
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmfzr'] . "" ; 
      ...
      { 
          ...
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmfzr'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['xmfzr']))
              {
                  $Campos_Erros['xmfzr'] = array();
              }
    ...
    {
        global $teste_validade;
      if ($this->sbbm == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['sbbm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['sbbm'] == "on"))
      {
          $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbbm'] . "" ; 
          ...
          if (!empty($this->sbbm) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_sbbm']) && !in_array($this->sbbm, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_sbbm']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['sbbm']))
              {
    ...
    function ValidateField_sbrq(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbrq'] . "; " ; 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_sbrq' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['sbrq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['sbrq'] == "on")) 
           { 
              $Campos_Falta[] = "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbrq'] . "" ; 
              if (!isset($Campos_Erros['sbrq']))
              {
                  $Campos_Erros['sbrq'] = array();
              }
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['sbr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['php_cmp_required']['sbr'] == "on")) 
      { 
          if ($this->sbr == "")  
          { 
              $Campos_Falta[] =  "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbr'] . "" ; 
      ...
      { 
          ...
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_sbr'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['sbr']))
              {
                  $Campos_Erros['sbr'] = array();
              }
    ...
    function ValidateField_qwcgrq(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_qwcgrq'] . "; " ; 
    ...
    function ValidateField_lxr(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_lxr'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_lxdh(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_lxdh'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                      $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_email'] . "; " ; 
    ...
    function ValidateField_bz(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_bz'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 128 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_fa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            {
                include_once 'form_cg_lxgl_mob_doc_name.php';
            }
            ...
            {
                $Campos_Crit .= "{lang_cg_lxgl_fld_fa}: " . $this->Ini->Nm_lang['lang_errm_file_invl']; 
    ...
    function ValidateField_bg(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            {
                $Campos_Crit .= "{lang_cg_lxgl_fld_bg}: " . $this->Ini->Nm_lang['lang_errm_file_invl']; 
    ...
    function ValidateField_ps(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            {
                $Campos_Crit .= "{lang_cg_lxgl_fld_ps}: " . $this->Ini->Nm_lang['lang_errm_file_invl']; 
...
//--------------------------------------------------------------------------------------
          ...
          { 
              ...
              { 
                 ...
                 { 
                  ...
                  { 
                      $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_fa'] . ": " . $this->Ini->Nm_lang['lang_errm_nfdr']; 
                      if (!isset($Campos_Erros['fa']))
                      {
                          $Campos_Erros['fa'] = array();
                      }
              ...
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_fa'] . " " . $this->Ini->Nm_lang['lang_errm_upld']; 
                  $this->fa = "";
                  if (!isset($Campos_Erros['fa']))
                  {
                      $Campos_Erros['fa'] = array();
          ...
          { 
              ...
              { 
                 ...
                 { 
                  ...
                  { 
                      $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_bg'] . ": " . $this->Ini->Nm_lang['lang_errm_nfdr']; 
                      if (!isset($Campos_Erros['bg']))
                      {
                          $Campos_Erros['bg'] = array();
                      }
              ...
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_bg'] . " " . $this->Ini->Nm_lang['lang_errm_upld']; 
                  $this->bg = "";
                  if (!isset($Campos_Erros['bg']))
                  {
                      $Campos_Erros['bg'] = array();
          ...
          { 
              ...
              { 
                 ...
                 { 
                  ...
                  { 
                      $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ps'] . ": " . $this->Ini->Nm_lang['lang_errm_nfdr']; 
                      if (!isset($Campos_Erros['ps']))
                      {
                          $Campos_Erros['ps'] = array();
                      }
              ...
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_cg_lxgl_fld_ps'] . " " . $this->Ini->Nm_lang['lang_errm_upld']; 
                  $this->ps = "";
                  if (!isset($Campos_Erros['ps']))
                  {
                      $Campos_Erros['ps'] = array();
   ...
   function nm_guardar_campos()
   {
    global
           $sc_seq_vert;
    $this->nmgp_dados_form['ysly'] = $this->ysly;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_cg_lxgl_mob_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values

          //----- ysly
   function ajax_return_values_ysly($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("ysly", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->ysly);
              $aLookup = array();
              $this->_tmp_lookup_ysly = $this->ysly;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_ysly']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_ysly'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_ysly']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_ysly'] = array(); 
}
$aLookup[] = array(form_cg_lxgl_mob_pack_protect_string('') => form_cg_lxgl_mob_pack_protect_string('请选择'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_ysly'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY mc";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_cg_lxgl_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_cg_lxgl_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_ysly'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"ysly\"";
          if (isset($this->NM_ajax_info['select_html']['ysly']) && !empty($this->NM_ajax_info['select_html']['ysly']))
          {
              $sSelComp = $this->NM_ajax_info['select_html']['ysly'];
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['ysly'] = array(
                       'row'    => '',
               'type'    => 'select',
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['ysly']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['ysly']['valList'][$i] = form_cg_lxgl_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['ysly']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['ysly']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['ysly']['labList'] = $aLabel;
          }
   }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_zjly']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_zjly'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_zjly']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_zjly'] = array(); 
}
$aLookup[] = array(form_cg_lxgl_mob_pack_protect_string('') => form_cg_lxgl_mob_pack_protect_string('请选择'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_zjly'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY mc";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_zjly'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['zjly']['valList'][$i] = form_cg_lxgl_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_sbbm']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_sbbm'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_sbbm']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_sbbm'] = array(); 
}
$aLookup[] = array(form_cg_lxgl_mob_pack_protect_string('') => form_cg_lxgl_mob_pack_protect_string('请选择'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_sbbm'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY mc";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['Lookup_sbbm'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sbbm']['valList'][$i] = form_cg_lxgl_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_fa($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fa", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['download_filenames']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['download_filenames'] = array();
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['download_filenames'][$sTmpFile] = $this->fa;
          ...
          $this->NM_ajax_info['fldList']['fa'] = array(
               ...
               'type'    => 'documento',
               'valList' => array($sTmpValue),
               'docLink' => "<a href=\"javascript:nm_mostra_doc('0', '" . $sTmpFile . "', 'form_cg_lxgl')\">" . $tmp_file_fa . "</a>",
               'docIcon' => $tmp_icon_fa,
              );
              if ('navigate_form' == $this->NM_ajax_opcao)
              {
   ...
   function ajax_return_values_bg($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("bg", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['download_filenames'][$sTmpFile] = $this->bg;
          ...
          $this->NM_ajax_info['fldList']['bg'] = array(
               ...
               'type'    => 'documento',
               'valList' => array($sTmpValue),
               'docLink' => "<a href=\"javascript:nm_mostra_doc('1', '" . $sTmpFile . "', 'form_cg_lxgl')\">" . $tmp_file_bg . "</a>",
               'docIcon' => $tmp_icon_bg,
              );
              if ('navigate_form' == $this->NM_ajax_opcao)
              {
   ...
   function ajax_return_values_ps($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("ps", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['download_filenames'][$sTmpFile] = $this->ps;
          ...
          $this->NM_ajax_info['fldList']['ps'] = array(
               ...
               'type'    => 'documento',
               'valList' => array($sTmpValue),
               'docLink' => "<a href=\"javascript:nm_mostra_doc('2', '" . $sTmpFile . "', 'form_cg_lxgl')\">" . $tmp_file_ps . "</a>",
               'docIcon' => $tmp_icon_ps,
              );
              if ('navigate_form' == $this->NM_ajax_opcao)
              {
   ...
   function ajax_return_values_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['scriptcase']['form_cg_lxgl_mob']['contr_erro'] = 'on';
 if(empty($this->shzt )){
  $this->shzt ='未提交';
}
$_SESSION['scriptcase']['form_cg_lxgl_mob']['contr_erro'] = 'off'; 
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['decimal_db'] == ",") 
      {
          $this->nm_troca_decimal(".", ",");
      }
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          $this->ysly_before_qstr = $this->ysly;
          $this->ysly = substr($this->Db->qstr($this->ysly), 1, -1); 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $aUpdateOk = array();
              ...
              if (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_ukey'] . " " . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmbh'] . ""); 
                  $this->nmgp_opcao = "nada"; 
                  $aUpdateOk[] = 'xmbh';
              }
              $rsUni->Close();
              ...
              if (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_ukey'] . " " . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmmc'] . ""); 
                  $this->nmgp_opcao = "nada"; 
                  $aUpdateOk[] = 'xmmc';
              }
              $rsUni->Close();
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET ysly = '$this->ysly', xmbh = '$this->xmbh', xmmc = '$this->xmmc', ysje = $this->ysje, zjly = '$this->zjly', xmfzr = '$this->xmfzr', sbrq = " . $this->Ini->date_delim . $this->sbrq . $this->Ini->date_delim1 . ", sbbm = '$this->sbbm', sbr = '$this->sbr', qwcgrq = " . $this->Ini->date_delim . $this->qwcgrq . $this->Ini->date_delim1 . ", lxr = '$this->lxr', lxdh = '$this->lxdh', email = '$this->email', bz = '$this->bz'";  
              } 
              else 
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ysly = '$this->ysly', xmbh = '$this->xmbh', xmmc = '$this->xmmc', ysje = $this->ysje, zjly = '$this->zjly', xmfzr = '$this->xmfzr', sbrq = " . $this->Ini->date_delim . $this->sbrq . $this->Ini->date_delim1 . ", sbbm = '$this->sbbm', sbr = '$this->sbr', qwcgrq = " . $this->Ini->date_delim . $this->qwcgrq . $this->Ini->date_delim1 . ", lxr = '$this->lxr', lxdh = '$this->lxdh', email = '$this->email', bz = '$this->bz'";  
              } 
          ...
          $this->ysly = $this->ysly_before_qstr;
          ...
          $this->ifjs = $this->ifjs_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['db_changed'] = true;


              if     (isset($NM_val_form) && isset($NM_val_form['id'])) { $this->id = $NM_val_form['id']; }
              elseif (isset($this->id)) { $this->nm_limpa_alfa($this->id); }
              if     (isset($NM_val_form) && isset($NM_val_form['ysly'])) { $this->ysly = $NM_val_form['ysly']; }
              elseif (isset($this->ysly)) { $this->nm_limpa_alfa($this->ysly); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('ysly', 'xmbh', 'xmmc', 'ysje', 'zjly', 'xmfzr', 'sbbm', 'sbrq', 'sbr', 'qwcgrq', 'lxr', 'lxdh', 'email', 'bz', 'fa', 'bg', 'ps'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          $aInsertOk = array(); 
              ...
              if (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_inst_uniq'] . " " . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmbh'] . ""); 
                  $this->nmgp_opcao = "nada"; 
                  $GLOBALS["erro_incl"] = 1; 
                  $aInsertOk[] = 'xmbh';
              }
              ...
              if (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_inst_uniq'] . " " . $this->Ini->Nm_lang['lang_cg_lxgl_fld_xmmc'] . ""); 
                  $this->nmgp_opcao = "nada"; 
                  $GLOBALS["erro_incl"] = 1; 
                  $aInsertOk[] = 'xmmc';
              }
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "ysly, xmbh, xmmc, ysje, zjly, xmfzr, sbrq, sbbm, sbr, qwcgrq, lxr, lxdh, email, bz, fa, bg, ps, cjsj, shzt, ifjs) VALUES (" . $NM_seq_auto . "'$this->ysly', '$this->xmbh', '$this->xmmc', $this->ysje, '$this->zjly', '$this->xmfzr', " . $this->Ini->date_delim . $this->sbrq . $this->Ini->date_delim1 . ", '$this->sbbm', '$this->sbr', " . $this->Ini->date_delim . $this->qwcgrq . $this->Ini->date_delim1 . ", '$this->lxr', '$this->lxdh', '$this->email', '$this->bz', '$this->fa', '$this->bg', '$this->ps', " . $this->Ini->date_delim . $this->cjsj . $this->Ini->date_delim1 . ", '$this->shzt', '$this->ifjs')"; 
              }
              else
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "ysly, xmbh, xmmc, ysje, zjly, xmfzr, sbrq, sbbm, sbr, qwcgrq, lxr, lxdh, email, bz, fa, bg, ps, cjsj, shzt, ifjs) VALUES (" . $NM_seq_auto . "'$this->ysly', '$this->xmbh', '$this->xmmc', $this->ysje, '$this->zjly', '$this->xmfzr', " . $this->Ini->date_delim . $this->sbrq . $this->Ini->date_delim1 . ", '$this->sbbm', '$this->sbr', " . $this->Ini->date_delim . $this->qwcgrq . $this->Ini->date_delim1 . ", '$this->lxr', '$this->lxdh', '$this->email', '$this->bz', '$this->fa', '$this->bg', '$this->ps', " . $this->Ini->date_delim . $this->cjsj . $this->Ini->date_delim1 . ", '$this->shzt', '$this->ifjs')"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['parms'] = "id?#?$this->id?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['parms'] = ""; 
          $nmgp_select = "SELECT id, ysly, xmbh, xmmc, ysje, zjly, xmfzr, sbrq, sbbm, sbr, qwcgrq, lxr, lxdh, email, bz, fa, bg, ps, cjsj, shzt, ifjs from " . $this->Ini->nm_tabela ; 
          $aWhere = array();
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['reg_start']) ; 
          } 
          else  
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              $this->shzt = $rs->fields[19] ; 
              $this->nmgp_dados_select['shzt'] = $this->shzt;
              $this->ifjs = $rs->fields[20] ; 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['parms'] = "id?#?$this->id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sub_dir'][0]  = "cglx";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sub_dir'][1]  = "cglx";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sub_dir'][2]  = "cglx";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['reg_start'] < $qt_geral_reg_form_cg_lxgl_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['dados_select'];
                  $this->ysly = $this->nmgp_dados_select['ysly'];  
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['dados_select'];
           $this->SC_log_arr['fields']['ysly']['0'] =  $nmgp_dados_select['ysly'];
...
// 
   ...
   {
       $this->SC_log_arr['fields']['ysly']['1'] =  $this->ysly;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['download_filenames'][$sTmpFile_fa] = $this->fa;
   } 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['download_filenames'][$sTmpFile_bg] = $this->bg;
   } 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['download_filenames'][$sTmpFile_ps] = $this->ps;
   } 
    include_once("form_cg_lxgl_mob_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['empty_filter']);
      ...
      if ($field == "SC_all_Cmp") 
      {
          $data_lookup = $this->SC_lookup_ysly($arg_search, $data_search);
          if (is_array($data_lookup) && !empty($data_lookup)) 
          {
              $this->SC_monta_condicao($comando, "ysly", $arg_search, $data_lookup);
          }
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_cg_lxgl_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['total'] = $qt_geral_reg_form_cg_lxgl_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_cg_lxgl_mob_pack_ajax_response();
      ...
      $Nm_datas['sbrq'] = "date";$Nm_datas['qwcgrq'] = "date";$Nm_datas['cjsj'] = "datetime";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_ysly($condicao, $campo)
   {
       $result = array();
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       $nm_comando = "SELECT mc, mc FROM dm_ysly WHERE (mc LIKE '%$campo%')" ; 
       if ($condicao == "ii")
       {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_cg_lxgl_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_cg_lxgl_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl_mob']['masterValue'] as $cmp_master => $val_master)
{
?>

...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_cg_lxgl'] . ""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_cg_lxgl'] . ""); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_cg_lxgl/form_cg_lxgl_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_cg_lxgl_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cg_lxgl_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['recarga'];
}
?>
...
<?php
 include_once("form_cg_lxgl_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cg_lxgl'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cg_lxgl'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_cg_lxgl'] . ""; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_cg_lxgl'] . ""; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bincluir", "nm_atualiza ('incluir');", "nm_atualiza ('incluir');", "sc_b_ins_t", "", "提交审核", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
   if (!isset($this->nm_new_label['ysly']))
   {
   ...
   $ysly = $this->ysly;
   $sStyleHidden_ysly = '';
   if (isset($this->nmgp_cmp_hidden['ysly']) && $this->nmgp_cmp_hidden['ysly'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['ysly']);
       $sStyleHidden_ysly = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_ysly = 'display: none;';
   $sStyleReadInp_ysly = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['ysly']) && $this->nmgp_cmp_readonly['ysly'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['ysly']);
       $sStyleReadLab_ysly = '';
       $sStyleReadInp_ysly = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['ysly']) && $this->nmgp_cmp_hidden['ysly'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="ysly" value="<?php echo $this->form_encode_input($this->ysly) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_ysly_label" id="hidden_field_label_ysly" style="<?php echo $sStyleHidden_ysly; ?>"><span id="id_label_ysly"><?php echo $this->nm_new_label['ysly']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['ysly']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['ysly'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ysly_line" id="hidden_field_data_ysly" style="<?php echo $sStyleHidden_ysly; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ysly_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ysly"]) &&  $this->nmgp_cmp_readonly["ysly"] == "on") { 
...
ORDER BY mc";
   ...
   while (!empty($todo[$x])) 
   {
          ...
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->ysly_1))
          {
              foreach ($this->ysly_1 as $tmp_ysly)
              {
                  if (trim($tmp_ysly) === trim($cadaselect[1])) { $ysly_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->ysly) === trim($cadaselect[1])) { $ysly_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="ysly" value="<?php echo $this->form_encode_input($ysly) . "\">" . $ysly_look . ""; ?>
<?php } else { ?>
...
ORDER BY mc";
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_ysly\" class=\"css_ysly_line\" style=\"" .  $sStyleReadLab_ysly . "\">" . $this->form_encode_input($ysly_look) . "</span><span id=\"id_read_off_ysly\" style=\"" . $sStyleReadInp_ysly . "\">";
   echo " <span id=\"idAjaxSelect_ysly\"><select class=\"sc-js-input scFormObjectOdd css_ysly_obj\" style=\"\" id=\"id_sc_field_ysly\" name=\"ysly\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   ...
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          ...
          if (trim($this->ysly) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_ysly_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_ysly_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xmbh_label" id="hidden_field_label_xmbh" style="<?php echo $sStyleHidden_xmbh; ?>"><span id="id_label_xmbh"><?php echo $this->nm_new_label['xmbh']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmbh'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_xmbh_line" id="hidden_field_data_xmbh" style="<?php echo $sStyleHidden_xmbh; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_xmbh_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xmmc_label" id="hidden_field_label_xmmc" style="<?php echo $sStyleHidden_xmmc; ?>"><span id="id_label_xmmc"><?php echo $this->nm_new_label['xmmc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmmc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_xmmc_line" id="hidden_field_data_xmmc" style="<?php echo $sStyleHidden_xmmc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_xmmc_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ysje_label" id="hidden_field_label_ysje" style="<?php echo $sStyleHidden_ysje; ?>"><span id="id_label_ysje"><?php echo $this->nm_new_label['ysje']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['ysje']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['ysje'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ysje_line" id="hidden_field_data_ysje" style="<?php echo $sStyleHidden_ysje; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ysje_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zjly_label" id="hidden_field_label_zjly" style="<?php echo $sStyleHidden_zjly; ?>"><span id="id_label_zjly"><?php echo $this->nm_new_label['zjly']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['zjly']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['zjly'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_zjly_line" id="hidden_field_data_zjly" style="<?php echo $sStyleHidden_zjly; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zjly_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_xmfzr_label" id="hidden_field_label_xmfzr" style="<?php echo $sStyleHidden_xmfzr; ?>"><span id="id_label_xmfzr"><?php echo $this->nm_new_label['xmfzr']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmfzr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmfzr'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_xmfzr_line" id="hidden_field_data_xmfzr" style="<?php echo $sStyleHidden_xmfzr; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_xmfzr_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sbbm_label" id="hidden_field_label_sbbm" style="<?php echo $sStyleHidden_sbbm; ?>"><span id="id_label_sbbm"><?php echo $this->nm_new_label['sbbm']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbbm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbbm'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_sbbm_line" id="hidden_field_data_sbbm" style="<?php echo $sStyleHidden_sbbm; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sbbm_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sbrq_label" id="hidden_field_label_sbrq" style="<?php echo $sStyleHidden_sbrq; ?>"><span id="id_label_sbrq"><?php echo $this->nm_new_label['sbrq']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbrq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbrq'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_sbrq_line" id="hidden_field_data_sbrq" style="<?php echo $sStyleHidden_sbrq; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sbrq_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sbr_label" id="hidden_field_label_sbr" style="<?php echo $sStyleHidden_sbr; ?>"><span id="id_label_sbr"><?php echo $this->nm_new_label['sbr']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbr'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_sbr_line" id="hidden_field_data_sbr" style="<?php echo $sStyleHidden_sbr; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sbr_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_qwcgrq_label" id="hidden_field_label_qwcgrq" style="<?php echo $sStyleHidden_qwcgrq; ?>"><span id="id_label_qwcgrq"><?php echo $this->nm_new_label['qwcgrq']; ?></span></TD>
    <TD class="scFormDataOdd css_qwcgrq_line" id="hidden_field_data_qwcgrq" style="<?php echo $sStyleHidden_qwcgrq; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_qwcgrq_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lxdh_label" id="hidden_field_label_lxdh" style="<?php echo $sStyleHidden_lxdh; ?>"><span id="id_label_lxdh"><?php echo $this->nm_new_label['lxdh']; ?></span></TD>
    <TD class="scFormDataOdd css_lxdh_line" id="hidden_field_data_lxdh" style="<?php echo $sStyleHidden_lxdh; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lxdh_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fa_label" id="hidden_field_label_fa" style="<?php echo $sStyleHidden_fa; ?>"><span id="id_label_fa"><?php echo $this->nm_new_label['fa']; ?></span></TD>
    <TD class="scFormDataOdd css_fa_line" id="hidden_field_data_fa" style="<?php echo $sStyleHidden_fa; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fa_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["fa"]) &&  $this->nmgp_cmp_readonly["fa"] == "on") { 

 ?>
<input type="hidden" name="fa" value="<?php echo $this->form_encode_input($fa) . "\"><img id=\"fa_img_uploading\" style=\"display: none\" border=\"0\" src=\"" . $this->Ini->path_icones . "/scriptcase__NM__ajax_load.gif\" align=\"absmiddle\" /><span id=\"id_ajax_doc_fa\"><a href=\"javascript:nm_mostra_doc('0', '" . str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_fa, 3)) . "', 'form_cg_lxgl')\">" . $fa . "</a></span>"; ?>
<?php } else { ?>
<span id="id_read_on_fa" class="scFormLinkOdd sc-ui-readonly-fa css_fa_line" style="<?php echo $sStyleReadLab_fa; ?>"><a href="javascript:nm_mostra_doc('0', '<?php echo str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_fa, 3)); ?>', 'form_cg_lxgl')"><?php echo $this->form_encode_input($this->fa); ?></a></span><span id="id_read_off_fa" style="white-space: nowrap;<?php echo $sStyleReadInp_fa; ?>"><span style="display:inline-block"><span id="sc-id-upload-select-fa" class="fileinput-button fileinput-button-padding scButton_default">
...
<span id="chk_ajax_img_fa"<?php if ($this->nmgp_opcao == "novo" || empty($fa)) { echo " style=\"display: none\""; } ?>> <input type=checkbox name="fa_limpa" value="<?php echo $fa_limpa . '" '; if ($fa_limpa == "S"){echo "checked ";} ?> onclick="this.value = ''; if (this.checked){ this.value = 'S'};"><?php echo $this->Ini->Nm_lang['lang_btns_dele_hint']; ?> &nbsp;</span><img id="fa_img_uploading" style="display: none" border="0" src="<?php echo $this->Ini->path_icones; ?>/scriptcase__NM__ajax_load.gif" align="absmiddle" /><span id="id_ajax_doc_fa"><a href="javascript:nm_mostra_doc('0', '<?php echo str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_fa, 3)); ?>', 'form_cg_lxgl')"><?php echo $fa ?></a></span><div id="id_sc_dragdrop_fa" class="scFormDataDragNDrop"><?php echo $this->Ini->Nm_lang['lang_errm_mu_dragfile'] ?></div>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bg_label" id="hidden_field_label_bg" style="<?php echo $sStyleHidden_bg; ?>"><span id="id_label_bg"><?php echo $this->nm_new_label['bg']; ?></span></TD>
    <TD class="scFormDataOdd css_bg_line" id="hidden_field_data_bg" style="<?php echo $sStyleHidden_bg; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bg_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["bg"]) &&  $this->nmgp_cmp_readonly["bg"] == "on") { 

 ?>
<input type="hidden" name="bg" value="<?php echo $this->form_encode_input($bg) . "\"><img id=\"bg_img_uploading\" style=\"display: none\" border=\"0\" src=\"" . $this->Ini->path_icones . "/scriptcase__NM__ajax_load.gif\" align=\"absmiddle\" /><span id=\"id_ajax_doc_bg\"><a href=\"javascript:nm_mostra_doc('1', '" . str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_bg, 3)) . "', 'form_cg_lxgl')\">" . $bg . "</a></span>"; ?>
<?php } else { ?>
<span id="id_read_on_bg" class="scFormLinkOdd sc-ui-readonly-bg css_bg_line" style="<?php echo $sStyleReadLab_bg; ?>"><a href="javascript:nm_mostra_doc('1', '<?php echo str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_bg, 3)); ?>', 'form_cg_lxgl')"><?php echo $this->form_encode_input($this->bg); ?></a></span><span id="id_read_off_bg" style="white-space: nowrap;<?php echo $sStyleReadInp_bg; ?>"><span style="display:inline-block"><span id="sc-id-upload-select-bg" class="fileinput-button fileinput-button-padding scButton_default">
 <span><?php echo $this->Ini->Nm_lang['lang_select_file'] ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ps_label" id="hidden_field_label_ps" style="<?php echo $sStyleHidden_ps; ?>"><span id="id_label_ps"><?php echo $this->nm_new_label['ps']; ?></span></TD>
    <TD class="scFormDataOdd css_ps_line" id="hidden_field_data_ps" style="<?php echo $sStyleHidden_ps; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ps_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ps"]) &&  $this->nmgp_cmp_readonly["ps"] == "on") { 

 ?>
<input type="hidden" name="ps" value="<?php echo $this->form_encode_input($ps) . "\"><img id=\"ps_img_uploading\" style=\"display: none\" border=\"0\" src=\"" . $this->Ini->path_icones . "/scriptcase__NM__ajax_load.gif\" align=\"absmiddle\" /><span id=\"id_ajax_doc_ps\"><a href=\"javascript:nm_mostra_doc('2', '" . str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_ps, 3)) . "', 'form_cg_lxgl')\">" . $ps . "</a></span>"; ?>
<?php } else { ?>
<span id="id_read_on_ps" class="scFormLinkOdd sc-ui-readonly-ps css_ps_line" style="<?php echo $sStyleReadLab_ps; ?>"><a href="javascript:nm_mostra_doc('2', '<?php echo str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_ps, 3)); ?>', 'form_cg_lxgl')"><?php echo $this->form_encode_input($this->ps); ?></a></span><span id="id_read_off_ps" style="white-space: nowrap;<?php echo $sStyleReadInp_ps; ?>"><span style="display:inline-block"><span id="sc-id-upload-select-ps" class="fileinput-button fileinput-button-padding scButton_default">
 <span><?php echo $this->Ini->Nm_lang['lang_select_file'] ?></span>
...
<span id="chk_ajax_img_ps"<?php if ($this->nmgp_opcao == "novo" || empty($ps)) { echo " style=\"display: none\""; } ?>> <input type=checkbox name="ps_limpa" value="<?php echo $ps_limpa . '" '; if ($ps_limpa == "S"){echo "checked ";} ?> onclick="this.value = ''; if (this.checked){ this.value = 'S'};"><?php echo $this->Ini->Nm_lang['lang_btns_dele_hint']; ?> &nbsp;</span><img id="ps_img_uploading" style="display: none" border="0" src="<?php echo $this->Ini->path_icones; ?>/scriptcase__NM__ajax_load.gif" align="absmiddle" /><span id="id_ajax_doc_ps"><a href="javascript:nm_mostra_doc('2', '<?php echo str_replace(array("'", '%'), array("\'", '**Perc**'), substr($sTmpFile_ps, 3)); ?>', 'form_cg_lxgl')"><?php echo $ps ?></a></span><div id="id_sc_dragdrop_ps" class="scFormDataDragNDrop"><?php echo $this->Ini->Nm_lang['lang_errm_mu_dragfile'] ?></div>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_cg_lxgl");
 parent.scAjaxDetailHeight("form_cg_lxgl", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}

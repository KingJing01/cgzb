...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_cg_lxgl($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_cg_lxgl_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("zh_cn");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("zh_cn");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['upload_field_info']['fa'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_cg_lxgl',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['upload_field_info']['bg'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_cg_lxgl',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_cg_lxgl']['upload_field_info']['ps'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_cg_lxgl',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cg_lxgl']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_cg_lxgl'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_lxgl']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_lxgl']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_cg_lxgl') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cg_lxgl']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_cg_lxgl'] . "";
      ...
      $_SESSION['scriptcase']['error_icon']['form_cg_lxgl']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['table_refresh'] = false;
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->fa_ul_name]))
          {
              $this->NM_ajax_info['param']['fa_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->fa_ul_name];
          }
      ...
      elseif (isset($this->fa_ul_name) && '' != $this->fa_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->fa_ul_name]))
          {
              $this->fa_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->fa_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->bg_ul_name]))
          {
              $this->NM_ajax_info['param']['bg_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->bg_ul_name];
          }
      ...
      elseif (isset($this->bg_ul_name) && '' != $this->bg_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->bg_ul_name]))
          {
              $this->bg_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->bg_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->ps_ul_name]))
          {
              $this->NM_ajax_info['param']['ps_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->ps_ul_name];
          }
      ...
      elseif (isset($this->ps_ul_name) && '' != $this->ps_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->ps_ul_name]))
          {
              $this->ps_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_field_ul_name'][$this->ps_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_cg_lxgl']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_cg_lxgl", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_cg_lxgl/form_cg_lxgl_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_cg_lxgl_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_cg_lxgl_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_cg_lxgl_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_cg_lxgl/form_cg_lxgl_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_cg_lxgl_erro.class.php"); 
      }
      $this->Erro      = new form_cg_lxgl_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_cg_lxgl']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Gera_log_access'] = false;
      }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          form_cg_lxgl_pack_ajax_response();
          exit;
      }
      if (isset($this->sc_inline_call) && 'Y' == $this->sc_inline_call)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $_SESSION['scriptcase']['form_cg_lxgl']['contr_erro'] = 'off';
          if ($Campos_Crit != "") 
          {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_redir_atualiz'] == "ok")
          {
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       $delim  = "'";
       $delim1 = "'";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['SC_sep_date1'];
       }
       $dt  = $delim . date('Y-m-d H:i:s') . $delim1;
       $usr = isset($_SESSION['usr_login']) ? $_SESSION['usr_login'] : "";
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_cg_lxgl', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_cg_lxgl', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_cg_lxgl']) || !is_array($this->NM_ajax_info['errList']['geral_form_cg_lxgl']))
              {
                  $this->NM_ajax_info['errList']['geral_form_cg_lxgl'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_cg_lxgl'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_ysly(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->ysly == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['ysly']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['ysly'] == "on"))
      {
          ...
          if (!empty($this->ysly) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_ysly']) && !in_array($this->ysly, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_ysly']))
          {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmbh']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmbh'] == "on")) 
      { 
          if ($this->xmbh == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmmc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmmc'] == "on")) 
      { 
          if ($this->xmmc == "")  
          { 
    ...
    function ValidateField_ysje(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['ysje']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['ysje'] == "on") 
           { 
    ...
    {
        global $teste_validade;
      if ($this->zjly == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['zjly']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['zjly'] == "on"))
      {
          ...
          if (!empty($this->zjly) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_zjly']) && !in_array($this->zjly, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_zjly']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['zjly']))
              {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmfzr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['xmfzr'] == "on")) 
      { 
          if ($this->xmfzr == "")  
          { 
    ...
    {
        global $teste_validade;
      if ($this->sbbm == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbbm']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbbm'] == "on"))
      {
          ...
          if (!empty($this->sbbm) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_sbbm']) && !in_array($this->sbbm, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_sbbm']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['sbbm']))
              {
    ...
    function ValidateField_sbrq(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_sbrq' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbrq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbrq'] == "on")) 
           { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['php_cmp_required']['sbr'] == "on")) 
      { 
          if ($this->sbr == "")  
          { 
    ...
    function ValidateField_fa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            {
                include_once 'form_cg_lxgl_doc_name.php';
            }
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_cg_lxgl_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_ysly']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_ysly'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_ysly']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_ysly'] = array(); 
}
$aLookup[] = array(form_cg_lxgl_pack_protect_string('') => form_cg_lxgl_pack_protect_string('请选择'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_ysly'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY mc";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_cg_lxgl_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_cg_lxgl_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_ysly'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['ysly']['valList'][$i] = form_cg_lxgl_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_zjly']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_zjly'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_zjly']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_zjly'] = array(); 
}
$aLookup[] = array(form_cg_lxgl_pack_protect_string('') => form_cg_lxgl_pack_protect_string('请选择'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_zjly'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY mc";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_zjly'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['zjly']['valList'][$i] = form_cg_lxgl_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_sbbm']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_sbbm'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_sbbm']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_sbbm'] = array(); 
}
$aLookup[] = array(form_cg_lxgl_pack_protect_string('') => form_cg_lxgl_pack_protect_string('请选择'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_sbbm'][] = '';
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
...
ORDER BY mc";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['Lookup_sbbm'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sbbm']['valList'][$i] = form_cg_lxgl_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_ps($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['scriptcase']['form_cg_lxgl']['contr_erro'] = 'on';
 if(empty($this->shzt )){
  $this->shzt ='未提交';
}
$_SESSION['scriptcase']['form_cg_lxgl']['contr_erro'] = 'off'; 
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opcao'] = '';
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->ifjs = $this->ifjs_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['parms'] = "id?#?$this->id?@?"; 
      }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter_form'];
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['parms'] = ""; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['select'] = ""; 
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['parms'] = "id?#?$this->id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sub_dir'][0]  = "cglx";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sub_dir'][1]  = "cglx";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sub_dir'][2]  = "cglx";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['dados_select'] = $this->nmgp_dados_select;
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['dados_select'];
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['dados_select'];
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   { 
    ...
    include_once("form_cg_lxgl_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_cg_lxgl = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['total'] = $qt_geral_reg_form_cg_lxgl;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_cg_lxgl_pack_ajax_response();
      ...
      $Nm_datas['sbrq'] = "date";$Nm_datas['qwcgrq'] = "date";$Nm_datas['cjsj'] = "datetime";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (isset($Nm_datas[$campo_join]))
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_cg_lxgl_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_cg_lxgl_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cg_lxgl']['masterValue'] as $cmp_master => $val_master)
{
?>

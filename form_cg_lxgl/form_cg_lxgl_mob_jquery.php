...
function scEventControl_init(iSeqRow) {
  scEventControl_data["ysly" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": ""};
...
function scEventControl_active(iSeqRow) {
  if (scEventControl_data["ysly" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["ysly" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_ysly' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_ysly_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_cg_lxgl_ysly_onfocus(this, iSeqRow) });
  $('#id_sc_field_xmbh' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_xmbh_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_cg_lxgl_xmbh_onfocus(this, iSeqRow) });
  $('#id_sc_field_xmmc' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_xmmc_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_cg_lxgl_xmmc_onfocus(this, iSeqRow) });
  $('#id_sc_field_ysje' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_ysje_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_cg_lxgl_ysje_onfocus(this, iSeqRow) });
  $('#id_sc_field_zjly' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_zjly_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_cg_lxgl_zjly_onfocus(this, iSeqRow) });
  $('#id_sc_field_xmfzr' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_xmfzr_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_cg_lxgl_xmfzr_onfocus(this, iSeqRow) });
  $('#id_sc_field_sbrq' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_sbrq_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_cg_lxgl_sbrq_onfocus(this, iSeqRow) });
  $('#id_sc_field_sbbm' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_sbbm_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_cg_lxgl_sbbm_onfocus(this, iSeqRow) });
  $('#id_sc_field_sbr' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_sbr_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_cg_lxgl_sbr_onfocus(this, iSeqRow) });
  $('#id_sc_field_qwcgrq' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_qwcgrq_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_cg_lxgl_qwcgrq_onfocus(this, iSeqRow) });
  $('#id_sc_field_lxr' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_lxr_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_cg_lxgl_lxr_onfocus(this, iSeqRow) });
  $('#id_sc_field_lxdh' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_lxdh_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_cg_lxgl_lxdh_onfocus(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_email_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_cg_lxgl_email_onfocus(this, iSeqRow) });
  $('#id_sc_field_bz' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_bz_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_form_cg_lxgl_bz_onfocus(this, iSeqRow) });
  $('#id_sc_field_fa' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_fa_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_form_cg_lxgl_fa_onfocus(this, iSeqRow) });
  $('#id_sc_field_bg' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_bg_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_form_cg_lxgl_bg_onfocus(this, iSeqRow) });
  $('#id_sc_field_ps' + iSeqRow).bind('blur', function() { sc_form_cg_lxgl_ps_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_form_cg_lxgl_ps_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_cg_lxgl_ysly_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_ysly();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_ysly_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_xmbh_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_xmbh();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_xmbh_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_xmmc_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_xmmc();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_xmmc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_ysje_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_ysje();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_ysje_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_zjly_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_zjly();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_zjly_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_xmfzr_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_xmfzr();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_xmfzr_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_sbrq_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_sbrq();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_sbrq_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_sbbm_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_sbbm();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_sbbm_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_sbr_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_sbr();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_sbr_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_qwcgrq_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_qwcgrq();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_qwcgrq_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_lxr_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_lxr();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_lxr_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_lxdh_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_lxdh();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_lxdh_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_email_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_email();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_email_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_bz_onblur(oThis, iSeqRow) {
  do_ajax_form_cg_lxgl_mob_validate_bz();
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_bz_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_fa_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_fa_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_bg_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_bg_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_cg_lxgl_ps_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_cg_lxgl_ps_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_fa" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_cg_lxgl_mob_ul_save.php",

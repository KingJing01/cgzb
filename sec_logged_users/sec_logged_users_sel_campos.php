<?php
   ...
   session_start();
    ...
    $Sel_Cmp = new sec_logged_users_sel_cmp(); 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_tbl_sec_logged'] ?></TITLE>
...
<?php
   if (isset($_SESSION['sc_session'][$this->sc_init]['sec_logged_users']['field_order']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['sec_logged_users']['field_order'] as $NM_cada_field)
       {
           if ($tab_ger_campos[$NM_cada_field] == "on")
           {
               ...
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsEnabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['sec_logged_users']['labels'][$NM_cada_field]; ?></li>
<?php
               }
               else
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsDisabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['sec_logged_users']['labels'][$NM_cada_field]; ?></li>
<?php
               }
           }
       }
